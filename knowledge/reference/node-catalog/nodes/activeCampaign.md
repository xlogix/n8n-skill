...
- Node name: `activeCampaign`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/ActiveCampaign/ActiveCampaign.node.js`
- Node version: `1`
- Groups: `transform`
...
- resource `accountContact`: `create`, `delete`, `update`
- resource `connection`: `create`, `delete`, `get`, `getAll`, `update`
- resource `contact`: `create`, `delete`, `get`, `getAll`, `update`
- resource `contactList`: `add`, `remove`
- resource `contactTag`: `add`, `remove`
- resource `deal`: `create`, `createNote`, `delete`, `get`, `getAll`, `update`, `updateNote`
- resource `ecommerceCustomer`: `create`, `delete`, `get`, `getAll`, `update`
- resource `ecommerceOrder`: `create`, `delete`, `get`, `getAll`, `update`
- resource `ecommerceOrderProducts`: `getAll`, `getByOrderId`, `getByProductId`
- resource `list`: `getAll`
...
| Operation | `operation` | `options` | no | `create` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Type | `tagType` | `options` | yes | `contact` | Tag-type of the new tag |
| Name | `name` | `string` | yes |  | Name of the new tag |
...
| Contact ID | `contactId` | `number` | yes |  |  |
| Contact Tag ID | `contactTagId` | `number` | yes | `0` | ID of the contact tag to delete |
| List ID | `listId` | `number` | yes |  |  |
| Contact ID | `contactId` | `number` | yes |  |  |
| List ID | `listId` | `number` | yes |  |  |
| Contact ID | `contactId` | `number` | yes |  |  |
| Name | `name` | `string` | yes |  | Account's name |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Account ID | `account` | `number` | yes |  |  |
| Contact ID | `contact` | `number` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Account Contact ID | `accountContactId` | `number` | yes | `0` | ID of the account contact to delete |
| Account Contact ID | `accountContactId` | `number` | yes |  | Account ID |
| Update Fields | `updateFields` | `collection` | no | `{}` | The fields to update |
| Email | `email` | `string` | yes |  | The email of the contact to create |
| Update if Exists | `updateIfExists` | `boolean` | no | `false` | Whether to update user if it exists already. If not set and user exists it will error instead. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Title | `title` | `string` | yes |  | The title of the deal |
| Deal's Contact ID | `contact` | `number` | yes | `0` | The ID of the deal's contact |
| Deal Value | `value` | `number` | yes | `0` | The value of the deal in cents |
| Currency | `currency` | `options` | yes | `eur` | The currency of the deal in 3-character ISO format |
| Deal Pipeline ID | `group` | `string` | no |  | The pipeline ID of the deal |
| Deal Stage ID | `stage` | `string` | no |  | The stage ID of the deal |
| Deal Owner ID | `owner` | `string` | no |  | The owner ID of the deal |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Deal ID | `dealId` | `number` | yes | `0` | ID of the deal to update |
| Update Fields | `updateFields` | `collection` | no | `{}` | The fields to update |
| Deal ID | `dealId` | `number` | yes | `0` | The ID of the deal to delete |
| Deal ID | `dealId` | `number` | yes | `0` | The ID of the deal to get |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Deal ID | `dealId` | `number` | yes |  | The ID of the deal note |
| Deal Note | `dealNote` | `string` | yes |  | The content of the deal note |
| Deal ID | `dealId` | `number` | yes |  | The ID of the deal note |
| Deal Note ID | `dealNoteId` | `number` | yes |  | The ID of the deal note |
| Deal Note | `dealNote` | `string` | no |  | The content of the deal note |
| Service | `service` | `string` | yes |  | The name of the service |
| External Account ID | `externalid` | `string` | yes |  | The ID of the account in the external service |
| Account Name | `name` | `string` | yes |  | The name associated with the account in the external service. Often this will be a company name (e.g., "My Toystore, Inc."). |
| Logo URL | `logoUrl` | `string` | yes |  | The URL to a logo image for the external service |
| Link URL | `linkUrl` | `string` | yes |  | The URL to a page where the integration with the external service can be managed in the third-party's website |
...
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| External ID | `externalid` | `string` | no |  | The ID of the order in the external service. ONLY REQUIRED IF EXTERNALCHECKOUTID NOT INCLUDED. |
| External Checkout ID | `externalcheckoutid` | `string` | no |  | The ID of the cart in the external service. ONLY REQUIRED IF EXTERNALID IS NOT INCLUDED. |
| Order Source | `source` | `number` | yes | `0` | The order source code (0 - will not trigger automations, 1 - will trigger automations) |
| Customer Email | `email` | `string` | yes |  | The email address of the customer who placed the order |
| Total Price | `totalPrice` | `number` | yes | `0` | The total price of the order in cents, including tax and shipping charges. (i.e. $456.78 => 45678). Must be greater than or equal to zero. |
| Order Currency | `currency` | `options` | yes | `eur` | The currency of the order (3-digit ISO code, e.g., "USD") |
...
| Creation Date | `externalCreatedDate` | `dateTime` | yes |  | The date the order was placed |
| Abandoning Date | `abandonedDate` | `dateTime` | no |  | The date the cart was abandoned. REQUIRED ONLY IF INCLUDING EXTERNALCHECKOUTID. |
| Products | `orderProducts` | `collection` | no | `{}` | All ordered products |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Order ID | `orderId` | `number` | no | `0` | The ID of the e-commerce order |
...
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Service ID | `connectionid` | `string` | yes |  | The ID of the connection object for the service where the customer originates |
| Customer ID | `externalid` | `string` | yes |  | The ID of the customer in the external service |
| Customer Email | `email` | `string` | yes |  | The email address of the customer |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Order ID | `orderId` | `number` | no | `0` | The ID of the order whose products you'd like returned |
| Product ID | `procuctId` | `number` | no | `0` | The ID of the product you'd like returned |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
