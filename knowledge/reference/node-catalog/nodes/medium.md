...
- Source file: `n8n-nodes-base/dist/nodes/Medium/Medium.node.js`
- Node version: `1`
- Groups: `output`
...
| Publication | `publication` | `boolean` | no | `false` | Whether you are posting for a publication |
| Publication Name or ID | `publicationId` | `options` | no |  | Publication IDs. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Title | `title` | `string` | yes |  | Title of the post. Max Length : 100 characters. |
| Content Format | `contentFormat` | `options` | yes |  | The format of the content to be posted |
| Content | `content` | `string` | yes |  | The body of the post, in a valid semantic HTML fragment, or Markdown |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `publication` |  |
