...
- Source file: `n8n-nodes-base/dist/nodes/Shopify/Shopify.node.js`
- Node version: `1`
- Groups: `output`
...
| Operation | `operation` | `options` | no | `create` |  |
| Title | `title` | `string` | yes |  | The name of the product |
