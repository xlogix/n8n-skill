...
- Node name: `venafiTlsProtectCloud`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Venafi/ProtectCloud/VenafiTlsProtectCloud.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `certificate`: `delete`, `download`, `get`, `getMany`, `renew`
- resource `certificateRequest`: `create`, `get`, `getMany`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `certificateRequest` |  |
| Operation | `operation` | `options` | no | `delete` |  |
| Certificate ID | `certificateId` | `string` | yes |  |  |
| Download Item | `downloadItem` | `options` | no | `certificate` |  |
| Keystore Type | `keystoreType` | `options` | no | `PEM` |  |
| Certificate Label | `certificateLabel` | `string` | yes |  |  |
| Private Key Passphrase | `privateKeyPassphrase` | `string` | yes |  |  |
| Keystore Passphrase | `keystorePassphrase` | `string` | yes |  |  |
| Input Data Field Name | `binaryProperty` | `string` | yes | `data` | The name of the input field containing the binary file data to be uploaded |
...
| Application Name or ID | `applicationId` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Existing Certificate ID | `existingCertificateId` | `string` | no |  |  |
| Certificate Issuing Template Name or ID | `certificateIssuingTemplateId` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Certificate Signing Request | `certificateSigningRequest` | `string` | no |  |  |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Application Name or ID | `applicationId` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Certificate Issuing Template Name or ID | `certificateIssuingTemplateId` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Generate CSR | `generateCsr` | `boolean` | no | `false` |  |
| Common Name | `commonName` | `string` | yes | `n8n.io` | The Common Name field for the certificate Subject (CN) |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Certificate Signing Request | `certificateSigningRequest` | `string` | no |  |  |
| Options | `options` | `collection` | no | `{}` |  |
| Certificate Request ID | `certificateRequestId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
