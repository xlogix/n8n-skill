...
- Source file: `n8n-nodes-base/dist/nodes/EmailSend/EmailSend.node.js`
- Node version: `[2,2.1]`
- Groups: `output`
...
### Operations
- resource `email`: `send`, `sendAndWait`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `hidden` | no | `email` |  |
| Operation | `operation` | `options` | no | `send` |  |
| From Email | `fromEmail` | `string` | yes |  | Email address of the sender. You can also specify a name: Nathan Doe &lt;nate@n8n.io&gt;. |
| To Email | `toEmail` | `string` | yes |  | Email address of the recipient. You can also specify a name: Nathan Doe &lt;nate@n8n.io&gt;. |
| Subject | `subject` | `string` | no |  | Subject line of the email |
| Email Format | `emailFormat` | `options` | no | `html` |  |
| Email Format | `emailFormat` | `options` | no | `text` |  |
