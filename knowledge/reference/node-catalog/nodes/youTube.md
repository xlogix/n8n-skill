...
- Source file: `n8n-nodes-base/dist/nodes/Google/YouTube/YouTube.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `channel`: `get`, `getAll`, `update`, `uploadBanner`
- resource `playlist`: `create`, `delete`, `get`, `getAll`, `update`
- resource `playlistItem`: `add`, `delete`, `get`, `getAll`
- resource `video`: `delete`, `get`, `getAll`, `rate`, `update`, `upload`
- resource `videoCategory`: `getAll`
...
| Fields | `part` | `multiOptions` | yes | `["*"]` | The fields parameter specifies a comma-separated list of one or more channel resource properties that the API response will include |
...
| Channel ID | `channelId` | `string` | yes |  | ID of the channel |
| Fields | `part` | `multiOptions` | yes | `["*"]` | The fields parameter specifies a comma-separated list of one or more channel resource properties that the API response will include |
| Channel ID | `channelId` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Channel ID | `channelId` | `string` | yes |  | ID of the channel |
| Input Binary Field | `binaryProperty` | `string` | yes | `data` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Title | `title` | `string` | yes |  | The playlist's title |
| Options | `options` | `collection` | no | `{}` |  |
| Playlist ID | `playlistId` | `string` | yes |  |  |
| Fields | `part` | `multiOptions` | yes | `["*"]` | The fields parameter specifies a comma-separated list of one or more playlist resource properties that the API response will include |
| Options | `options` | `collection` | no | `{}` |  |
| Playlist ID | `playlistId` | `string` | yes |  |  |
| Options | `options` | `collection` | no | `{}` |  |
| Fields | `part` | `multiOptions` | yes | `["*"]` | The fields parameter specifies a comma-separated list of one or more playlist resource properties that the API response will include |
...
| Filters | `filters` | `collection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Playlist ID | `playlistId` | `string` | yes |  | The playlist's title |
| Title | `title` | `string` | yes |  | The playlist's title |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `add` |  |
| Playlist Name or ID | `playlistId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Video ID | `videoId` | `string` | yes |  |  |
| Options | `options` | `collection` | no | `{}` |  |
| Playlist Item ID | `playlistItemId` | `string` | yes |  |  |
| Fields | `part` | `multiOptions` | yes | `["*"]` | The fields parameter specifies a comma-separated list of one or more playlistItem resource properties that the API response will include |
| Options | `options` | `collection` | no | `{}` |  |
| Playlist Item ID | `playlistItemId` | `string` | yes |  |  |
| Options | `options` | `collection` | no | `{}` |  |
| Playlist Name or ID | `playlistId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
...
| Region Code | `regionCode` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Category Name or ID | `categoryId` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Input Binary Field | `binaryProperty` | `string` | yes | `data` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Video ID | `videoId` | `string` | yes |  | ID of the video |
| Options | `options` | `collection` | no | `{}` |  |
| Video ID | `videoId` | `string` | yes |  |  |
| Fields | `part` | `multiOptions` | yes | `["*"]` | The fields parameter specifies a comma-separated list of one or more video resource properties that the API response will include |
| Options | `options` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `25` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Region Code | `regionCode` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `25` | Max number of results to return |
