...
- Node name: `oracleDatabase`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Oracle/Sql/OracleSql.node.js`
- Node version: `[1]`
- Groups: `input`
...
### Operations
- resource `database`: `deleteTable`, `execute`, `insert`, `select`, `update`, `upsert`
...
| Schema | `schema` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The schema that contains the table you want to work on |
...
| Important: Single Statement mode works only for the first item | `stmtBatchingNotice` | `notice` | no |  |  |
| Statement | `query` | `string` | yes |  | The SQL statement to execute. You can use n8n expressions and positional parameters like :1, :2, :3, or named parameters like :name, :ID, etc to refer to the 'Bind Variable Placeholder Values' set in options below. |
| Options | `options` | `collection` | no | `{}` |  |
| Important: Single Statement mode works only for the first item | `stmtBatchingNotice` | `notice` | no |  |  |
