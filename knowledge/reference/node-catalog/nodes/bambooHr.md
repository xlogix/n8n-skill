...
- Source file: `n8n-nodes-base/dist/nodes/BambooHr/BambooHr.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `companyReport`: `get`
- resource `employee`: `create`, `get`, `getAll`, `update`
- resource `employeeDocument`: `delete`, `download`, `getAll`, `update`, `upload`
- resource `file`: `delete`, `download`, `getAll`, `update`, `upload`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `employee` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Synced with Trax Payroll | `synced` | `boolean` | yes | `false` | Whether the employee to create was added to a pay schedule synced with Trax Payroll |
| First Name | `firstName` | `string` | yes |  |  |
| Last Name | `lastName` | `string` | yes |  |  |
| Address | `address` | `fixedCollection` | yes | `{}` |  |
| Date of Birth | `dateOfBirth` | `dateTime` | yes |  |  |
| Department Name or ID | `department` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Division Name or ID | `division` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Employee Number | `employeeNumber` | `string` | yes |  |  |
| FLSA Overtime Status | `exempt` | `options` | yes |  |  |
| Gender | `gender` | `options` | yes |  |  |
| Hire Date | `hireDate` | `dateTime` | yes |  |  |
| Location Name or ID | `location` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Marital Status | `maritalStatus` | `options` | yes |  |  |
| Mobile Phone | `mobilePhone` | `string` | yes |  |  |
| Pay Per | `paidPer` | `options` | yes |  |  |
| Pay Rate | `payRate` | `fixedCollection` | yes | `{}` |  |
| Pay Type | `payType` | `options` | yes |  |  |
| Preferred Name | `preferredName` | `string` | yes |  |  |
| Social Security Number | `ssn` | `string` | yes |  | A standard United States Social Security number, with dashes |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Employee ID | `employeeId` | `string` | yes |  |  |
...
| Employee ID | `employeeId` | `string` | yes |  |  |
| Synced with Trax Payroll | `synced` | `boolean` | yes | `false` | Whether the employee to create was added to a pay schedule synced with Trax Payroll |
| Address | `addasasress` | `fixedCollection` | yes | `{}` |  |
| Date of Birth | `dateOfBirth` | `dateTime` | yes |  |  |
| Department Name or ID | `department` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Division Name or ID | `division` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Employee Number | `employeeNumber` | `string` | yes |  |  |
...
| Employee ID | `employeeId` | `string` | yes |  | ID of the employee |
| File ID | `fileId` | `string` | yes |  | ID of the employee file |
| Employee ID | `employeeId` | `string` | yes |  | ID of the employee |
| File ID | `fileId` | `string` | yes |  | ID of the employee file |
| Put Output In Field | `output` | `string` | yes | `data` | The name of the output field to put the binary file data in |
| Employee ID | `employeeId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Employee ID | `employeeId` | `string` | yes |  | ID of the employee |
| Employee Document Category ID | `categoryId` | `string` | yes |  |  |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `delete` |  |
| File ID | `fileId` | `string` | yes |  | ID of the file |
| File ID | `fileId` | `string` | yes |  | ID of the file |
| Put Output In Field | `output` | `string` | yes | `data` | The name of the output field to put the binary file data in |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Input Data Field Name | `binaryPropertyName` | `string` | yes | `data` | The name of the input field containing the binary file data to be uploaded. Supported file types: PNG, JPEG. |
| Category Name or ID | `categoryId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Report ID | `reportId` | `string` | yes |  | ID of the report. You can get the report number by hovering over the report name on the reports page and grabbing the ID. |
| Format | `format` | `options` | yes | `JSON` | The output format for the report |
| Put Output In Field | `output` | `string` | yes | `data` | The name of the output field to put the binary file data in |
| Options | `options` | `collection` | no | `{}` |  |
