...
- Node name: `googleChat`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Google/Chat/GoogleChat.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `member`: `get`, `getAll`
- resource `message`: `create`, `delete`, `get`, `sendAndWait`, `update`
- resource `space`: `get`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Authentication | `authentication` | `options` | no | `serviceAccount` |  |
| Resource | `resource` | `options` | yes | `message` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Member ID | `memberId` | `string` | yes |  | Member to be retrieved in the form "spaces/*/members/*" |
| Space Name or ID | `spaceId` | `options` | yes | `[]` | The name of the space for which to retrieve members, in the form "spaces/*". Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
...
| Space Name or ID | `spaceId` | `options` | yes |  | Space resource name, in the form "spaces/*". Example: spaces/AAAAMpdlehY. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` | Whether to pass the message object as JSON |
| Message | `messageUi` | `collection` | yes | `{}` |  |
| See <a href="https://developers.google.com/chat/reference/rest/v1/spaces.messages#Message" target="_blank">Google Chat Guide</a> To Creating Messages | `jsonNotice` | `notice` | no |  |  |
| Message (JSON) | `messageJson` | `json` | yes |  | Message input as JSON Object or JSON String |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Message ID | `messageId` | `string` | yes |  | Resource name of the message to be deleted, in the form "spaces//messages/" |
| Message ID | `messageId` | `string` | yes |  | Resource name of the message to be retrieved, in the form "spaces//messages/" |
| Message ID | `messageId` | `string` | yes |  | Resource name of the message to be updated, in the form "spaces//messages/" |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` | Whether to pass the update fields object as JSON |
| Update Fields | `updateFieldsUi` | `collection` | yes | `{}` |  |
| See <a href="https://developers.google.com/chat/reference/rest/v1/spaces.messages#Message" target="_blank">Google Chat Guide</a> To Creating Messages | `jsonNotice` | `notice` | no |  |  |
| Update Fields (JSON) | `updateFieldsJson` | `json` | yes |  | Message input as JSON Object or JSON String |
| Operation | `operation` | `options` | no | `get` |  |
| Space ID | `spaceId` | `string` | yes |  | Resource name of the space, in the form "spaces/*" |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Space Name or ID | `spaceId` | `options` | yes |  | Space resource name, in the form "spaces/*". Example: spaces/AAAAMpdlehY. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
