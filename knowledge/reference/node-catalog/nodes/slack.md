...
- Source file: `n8n-nodes-base/dist/nodes/Slack/Slack.node.js`
- Node version: `[2,2.1,2.2,2.3,2.4]`
- Groups: `output`
...
### Operations
- resource `channel`: `archive`, `close`, `create`, `get`, `getAll`, `history`, `invite`, `join`, `kick`, `leave`, `member`, `open`, `rename`, `replies`, `setPurpose`, `setTopic`, `unarchive`
- resource `file`: `get`, `getAll`, `upload`
- resource `message`: `delete`, `getPermalink`, `post`, `search`, `sendAndWait`, `update`
- resource `reaction`: `add`, `get`, `remove`
- resource `star`: `add`, `delete`, `getAll`
- resource `user`: `getAll`, `getPresence`, `getProfile`, `info`, `updateProfile`
- resource `userGroup`: `create`, `disable`, `enable`, `getAll`, `getUsers`, `update`, `updateUsers`
...
| Channel | `channelId` | `resourceLocator` | no | `{"mode":"list","value":""}` | The Slack channel to archive |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to close |
| Channel | `channelId` | `string` | yes |  |  |
| Channel Visibility | `channelVisibility` | `options` | yes | `public` | Whether to create a Public or a Private Slack channel. <a href="https://slack.com/help/articles/360017938993-What-is-a-channel">More info</a>. |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to invite to |
| User Names or IDs | `userIds` | `multiOptions` | yes | `[]` | The ID of the user to invite into channel. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to get |
| Options | `options` | `collection` | no | `{}` |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to kick the user from |
| User Name or ID | `userId` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to join |
...
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to get the history from |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to leave from |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to get the members from |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Resolve Data | `resolveData` | `boolean` | no | `false` | Whether to resolve the data automatically. By default the response only contain the ID to resource. |
| Options | `options` | `collection` | no | `{}` |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to rename |
| Name | `name` | `string` | yes |  | New name for conversation |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to replies to |
| Message Timestamp | `ts` | `number` | yes |  | Timestamp of the message to reply |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to set the purpose of |
| Purpose | `purpose` | `string` | yes |  | A new, specialer purpose |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to set the topic of |
| Topic | `topic` | `string` | yes |  |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to unarchive |
| Operation | `operation` | `options` | no | `post` |  |
| Channel | `channelId` | `resourceLocator` | no | `{"mode":"list","value":""}` | The Slack channel to get the message permalink from |
| Message Timestamp | `timestamp` | `number` | yes |  | Timestamp of the message to message |
| Send Message To | `select` | `options` | yes |  |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to send to |
| User | `user` | `resourceLocator` | no | `{"mode":"list","value":""}` |  |
| Message Type | `messageType` | `options` | no | `text` | Whether to send a simple text message, or use Slack’s Blocks UI builder for more sophisticated messages that include form fields, sections and more |
| Message Text | `text` | `string` | yes |  | The message text to post. Supports <a href="https://api.slack.com/reference/surfaces/formatting">markdown</a> by default - this can be disabled in "Options". |
| Blocks | `blocksUi` | `string` | yes |  | Enter the JSON output from Slack's visual Block Kit Builder here. You can then use expressions to add variable content to your blocks. To create blocks, use <a target='_blank' href='https://app.slack.com/block-kit-builder'>Slack's Block Kit Builder</a> |
| Notification Text | `text` | `string` | no |  | Fallback text to display in slack notifications. Supports <a href="https://api.slack.com/reference/surfaces/formatting">markdown</a> by default - this can be disabled in "Options". |
| This is a legacy Slack feature. Slack advises to instead use Blocks. | `noticeAttachments` | `notice` | no |  |  |
| Attachments | `attachments` | `collection` | no | `{}` |  |
| Options | `otherOptions` | `collection` | no | `{}` | Other options to set |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to update the message from |
| Message Timestamp | `ts` | `number` | yes |  | Timestamp of the message to update |
| Message Type | `messageType` | `options` | no | `text` | Whether to send a simple text message, or use Slack’s Blocks UI builder for more sophisticated messages that include form fields, sections and more |
| Blocks | `blocksUi` | `string` | yes |  | Enter the JSON output from Slack's visual Block Kit Builder here. You can then use expressions to add variable content to your blocks. To create blocks, use <a target='_blank' href='https://app.slack.com/block-kit-builder'>Slack's Block Kit Builder</a> |
| Notification Text | `text` | `string` | no |  | Fallback text to display in slack notifications. Supports <a href="https://api.slack.com/reference/surfaces/formatting">markdown</a> by default - this can be disabled in "Options". |
| Message Text | `text` | `string` | no |  | The message text to update. Supports <a href="https://api.slack.com/reference/surfaces/formatting/">markdown</a> by default - this can be disabled in "Options". |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Options | `otherOptions` | `collection` | no | `{}` | Other options to set |
| Delete Message From | `select` | `options` | yes |  |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to delete the message from |
| User | `user` | `resourceLocator` | no | `{"mode":"list","value":""}` |  |
| Message Timestamp | `timestamp` | `number` | yes |  | Timestamp of the message to delete |
| Search Query | `query` | `string` | yes |  | The text to search for within messages |
| Sort By | `sort` | `options` | no | `desc` | How search results should be sorted. You can sort by. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `25` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Send Message To | `select` | `options` | yes | `user` |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to send to |
| User | `user` | `resourceLocator` | no | `{"mode":"list","value":""}` |  |
...
| Item to Add Star | `target` | `options` | yes |  | Choose whether to add a star to a message or a file |
| Channel | `channelId` | `resourceLocator` | no | `{"mode":"list","value":""}` | The Slack channel to add a star to |
| File ID | `fileId` | `string` | no |  | File to add star to |
| Message Timestamp | `timestamp` | `number` | no |  | Timestamp of the message to add |
| Options | `options` | `collection` | no | `{}` | Options to set |
| Options | `options` | `collection` | no | `{}` | Options to set |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `upload` |  |
| Binary File | `binaryData` | `boolean` | no | `false` | Whether the data to upload should be taken from binary field |
| File Content | `fileContent` | `string` | no |  |  |
| File Property | `binaryPropertyName` | `string` | yes | `data` | Name of the binary property which contains the data for the file to be uploaded |
| File Property | `binaryPropertyName` | `string` | yes | `data` | Name of the binary property which contains the data for the file to be uploaded |
...
| Operation | `operation` | `options` | no | `add` |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The Slack channel to get the reactions from |
| Message Timestamp | `timestamp` | `number` | yes |  | Timestamp of the message to add, get or remove |
| Emoji Code | `name` | `string` | yes |  | Emoji code to use for the message reaction. Use emoji codes like +1, not an actual emoji like 👍. <a target="_blank" href=" https://www.webfx.com/tools/emoji-cheat-sheet/">List of common emoji codes</a> |
| Operation | `operation` | `options` | no | `info` |  |
| User | `user` | `resourceLocator` | no | `{"mode":"list","value":""}` | The ID of the user to get information about |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| User | `user` | `resourceLocator` | no | `{"mode":"list","value":""}` | The ID of the user to get the online status of |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | A name for the User Group. Must be unique among User Groups. |
| Options | `Options` | `collection` | no | `{}` |  |
| User Group ID | `userGroupId` | `string` | yes |  | The encoded ID of the User Group to update |
| Options | `options` | `collection` | no | `{}` |  |
| User Group ID | `userGroupId` | `string` | yes |  | The encoded ID of the User Group to update |
| Options | `option` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| User Group ID | `userGroupId` | `string` | yes |  | The encoded ID of the User Group to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| User Group ID | `userGroupId` | `string` | yes |  | The encoded ID of the User Group to update |
| User Names or IDs | `users` | `multiOptions` | yes | `[]` | Users to add to the User Group. Existing users will be preserved. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Options | `options` | `collection` | no | `{}` |  |
| User Group ID | `userGroupId` | `string` | yes |  | The encoded ID of the User Group |
| Options | `options` | `collection` | no | `{}` |  |
...
[
  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "default": [],
        "description": "If only one user is included, this creates a 1:1 DM. The ordering of the users is preserved whenever a multi-person direct message is returned. Supply a channel when not supplying users. Choose from the list, or specify IDs using an <a href=\"https://docs.n8n.io/code/expressions/\">expression</a>."
      }
    ]
  },
  {
    ...
    "options": [
      {
        ...
        "default": [],
        "description": "The channels to send the file to. Choose from the list, or specify IDs using an <a href=\"https://docs.n8n.io/code/expressions/\">expression</a>."
      },
      {
        "displayName": "Channel Name or ID",
        "name": "channelId",
        ...
        "default": [],
        "description": "The channel to send the file to. Choose from the list, or specify an ID using an <a href=\"https://docs.n8n.io/code/expressions/\">expression</a>."
      },
      {
  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "description": "Filter files created by a single user. Choose from the list, or specify an ID using an <a href=\"https://docs.n8n.io/code/expressions/\">expression</a>."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "required": true,
    "description": "Users to add to the User Group. Existing users will be preserved. Choose from the list, or specify IDs using an <a href=\"https://docs.n8n.io/code/expressions/\">expression</a>."
  },
  {
    "displayName": "Options",
    "name": "options",
