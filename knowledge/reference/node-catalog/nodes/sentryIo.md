...
- Source file: `n8n-nodes-base/dist/nodes/SentryIo/SentryIo.node.js`
- Node version: `1`
- Groups: `output`
...
## Credentials
- `sentryIoOAuth2Api` (required)
- `sentryIoApi` (required)
- `sentryIoServerApi` (required)
...
### Operations
- resource `event`: `get`, `getAll`
- resource `issue`: `delete`, `get`, `getAll`, `update`
- resource `organization`: `create`, `get`, `getAll`, `update`
- resource `project`: `create`, `delete`, `get`, `getAll`, `update`
- resource `release`: `create`, `delete`, `get`, `getAll`, `update`
- resource `team`: `create`, `delete`, `get`, `getAll`, `update`
...
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the events belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Project Slug Name or ID | `projectSlug` | `options` | yes |  | The slug of the project the events belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Full | `full` | `boolean` | no | `true` | Whether the event payload will include the full event body, including the stack trace |
...
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the events belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Project Slug Name or ID | `projectSlug` | `options` | yes |  | The slug of the project the events belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Event ID | `eventId` | `string` | yes |  | The ID of the event to retrieve (either the numeric primary-key or the hexadecimal ID as reported by the raven client) |
| Operation | `operation` | `options` | no | `get` |  |
| Issue ID | `issueId` | `string` | yes |  | ID of issue to get |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the issues belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Project Slug Name or ID | `projectSlug` | `options` | yes |  | The slug of the project the issues belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Issue ID | `issueId` | `string` | yes |  | ID of issue to get |
| Update Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the team should be created for. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Name | `name` | `string` | yes |  | The slug of the organization the team should be created for |
| Agree to Terms | `agreeTerms` | `boolean` | no | `false` | Whether you agree to the applicable terms of service and privacy policy of Sentry.io |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Slug Name or ID | `organization_slug` | `options` | yes |  | The slug of the organization to update. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the events belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Project Slug Name or ID | `projectSlug` | `options` | yes |  | The slug of the project to retrieve. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Team Slug Name or ID | `teamSlug` | `options` | yes |  | The slug of the team to create a new project for. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Name | `name` | `string` | yes |  | The name for the new project |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the project belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Project Slug Name or ID | `projectSlug` | `options` | yes |  | The slug of the project to update. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the project belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Project Slug Name or ID | `projectSlug` | `options` | yes |  | The slug of the project to delete. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Operation | `operation` | `options` | no | `get` |  |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the releases belong to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the release belongs to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Version | `version` | `string` | yes |  | The version identifier of the release |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the release belongs to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Version | `version` | `string` | yes |  | A version identifier for this release. Can be a version number, a commit hash etc. |
| URL | `url` | `string` | yes |  | A URL that points to the release. This can be the path to an online interface to the sourcecode for instance. |
| Project Names or IDs | `projects` | `multiOptions` | yes | `[]` | A list of project slugs that are involved in this release. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the release belongs to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Version | `version` | `string` | yes |  | A version identifier for this release. Can be a version number, a commit hash etc. |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization for which the teams should be listed. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the team belongs to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Team Slug Name or ID | `teamSlug` | `options` | yes |  | The slug of the team to get. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the team belongs to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Name | `name` | `string` | yes |  | The name of the team |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the team belongs to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Team Slug Name or ID | `teamSlug` | `options` | yes |  | The slug of the team to update. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Organization Slug Name or ID | `organizationSlug` | `options` | yes |  | The slug of the organization the team belongs to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Team Slug Name or ID | `teamSlug` | `options` | yes |  | The slug of the team to delete. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
