...
- Node name: `azureCosmosDb`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Microsoft/AzureCosmosDb/AzureCosmosDb.node.js`
- Node version: `1`
- Groups: `transform`
...
## Credentials
- `microsoftAzureCosmosDbSharedKeyApi` (required)
...
- resource `item`: `create`, `delete`, `get`, `getAll`, `query`, `update`
...
| ID | `containerCreate` | `string` | yes |  | Unique identifier for the new container |
| Partition Key | `partitionKey` | `json` | yes | `{
	"paths": [
		"/id"
	],
	"kind": "Hash",
...
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container you want to delete |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container you want to retrieve |
...
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Operation | `operation` | `options` | no | `getAll` |  |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container you want to use |
| Item Contents | `customProperties` | `json` | yes | `{
	"id": "replace_with_new_document_id"
}` | The item contents as a JSON object |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container you want to use |
| Item | `item` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the item to be deleted |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container you want to use |
| Item | `item` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the item you want to retrieve |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container you want to use |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container you want to use |
| Query | `query` | `string` | yes |  | The SQL query to execute. Use $1, $2, $3, etc., to reference the 'Query Parameters' set in the options below. |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Options | `options` | `fixedCollection` | no | `{}` |  |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container you want to use |
| Item | `item` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the item to be updated |
| Item Contents | `customProperties` | `json` | yes | `{}` | The item contents as a JSON object |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
