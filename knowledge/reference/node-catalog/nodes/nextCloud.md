...
- Source file: `n8n-nodes-base/dist/nodes/NextCloud/NextCloud.node.js`
- Node version: `1`
- Groups: `input`
...
## Credentials
- `nextCloudApi` (required)
- `nextCloudOAuth2Api` (required)
...
### Operations
- resource `file`: `copy`, `delete`, `download`, `move`, `share`, `upload`
- resource `folder`: `copy`, `create`, `delete`, `list`, `move`, `share`
...
| Operation | `operation` | `options` | no | `create` |  |
| From Path | `path` | `string` | yes |  | The path of file or folder to copy. The path should start with "/". |
| To Path | `toPath` | `string` | yes |  | The destination path of file or folder. The path should start with "/". |
| Delete Path | `path` | `string` | yes |  | The path to delete. Can be a single file or a whole folder. The path should start with "/". |
| From Path | `path` | `string` | yes |  | The path of file or folder to move. The path should start with "/". |
| To Path | `toPath` | `string` | yes |  | The new path of file or folder. The path should start with "/". |
| File Path | `path` | `string` | yes |  | The file path of the file to download. Has to contain the full path. The path should start with "/". |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| File Path | `path` | `string` | yes |  | The absolute file path of the file to upload. Has to contain the full path. The parent folder has to exist. Existing files get overwritten. |
| Binary File | `binaryDataUpload` | `boolean` | yes | `false` |  |
...
| File Path | `path` | `string` | yes |  | The file path of the file to share. Has to contain the full path. The path should start with "/". |
| Share Type | `shareType` | `options` | no | `0` | The share permissions to set |
| Circle ID | `circleId` | `string` | no |  | The ID of the circle to share with |
| Email | `email` | `string` | no |  | The Email address to share with |
| Group ID | `groupId` | `string` | no |  | The ID of the group to share with |
| User | `user` | `string` | no |  | The user to share with |
| Options | `options` | `collection` | no | `{}` |  |
| Folder | `path` | `string` | yes |  | The folder to create. The parent folder has to exist. The path should start with "/". |
| Folder Path | `path` | `string` | no |  | The path of which to list the content. The path should start with "/". |
| Username | `userId` | `string` | yes |  | Username the user will have |
| Email | `email` | `string` | yes |  | The email of the user to invite |
...
| Options | `options` | `collection` | no | `{}` |  |
| Update Fields | `updateFields` | `fixedCollection` | no | `{}` |  |
