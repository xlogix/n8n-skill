...
- Source file: `n8n-nodes-base/dist/nodes/Salesmate/Salesmate.node.js`
- Node version: `1`
- Groups: `output`
...
| Owner Name or ID | `owner` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| RAW Data | `rawData` | `boolean` | no | `false` | Whether the data should include the fields details |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Company ID | `id` | `string` | yes |  |  |
| RAW Data | `rawData` | `boolean` | no | `false` | Whether the data should include the fields details |
...
| Filters | `filtersJson` | `json` | no |  |  |
| Filters | `filters` | `fixedCollection` | no | `{}` |  |
| Company ID | `id` | `string` | yes |  | If more than one company add them separated by , |
| Title | `title` | `string` | yes |  |  |
| Owner Name or ID | `owner` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Type | `type` | `string` | yes |  | This field displays activity type such as call, meeting etc |
| RAW Data | `rawData` | `boolean` | no | `false` | Whether the data should include the fields details |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Activity ID | `id` | `string` | yes |  |  |
| RAW Data | `rawData` | `boolean` | no | `false` | Whether the data should include the fields details |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Activity ID | `id` | `string` | yes |  |  |
| RAW Data | `rawData` | `boolean` | no | `false` | Whether the data should include the fields details |
...
| Filters | `filtersJson` | `json` | no |  |  |
| Filters | `filters` | `fixedCollection` | no | `{}` |  |
| Activity ID | `id` | `string` | yes |  | If more than one activity add them separated by , |
| Title | `title` | `string` | yes |  |  |
| Owner Name or ID | `owner` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Primary Contact Name or ID | `primaryContact` | `options` | yes |  | Primary contact for the deal. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Pipeline | `pipeline` | `options` | yes |  |  |
| Status | `status` | `options` | yes | `Open` |  |
| Stage | `stage` | `options` | yes |  |  |
| Currency | `currency` | `string` | yes |  |  |
| RAW Data | `rawData` | `boolean` | no | `false` | Whether the data should include the fields details |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Deal ID | `id` | `string` | yes |  |  |
| RAW Data | `rawData` | `boolean` | no | `false` | Whether the data should include the fields details |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Deal ID | `id` | `string` | yes |  |  |
| RAW Data | `rawData` | `boolean` | no | `false` | Whether the data should include the fields details |
...
| Filters | `filtersJson` | `json` | no |  |  |
| Filters | `filters` | `fixedCollection` | no | `{}` |  |
| Deal ID | `id` | `string` | yes |  | If more than one deal add them separated by , |
