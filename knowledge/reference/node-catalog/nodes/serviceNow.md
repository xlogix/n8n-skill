...
- Node name: `serviceNow`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/ServiceNow/ServiceNow.node.js`
- Node version: `1`
- Groups: `output`
...
## Credentials
- `serviceNowOAuth2Api` (required)
- `serviceNowBasicApi` (required)
...
### Operations
- resource `attachment`: `delete`, `get`, `getAll`, `upload`
- resource `businessService`: `getAll`
- resource `configurationItems`: `getAll`
- resource `department`: `getAll`
- resource `dictionary`: `getAll`
- resource `incident`: `create`, `delete`, `get`, `getAll`, `update`
- resource `tableRecord`: `create`, `delete`, `get`, `getAll`, `update`
- resource `user`: `create`, `delete`, `get`, `getAll`, `update`
- resource `userGroup`: `getAll`
- resource `userRole`: `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Authentication | `authentication` | `options` | no | `oAuth2` | Authentication method to use |
| Resource | `resource` | `options` | no | `user` |  |
| Operation | `operation` | `options` | no | `upload` |  |
| Table Name or ID | `tableName` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Table Record ID | `id` | `string` | yes |  | Sys_id of the record in the table specified in Table Name that you want to attach the file to |
| Input Data Field Name | `inputDataFieldName` | `string` | yes | `data` | Name of the binary property that contains the data to upload |
| Options | `options` | `collection` | no | `{}` |  |
| Attachment ID | `attachmentId` | `string` | yes |  | Sys_id value of the attachment to delete |
| Attachment ID | `attachmentId` | `string` | yes |  | Sys_id value of the attachment to delete |
...
| Download Attachments | `download` | `boolean` | yes | `false` |  |
| Output Field | `outputField` | `string` | no | `data` | Field name where downloaded data will be placed |
| Options | `options` | `collection` | no | `{}` |  |
...
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Incident ID | `id` | `string` | yes |  | Unique identifier of the incident |
| Options | `options` | `collection` | no | `{}` |  |
| Incident ID | `id` | `string` | yes |  | Unique identifier of the incident |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Table Name or ID | `tableName` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Data to Send | `dataToSend` | `options` | no | `columns` |  |
| Inputs to Ignore | `inputsToIgnore` | `string` | no |  | List of input properties to avoid sending, separated by commas. Leave empty to send all inputs. |
| Fields to Send | `fieldsToSend` | `fixedCollection` | no | `{}` |  |
| Table Name or ID | `tableName` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Table Name or ID | `tableName` | `options` | yes |  | Name of the table in which the record exists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Table Record ID | `id` | `string` | yes |  | Unique identifier of the record |
| Options | `options` | `collection` | no | `{}` |  |
| Table Name or ID | `tableName` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Table Record ID | `id` | `string` | yes |  | Unique identifier of the record |
| Data to Send | `dataToSend` | `options` | no | `columns` |  |
...
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Retrieve Identifier | `getOption` | `options` | yes | `id` | Unique identifier of the user |
| Username | `user_name` | `string` | yes |  | Unique identifier of the user |
| User ID | `id` | `string` | yes |  | Unique identifier of the user |
| User ID | `id` | `string` | yes |  | Unique identifier of the user |
| Options | `options` | `collection` | no | `{}` |  |
| User ID | `id` | `string` | yes |  | Unique identifier of the user |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
