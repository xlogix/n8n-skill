...
- Source file: `n8n-nodes-base/dist/nodes/Cortex/Cortex.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `analyzer`: `execute`
- resource `job`: `get`, `report`
- resource `responder`: `execute`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | yes | `analyzer` | Choose a resource |
| Operation | `operation` | `options` | yes | `execute` | Choose an operation |
| Analyzer Type Name or ID | `analyzer` | `options` | yes |  | Choose the analyzer. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Observable Type Name or ID | `observableType` | `options` | yes |  | Choose the observable type. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Observable Value | `observableValue` | `string` | yes |  | Enter the observable value |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| TLP | `tlp` | `options` | no | `2` | The TLP of the analyzed observable |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | yes | `execute` | Choose an operation |
| Responder Type Name or ID | `responder` | `options` | yes |  | Choose the responder. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Entity Type Name or ID | `entityType` | `options` | yes |  | Choose the Data type. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| JSON Parameters | `jsonObject` | `boolean` | no | `false` | Choose between providing JSON object or seperated attributes |
| Entity Object (JSON) | `objectData` | `string` | yes |  |  |
| Parameters | `parameters` | `fixedCollection` | no | `{}` |  |
| Parameters | `parameters` | `fixedCollection` | no | `{}` |  |
| Parameters | `parameters` | `fixedCollection` | no | `{}` |  |
| Parameters | `parameters` | `fixedCollection` | no | `{}` |  |
| Parameters | `parameters` | `fixedCollection` | no | `{}` |  |
| Operation | `operation` | `options` | yes | `get` | Choose an operation |
| Job ID | `jobId` | `string` | yes |  | ID of the job |
