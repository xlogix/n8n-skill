...
- Node name: `kafkaTrigger`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Kafka/KafkaTrigger.node.js`
...
|---|---|---|---|---|---|
| Topic | `topic` | `string` | yes |  | Name of the queue of topic to consume from |
| Group ID | `groupId` | `string` | yes |  | ID of the consumer group |
| Resolve Offset | `resolveOffset` | `options` | no | `onCompletion` | Select on which condition the offsets should be resolved. In the manual mode, when execution started by clicking on Execute Workflow or Execute Step button, offsets are always resolved immediately after message received. |
| Allowed Statuses | `allowedStatuses` | `multiOptions` | no | `["success"]` |  |
