...
- Source file: `n8n-nodes-base/dist/nodes/Zammad/Zammad.node.js`
- Node version: `1`
- Groups: `input`
...
## Credentials
- `zammadBasicAuthApi` (required)
- `zammadTokenAuthApi` (required)
...
### Operations
- resource `group`: `create`, `delete`, `get`, `getAll`, `update`
- resource `organization`: `create`, `delete`, `get`, `getAll`, `update`
- resource `ticket`: `create`, `delete`, `get`, `getAll`
- resource `user`: `create`, `delete`, `get`, `getAll`, `getSelf`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Authentication | `authentication` | `options` | no | `tokenAuth` |  |
| Resource | `resource` | `options` | no | `user` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Group Name | `name` | `string` | yes |  |  |
| Group ID | `id` | `string` | yes |  | Group to update. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Group ID | `id` | `string` | yes |  | Group to delete. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Group ID | `id` | `string` | yes |  | Group to retrieve. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
...
| Operation | `operation` | `options` | no | `create` |  |
| Organization Name | `name` | `string` | yes |  |  |
| Organization ID | `id` | `string` | yes |  | Organization to update. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Organization ID | `id` | `string` | yes |  | Organization to delete. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Organization ID | `id` | `string` | yes |  | Organization to retrieve. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
| Title | `title` | `string` | yes |  | Title of the ticket to create |
| Group Name or ID | `group` | `options` | yes |  | Group that will own the ticket to create. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Customer Email Name or ID | `customer` | `options` | yes |  | Email address of the customer concerned in the ticket to create. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Ticket ID | `id` | `string` | yes |  | Ticket to retrieve. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Ticket ID | `id` | `string` | yes |  | Ticket to delete. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Article | `article` | `fixedCollection` | yes | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
...
| User ID | `id` | `string` | yes |  | User to update. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| User ID | `id` | `string` | yes |  | User to delete. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| User ID | `id` | `string` | yes |  | User to retrieve. Specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
