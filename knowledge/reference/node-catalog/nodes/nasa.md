...
- Source file: `n8n-nodes-base/dist/nodes/Nasa/Nasa.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `asteroidNeoBrowse`: `getAll`
- resource `asteroidNeoFeed`: `get`
- resource `asteroidNeoLookup`: `get`
- resource `astronomyPictureOfTheDay`: `get`
- resource `donkiCoronalMassEjection`: `get`
- resource `donkiGeomagneticStorm`: `get`
- resource `donkiHighSpeedStream`: `get`
- resource `donkiInterplanetaryShock`: `get`
- resource `donkiMagnetopauseCrossing`: `get`
- resource `donkiNotifications`: `get`
- resource `donkiRadiationBeltEnhancement`: `get`
- resource `donkiSolarEnergeticParticle`: `get`
- resource `donkiSolarFlare`: `get`
- resource `donkiWsaEnlilSimulation`: `get`
- resource `earthAssets`: `get`
- resource `earthImagery`: `get`
- resource `imageAndVideoLibrary`: `get`
- resource `inSightMarsWeatherService`: `get`
- resource `techTransfer`: `get`
- resource `twoLineElementSet`: `get`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `astronomyPictureOfTheDay` |  |
...
| Operation | `operation` | `options` | no | `get` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Asteroid ID | `asteroidId` | `string` | yes |  | The ID of the asteroid to be returned |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Download Image | `download` | `boolean` | no | `true` | By default just the URL of the image is returned. When set to true the image will be downloaded. |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Latitude | `lat` | `number` | no |  | Latitude for the location of the image |
| Longitude | `lon` | `number` | no |  | Longitude for the location of the image |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
