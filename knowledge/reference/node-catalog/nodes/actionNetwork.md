...
- Node name: `actionNetwork`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/ActionNetwork/ActionNetwork.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `attendance`: `create`, `get`, `getAll`
- resource `event`: `create`, `get`, `getAll`
- resource `person`: `create`, `get`, `getAll`, `update`
- resource `personTag`: `add`, `remove`
- resource `petition`: `create`, `get`, `getAll`, `update`
- resource `signature`: `create`, `get`, `getAll`, `update`
- resource `tag`: `create`, `get`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `attendance` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Person ID | `personId` | `string` | yes |  | ID of the person to create an attendance for |
| Event ID | `eventId` | `string` | yes |  | ID of the event to create an attendance for |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Event ID | `eventId` | `string` | yes |  | ID of the event whose attendance to retrieve |
| Attendance ID | `attendanceId` | `string` | yes |  | ID of the attendance to retrieve |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Event ID | `eventId` | `string` | yes |  | ID of the event to create an attendance for |
...
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Operation | `operation` | `options` | no | `create` |  |
| Origin System | `originSystem` | `string` | yes |  | Source where the event originated |
| Title | `title` | `string` | yes |  | Title of the event to create |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Event ID | `eventId` | `string` | yes |  | ID of the event to retrieve |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Operation | `operation` | `options` | no | `create` |  |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Email Address | `email_addresses` | `fixedCollection` | no | `{}` | Person’s email addresses |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Person ID | `personId` | `string` | yes |  | ID of the person to retrieve |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `25` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Person ID | `personId` | `string` | yes |  | ID of the person to update |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Origin System | `originSystem` | `string` | yes |  | Source where the petition originated |
| Title | `title` | `string` | yes |  | Title of the petition to create |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Petition ID | `petitionId` | `string` | yes |  | ID of the petition to retrieve |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Petition ID | `petitionId` | `string` | yes |  | ID of the petition to update |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Petition ID | `petitionId` | `string` | yes |  | ID of the petition to sign |
| Person ID | `personId` | `string` | yes |  | ID of the person whose signature to create |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Petition ID | `petitionId` | `string` | yes |  | ID of the petition whose signature to retrieve |
| Signature ID | `signatureId` | `string` | yes |  | ID of the signature to retrieve |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Petition ID | `petitionId` | `string` | yes |  | ID of the petition whose signatures to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Petition ID | `petitionId` | `string` | yes |  | ID of the petition whose signature to update |
| Signature ID | `signatureId` | `string` | yes |  | ID of the signature to update |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | Name of the tag to create |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
...
| Tag Name or ID | `tagId` | `options` | yes | `[]` | ID of the tag to add. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Person ID | `personId` | `string` | yes |  | ID of the person to add the tag to |
| Tag Name or ID | `tagId` | `options` | yes | `[]` | ID of the tag whose tagging to delete. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Tagging Name or ID | `taggingId` | `options` | yes | `[]` | ID of the tagging to remove. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
