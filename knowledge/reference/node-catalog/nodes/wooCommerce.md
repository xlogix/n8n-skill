...
- Node name: `wooCommerce`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/WooCommerce/WooCommerce.node.js`
- Node version: `1`
- Groups: `output`
...
- resource `order`: `create`, `delete`, `get`, `getAll`, `update`
- resource `product`: `create`, `delete`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `product` |  |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Dimensions | `dimensionsUi` | `fixedCollection` | no | `{}` | Product dimensions |
| Images | `imagesUi` | `fixedCollection` | no | `{}` | Product Image |
...
| Operation | `operation` | `options` | no | `create` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Billing | `billingUi` | `fixedCollection` | no | `{}` | Billing address |
| Coupon Lines | `couponLinesUi` | `fixedCollection` | no | `{}` | Coupons line data |
| Fee Lines | `feeLinesUi` | `fixedCollection` | no | `{}` | Fee line data |
| Line Items | `lineItemsUi` | `fixedCollection` | no | `{}` | Line item data |
| Metadata | `metadataUi` | `fixedCollection` | no | `{}` | Meta data |
| Shipping | `shippingUi` | `fixedCollection` | no | `{}` | Shipping address |
| Shipping Lines | `shippingLinesUi` | `fixedCollection` | no | `{}` | Shipping line data |
| Order ID | `orderId` | `string` | no |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Billing | `billingUi` | `fixedCollection` | no | `{}` | Billing address |
| Coupon Lines | `couponLinesUi` | `fixedCollection` | no | `{}` | Coupons line data |
| Fee Lines | `feeLinesUi` | `fixedCollection` | no | `{}` | Fee line data |
