...
- Source file: `n8n-nodes-base/dist/nodes/Elastic/Elasticsearch/Elasticsearch.node.js`
- Node version: `1`
- Groups: `transform`
...
- resource `index`: `create`, `delete`, `get`, `getAll`
...
| Index ID | `indexId` | `string` | yes |  | ID of the index containing the document to delete |
| Document ID | `documentId` | `string` | yes |  | ID of the document to delete |
| Options | `options` | `collection` | no | `{}` |  |
| Index ID | `indexId` | `string` | yes |  | ID of the index containing the document to retrieve |
| Document ID | `documentId` | `string` | yes |  | ID of the document to retrieve |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Options | `options` | `collection` | no | `{}` |  |
| Index ID | `indexId` | `string` | yes |  | ID of the index containing the documents to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| By default, you cannot page through more than 10,000 hits. To page through more hits, add "Sort" from options. | `paginateNotice` | `notice` | no |  |  |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Options | `options` | `collection` | no | `{}` |  |
| Index ID | `indexId` | `string` | yes |  | ID of the index to add the document to |
...
| Options | `options` | `collection` | no | `{}` |  |
| Index ID | `indexId` | `string` | yes |  | ID of the document to update |
| Document ID | `documentId` | `string` | yes |  | ID of the document to update |
| Data to Send | `dataToSend` | `options` | no | `defineBelow` | Whether to insert the input data this node receives in the new row |
| Inputs to Ignore | `inputsToIgnore` | `string` | no |  | List of input properties to avoid sending, separated by commas. Leave empty to send all properties. |
| Fields to Send | `fieldsUi` | `fixedCollection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Index ID | `indexId` | `string` | yes |  | ID of the index to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Index ID | `indexId` | `string` | yes |  | ID of the index to delete |
| Index ID | `indexId` | `string` | yes |  | ID of the index to retrieve |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
