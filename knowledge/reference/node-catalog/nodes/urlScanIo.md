...
- Source file: `n8n-nodes-base/dist/nodes/UrlScanIo/UrlScanIo.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `scan`: `get`, `getAll`, `perform`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `scan` |  |
| Operation | `operation` | `options` | no | `perform` |  |
| Scan ID | `scanId` | `string` | no |  | ID of the scan to retrieve |
