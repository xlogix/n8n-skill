...
- Source file: `n8n-nodes-base/dist/nodes/Flow/Flow.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `task`: `create`, `get`, `getAll`, `update`
...
| Workspace ID | `workspaceId` | `string` | yes |  | Create resources under the given workspace |
| Name | `name` | `string` | yes |  | The title of the task |
