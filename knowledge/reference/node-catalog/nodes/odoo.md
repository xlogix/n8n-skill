...
- Source file: `n8n-nodes-base/dist/nodes/Odoo/Odoo.node.js`
- Node version: `1`
- Groups: `transform`
...
- resource `custom`: `create`, `delete`, `get`, `getAll`, `update`
...
| Custom Resource Name or ID | `customResource` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Operation | `operation` | `options` | no | `create` |  |
| Fields | `fieldsToCreateOrUpdate` | `fixedCollection` | no | `{}` |  |
| Custom Resource ID | `customResourceId` | `string` | yes |  |  |
...
| Filters | `filterRequest` | `fixedCollection` | no | `{}` | Filter request by applying filters |
| Custom Resource ID | `customResourceId` | `string` | yes |  |  |
| Update Fields | `fieldsToCreateOrUpdate` | `fixedCollection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `opportunityName` | `string` | yes |  |  |
