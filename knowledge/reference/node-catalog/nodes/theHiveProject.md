...
- Node name: `theHiveProject`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/TheHiveProject/TheHiveProject.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `alert`: `create`, `deleteAlert`, `executeResponder`, `get`, `merge`, `promote`, `search`, `status`, `update`
- resource `case`: `addAttachment`, `create`, `deleteAttachment`, `deleteCase`, `executeResponder`, `get`, `getAttachment`, `getTimeline`, `search`, `update`
- resource `comment`: `add`, `deleteComment`, `search`, `update`
- resource `log`: `addAttachment`, `create`, `deleteAttachment`, `deleteLog`, `executeResponder`, `get`, `search`
- resource `observable`: `create`, `deleteObservable`, `executeAnalyzer`, `executeResponder`, `get`, `search`, `update`
- resource `page`: `create`, `deletePage`, `search`, `update`
- resource `query`: `executeQuery`
- resource `task`: `create`, `deleteTask`, `executeResponder`, `get`, `search`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | yes | `alert` |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Fields | `alertFields` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Observables | `observableUi` | `fixedCollection` | no | `{}` |  |
| Alert | `alertId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Alert | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Responder Name or ID | `responder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Alert | `alertId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
...
| Options | `options` | `collection` | no | `{}` |  |
| Alert | `alertId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Status Name or ID | `status` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Alert | `alertId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Alert | `alertId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Fields | `alertUpdateFields` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Attachments | `attachmentsUi` | `fixedCollection` | no | `{}` | Array of supported attachments to add to the message |
| Options | `options` | `collection` | no | `{}` |  |
| Fields | `caseFields` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Attachment Name or ID | `attachmentId` | `options` | yes |  | ID of the attachment. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Case | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Responder Name or ID | `responder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Attachment Name or ID | `attachmentId` | `options` | yes |  | ID of the attachment. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
...
| Options | `options` | `collection` | no | `{}` |  |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Fields | `caseUpdateFields` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Operation | `operation` | `options` | yes | `add` |  |
| Add to | `addTo` | `options` | no | `alert` |  |
| Case | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Alert | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Message | `message` | `string` | yes |  |  |
| Comment | `commentId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Search in | `searchIn` | `options` | no | `all` | Whether to search for comments in all alerts and cases or in a specific case or alert |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Alert | `alertId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
...
| Message | `message` | `string` | yes |  |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Task Log | `logId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Attachments | `attachmentsUi` | `fixedCollection` | no | `{}` | Array of supported attachments to add to the message |
| Task | `taskId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Fields | `logFields` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Attachments | `attachmentsUi` | `fixedCollection` | no | `{}` | Array of supported attachments to add to the message |
| Task Log | `logId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Attachment Name or ID | `attachmentId` | `options` | yes |  | ID of the attachment. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Task Log | `logId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Task Log | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Responder Name or ID | `responder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Task Log | `logId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Search in All Tasks | `allTasks` | `boolean` | no | `true` | Whether to search in all tasks or only in selected task |
| Task | `taskId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `fixedCollection` | no | `{}` |  |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Create in | `createIn` | `options` | no | `case` |  |
| Case | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Alert | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Data Type | `dataType` | `options` | yes | `file` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Data | `data` | `string` | yes |  |  |
| Attachments | `attachmentsUi` | `fixedCollection` | yes | `{}` | Array of supported attachments to add to the message |
| Fields | `observableFields` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Observable | `observableId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Observable | `observableId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Data Type | `dataType` | `options` | no |  | Type of the observable. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Analyzer Names or IDs | `analyzers` | `multiOptions` | yes | `[]` | Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Observable | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Responder Name or ID | `responder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Observable | `observableId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Search in | `searchIn` | `options` | no | `all` | Whether to search for observables in all alerts and cases or in a specific case or alert |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Alert | `alertId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
...
| Sort | `sort` | `fixedCollection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Fields | `observableUpdateFields` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Create in | `location` | `options` | no | `case` |  |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Title | `title` | `string` | yes |  |  |
| Category | `category` | `string` | yes |  |  |
| Content | `content` | `string` | yes |  |  |
| Delete From ... | `location` | `options` | no | `knowledgeBase` |  |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Page | `pageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Search in Knowledge Base | `searchInKnowledgeBase` | `boolean` | no | `true` | Whether to search in knowledge base or only in the selected case |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `fixedCollection` | no | `{}` |  |
| Sort | `sort` | `fixedCollection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Update in | `location` | `options` | no | `case` |  |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Page | `pageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Content | `content` | `string` | no |  |  |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | yes | `executeQuery` |  |
| Query | `queryJson` | `json` | yes | `=[
  {
...
| Operation | `operation` | `options` | yes | `create` |  |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Fields | `taskFields` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Task | `taskId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Task | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Responder Name or ID | `responder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Task | `taskId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Search in All Cases | `allCases` | `boolean` | no | `true` | Whether to search in all cases or only in a selected case |
| Case | `caseId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `fixedCollection` | no | `{}` |  |
| Sort | `sort` | `fixedCollection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Fields | `taskUpdateFields` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
