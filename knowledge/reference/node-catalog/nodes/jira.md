...
- Source file: `n8n-nodes-base/dist/nodes/Jira/Jira.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `issue`: `changelog`, `create`, `delete`, `get`, `getAll`, `notify`, `transitions`, `update`
- resource `issueAttachment`: `add`, `get`, `getAll`, `remove`
- resource `issueComment`: `add`, `get`, `getAll`, `remove`, `update`
- resource `user`: `create`, `delete`, `get`
...
| Project | `project` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Issue Type | `issueType` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Summary | `summary` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Issue Key | `issueKey` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Issue Key | `issueKey` | `string` | yes |  |  |
| Delete Subtasks | `deleteSubtasks` | `boolean` | yes | `false` |  |
| Issue Key | `issueKey` | `string` | yes |  |  |
| Simplify | `simplifyOutput` | `boolean` | no | `false` | Whether to return a simplified version of the response instead of the raw data |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Notification Recipients | `notificationRecipientsUi` | `fixedCollection` | no | `{}` | The recipients of the email notification for the issue |
| Notification Recipients | `notificationRecipientsJson` | `json` | no |  | The recipients of the email notification for the issue |
| Notification Recipients Restrictions | `notificationRecipientsRestrictionsUi` | `fixedCollection` | no | `{}` | Restricts the notifications to users with the specified permissions |
| Notification Recipients Restrictions | `notificationRecipientsRestrictionsJson` | `json` | no |  | Restricts the notifications to users with the specified permissions |
| Issue Key | `issueKey` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `add` |  |
| Issue Key | `issueKey` | `string` | yes |  |  |
| Input Binary Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Attachment ID | `attachmentId` | `string` | yes |  | The ID of the attachment |
| Download | `download` | `boolean` | yes | `false` |  |
...
| Attachment ID | `attachmentId` | `string` | yes |  | The ID of the attachment |
| Operation | `operation` | `options` | no | `add` |  |
| Issue Key | `issueKey` | `string` | yes |  | issueComment Key |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Comment | `comment` | `string` | no |  | Comment's text |
| Document Format (JSON) | `commentJson` | `json` | no |  | The Atlassian Document Format (ADF). Online builder can be found <a href="https://developer.atlassian.com/cloud/jira/platform/apis/document/playground/">here</a>. |
| Options | `options` | `collection` | no | `{}` |  |
| Issue Key | `issueKey` | `string` | yes |  | The ID or key of the issue |
| Comment ID | `commentId` | `string` | yes |  | The ID of the comment |
| Options | `options` | `collection` | no | `{}` |  |
| Issue Key | `issueKey` | `string` | yes |  | The ID or key of the issue |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
...
| Issue Key | `issueKey` | `string` | yes |  | The ID or key of the issue |
| Comment ID | `commentId` | `string` | yes |  | The ID of the comment |
| Issue Key | `issueKey` | `string` | yes |  | The Issue Comment key |
| Comment ID | `commentId` | `string` | yes |  | The ID of the comment |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Comment | `comment` | `string` | no |  | Comment's text |
| Document Format (JSON) | `commentJson` | `json` | no |  | The Atlassian Document Format (ADF). Online builder can be found <a href="https://developer.atlassian.com/cloud/jira/platform/apis/document/playground/">here</a>. |
...
| Email Address | `emailAddress` | `string` | yes |  |  |
| Display Name | `displayName` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Account ID | `accountId` | `string` | no |  | Account ID of the user to delete |
| Account ID | `accountId` | `string` | no |  | Account ID of the user to retrieve |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
