...
- Source file: `n8n-nodes-base/dist/nodes/Zendesk/Zendesk.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `organization`: `count`, `create`, `delete`, `get`, `getAll`, `getRelatedData`, `update`
- resource `ticket`: `create`, `delete`, `get`, `getAll`, `recover`, `update`
- resource `ticketField`: `get`, `getAll`
- resource `user`: `create`, `delete`, `get`, `getAll`, `getOrganizations`, `getRelatedData`, `search`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Authentication | `authentication` | `options` | no | `apiToken` |  |
| Resource | `resource` | `options` | no | `ticket` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Description | `description` | `string` | yes |  | The first comment on the ticket |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFieldsJson` | `json` | no |  | Object of values to set as described <a href="https://developer.zendesk.com/rest_api/docs/support/tickets">here</a> |
| Ticket ID | `id` | `string` | yes |  |  |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Update Fields | `updateFieldsJson` | `json` | no |  | Object of values to update as described <a href="https://developer.zendesk.com/rest_api/docs/support/tickets">here</a> |
| Ticket Type | `ticketType` | `options` | yes | `regular` |  |
| Ticket ID | `id` | `string` | yes |  |  |
| Suspended Ticket ID | `id` | `string` | yes |  | Ticket ID |
...
| Ticket ID | `id` | `string` | yes |  |  |
| Suspended Ticket ID | `id` | `string` | yes |  | Ticket ID |
| Suspended Ticket ID | `id` | `string` | yes |  |  |
| Operation | `operation` | `options` | no | `get` |  |
| Ticket Field ID | `ticketFieldId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | The user's name |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| User ID | `id` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| User ID | `id` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
