...
- Node name: `githubTrigger`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Github/GithubTrigger.node.js`
- Node version: `1`
- Groups: `trigger`
...
|---|---|---|---|---|---|
| Only members with owner privileges for an organization or admin privileges for a repository can set up the webhooks this node requires. | `notice` | `notice` | no |  |  |
