...
- Node name: `venafiTlsProtectDatacenter`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Venafi/Datacenter/VenafiTlsProtectDatacenter.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `certificate`: `create`, `delete`, `download`, `get`, `getMany`, `renew`
- resource `policy`: `get`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `certificate` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Policy DN | `PolicyDN` | `string` | no |  | The folder DN for the new certificate. If the value is missing, the folder name is the system default. If no system default is configured |
| Subject | `Subject` | `string` | no |  | The Common Name field for the certificate Subject (DN) |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Certificate DN | `certificateDn` | `string` | yes |  |  |
| Include Private Key | `includePrivateKey` | `boolean` | no | `false` |  |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Certificate GUID | `certificateId` | `string` | yes |  | A GUID that uniquely identifies the certificate |
...
| Certificate DN | `certificateDN` | `string` | yes |  | The Distinguished Name (DN) of the certificate to renew |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Policy DN | `policyDn` | `string` | yes |  | The Distinguished Name (DN) of the policy folder |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
