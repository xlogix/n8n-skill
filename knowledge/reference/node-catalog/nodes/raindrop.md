...
- Source file: `n8n-nodes-base/dist/nodes/Raindrop/Raindrop.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `bookmark`: `create`, `delete`, `get`, `getAll`, `update`
- resource `collection`: `create`, `delete`, `get`, `getAll`, `update`
- resource `tag`: `delete`, `getAll`
- resource `user`: `get`
...
| Collection Name or ID | `collectionId` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Link | `link` | `string` | yes |  | Link of the bookmark to be created |
...
| Collection Name or ID | `collectionId` | `options` | yes | `[]` | The ID of the collection from which to retrieve all bookmarks. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
...
| Operation | `operation` | `options` | no | `get` |  |
| Title | `title` | `string` | yes |  | Title of the collection to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Type | `type` | `options` | yes | `parent` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Collection ID | `collectionId` | `string` | yes |  | The ID of the collection to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Tags | `tags` | `string` | yes |  | One or more tags to delete. Enter comma-separated values to delete multiple tags. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Self | `self` | `boolean` | yes | `true` | Whether to return details on the logged-in user |
| User ID | `userId` | `string` | yes |  | The ID of the user to retrieve |
