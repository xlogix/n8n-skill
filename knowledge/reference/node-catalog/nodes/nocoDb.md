...
- Source file: `n8n-nodes-base/dist/nodes/NocoDB/NocoDB.node.js`
- Node version: `[1,2,3]`
- Groups: `input`
...
### Operations
- resource `row`: `create`, `delete`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Authentication | `authentication` | `options` | no | `nocoDb` |  |
| API Version | `version` | `options` | no | `1` |  |
| API Version | `version` | `options` | no | `2` |  |
| API Version | `version` | `options` | no | `3` |  |
| Resource | `resource` | `options` | no | `row` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Workspace Name or ID | `workspaceId` | `options` | no | `none` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Base Name or ID | `projectId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Project ID | `projectId` | `string` | yes |  | The ID of the project |
...
| Table Name or ID | `table` | `options` | yes |  | The table to operate on. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Table | `table` | `string` | yes |  | The name of the table |
| Primary Key Type | `primaryKey` | `options` | no | `id` |  |
| Primary Key Type | `primaryKey` | `options` | no | `id` |  |
| Field Name | `customPrimaryKey` | `string` | no |  |  |
| Field Name | `customPrimaryKey` | `string` | no |  |  |
| Row ID Value | `id` | `string` | yes |  | The value of the ID field |
| Row ID Value | `id` | `string` | yes |  | The value of the ID field |
...
| In this mode, make sure the incoming data fields are named the same as the columns in NocoDB. (Use an 'Edit Fields' node before this node to change them if required.) | `info` | `notice` | no |  |  |
| This operation requires the primary key to be included for each row. | `info` | `notice` | no |  |  |
