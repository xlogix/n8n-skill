...
- Source file: `n8n-nodes-base/dist/nodes/Clockify/Clockify.node.js`
- Node version: `1`
- Groups: `transform`
...
- resource `timeEntry`: `create`, `delete`, `get`, `update`
- resource `user`: `getAll`
- resource `workspace`: `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `project` |  |
...
| Client Name | `name` | `string` | yes |  | Name of client being created |
| Client ID | `clientId` | `string` | no |  |  |
| Client ID | `clientId` | `string` | no |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
...
| Project Name | `name` | `string` | yes |  | Name of project being created |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Project ID | `projectId` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Name | `name` | `string` | yes |  | Name of tag being created |
| Tag ID | `tagId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Tag ID | `tagId` | `string` | yes |  |  |
...
| Task Name | `name` | `string` | yes |  | Name of task to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Task ID | `taskId` | `string` | yes |  | ID of task to delete |
| Task ID | `taskId` | `string` | yes |  | ID of task to get |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Task ID | `taskId` | `string` | yes |  | ID of task to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Time Entry ID | `timeEntryId` | `string` | yes |  |  |
| Time Entry ID | `timeEntryId` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Time Entry ID | `timeEntryId` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
