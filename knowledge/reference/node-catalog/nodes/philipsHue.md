...
- Node name: `philipsHue`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/PhilipsHue/PhilipsHue.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `light`: `delete`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `light` |  |
| Operation | `operation` | `options` | no | `update` |  |
| Light ID | `lightId` | `string` | yes |  |  |
...
| Light ID | `lightId` | `string` | yes |  |  |
| Light Name or ID | `lightId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| On | `on` | `boolean` | yes | `true` | On/Off state of the light |
