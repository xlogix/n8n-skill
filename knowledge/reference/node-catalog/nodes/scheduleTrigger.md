...
- Node name: `scheduleTrigger`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Schedule/ScheduleTrigger.node.js`
...
| Trigger Rules | `rule` | `fixedCollection` | no | `{"interval":[{"field":"days"}]}` |  |
