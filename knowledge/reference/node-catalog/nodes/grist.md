...
- Source file: `n8n-nodes-base/dist/nodes/Grist/Grist.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- default/all resources: `create`, `delete`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Operation | `operation` | `options` | no | `getAll` |  |
| Document ID | `docId` | `string` | yes |  | In your document, click your profile icon, then Document Settings, then copy the value under "This document's ID" |
| Table ID | `tableId` | `string` | yes |  | ID of table to operate on. If unsure, look at the Code View. |
| Row ID | `rowId` | `string` | yes |  | ID of the row to delete, or comma-separated list of row IDs to delete |
...
| Data to Send | `dataToSend` | `options` | no | `defineInNode` | Whether to insert the input data this node receives in the new row |
