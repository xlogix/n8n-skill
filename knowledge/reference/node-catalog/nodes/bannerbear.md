...
- Source file: `n8n-nodes-base/dist/nodes/Bannerbear/Bannerbear.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `image`: `create`, `get`
- resource `template`: `get`, `getAll`
...
| Template Name or ID | `templateId` | `options` | yes |  | The template ID you want to use. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Modifications | `modificationsUi` | `fixedCollection` | no | `{}` |  |
| Image ID | `imageId` | `string` | yes |  | Unique identifier for the image |
| Operation | `operation` | `options` | no | `get` |  |
| Template ID | `templateId` | `string` | yes |  | Unique identifier for the template |
