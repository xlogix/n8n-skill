...
- Source file: `n8n-nodes-base/dist/nodes/TheHive/TheHive.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `log`: `create`, `executeResponder`, `get`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | yes | `alert` |  |
| Operation Name or ID | `operation` | `options` | yes | `create` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
...
| Alert ID | `id` | `string` | yes |  | Title of the alert |
| Case ID | `caseId` | `string` | yes |  |  |
| Title | `title` | `string` | yes |  | Title of the alert |
| Description | `description` | `string` | yes |  | Description of the alert |
| Severity | `severity` | `options` | yes | `2` | Severity of the alert. Default=Medium. |
| Date | `date` | `dateTime` | yes |  | Date and time when the alert was raised default=now |
| Tags | `tags` | `string` | yes |  | Case Tags |
| TLP | `tlp` | `options` | yes | `2` | Traffict Light Protocol (TLP). Default=Amber. |
| Status | `status` | `options` | yes | `New` | Status of the alert |
| Type | `type` | `string` | yes |  | Type of the alert |
| Source | `source` | `string` | yes |  | Source of the alert |
| SourceRef | `sourceRef` | `string` | yes |  | Source reference of the alert |
| Follow | `follow` | `boolean` | yes | `true` | Whether the alert becomes active when updated default=true |
| Artifacts | `artifactUi` | `fixedCollection` | no | `{}` | Artifact attributes |
...
| JSON Parameters | `jsonParameters` | `boolean` | no | `true` |  |
...
| Operation Name or ID | `operation` | `options` | yes | `getAll` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Case ID | `caseId` | `string` | yes |  | ID of the case |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Observable ID | `id` | `string` | yes |  | ID of the observable |
| Data Type Name or ID | `dataType` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Data | `data` | `string` | yes |  |  |
| Input Binary Field | `binaryProperty` | `string` | yes | `data` | The name of the input binary field that represent the attachment file |
| Message | `message` | `string` | yes |  | Description of the observable in the context of the case |
| Start Date | `startDate` | `dateTime` | yes |  | Date and time of the begin of the case default=now |
| TLP | `tlp` | `options` | yes | `2` | Traffict Light Protocol (TLP). Default=Amber. |
| IOC | `ioc` | `boolean` | yes | `false` | Whether the observable is an IOC (Indicator of compromise) |
| Sighted | `sighted` | `boolean` | yes | `false` | Whether sighted previously |
| Status | `status` | `options` | yes |  | Status of the observable. Default=Ok. |
...
| Options | `options` | `collection` | no | `{}` |  |
| Filters | `filters` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | yes | `getAll` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Case ID | `id` | `string` | yes |  | ID of the case |
| Title | `title` | `string` | yes |  | Title of the case |
| Description | `description` | `string` | yes |  | Description of the case |
| Severity | `severity` | `options` | yes | `2` | Severity of the alert. Default=Medium. |
| Start Date | `startDate` | `dateTime` | yes |  | Date and time of the begin of the case default=now |
| Owner | `owner` | `string` | yes |  |  |
| Flag | `flag` | `boolean` | yes | `false` | Flag of the case default=false |
| TLP | `tlp` | `options` | yes | `2` | Traffict Light Protocol (TLP). Default=Amber. |
...
| Filters | `filters` | `collection` | no | `{}` |  |
| Operation Name or ID | `operation` | `options` | yes | `getAll` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Task ID | `id` | `string` | yes |  | ID of the taks |
| Case ID | `caseId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Title | `title` | `string` | yes |  | Task details |
| Status | `status` | `options` | yes | `Waiting` | Status of the task. Default=Waiting. |
| Flag | `flag` | `boolean` | yes | `false` | Whether to flag the task. Default=false. |
| Responder Name or ID | `responder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Options | `options` | `collection` | no | `{}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Filters | `filters` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | yes | `getAll` |  |
| Task ID | `taskId` | `string` | yes |  | ID of the task |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Log ID | `id` | `string` | yes |  |  |
| Message | `message` | `string` | yes |  | Content of the Log |
| Start Date | `startDate` | `dateTime` | yes |  | Date of the log submission default=now |
| Status | `status` | `options` | yes |  | Status of the log (Ok or Deleted) default=Ok |
| Responder Name or ID | `responder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Options | `options` | `collection` | no | `{}` |  |
