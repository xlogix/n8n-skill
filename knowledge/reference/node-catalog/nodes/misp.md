...
- Source file: `n8n-nodes-base/dist/nodes/Misp/Misp.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `attribute`: `create`, `delete`, `get`, `getAll`, `search`, `update`
- resource `event`: `create`, `delete`, `get`, `getAll`, `publish`, `search`, `unpublish`, `update`
- resource `eventTag`: `add`, `remove`
- resource `feed`: `create`, `disable`, `enable`, `get`, `getAll`, `update`
- resource `galaxy`: `delete`, `get`, `getAll`
- resource `noticelist`: `get`, `getAll`
- resource `object`: `search`
- resource `organisation`: `create`, `delete`, `get`, `getAll`, `update`
- resource `tag`: `create`, `delete`, `getAll`, `update`
- resource `user`: `create`, `delete`, `get`, `getAll`, `update`
- resource `warninglist`: `get`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `attribute` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Event UUID | `eventId` | `string` | yes |  | UUID of the event to attach the attribute to |
| Type | `type` | `options` | yes | `text` |  |
| Value | `value` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Attribute ID | `attributeId` | `string` | yes |  | UUID or numeric ID of the attribute |
| Attribute ID | `attributeId` | `string` | yes |  | UUID or numeric ID of the attribute |
...
| Use JSON to Specify Fields | `useJson` | `boolean` | no | `false` | Whether to use JSON to specify the fields for the search request |
...
| Value | `value` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Attribute ID | `attributeId` | `string` | yes |  | ID of the attribute to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Organization Name or ID | `org_id` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Information | `information` | `string` | yes |  | Information on the event - max 65535 characters |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Event ID | `eventId` | `string` | yes |  | UUID or numeric ID of the event |
| Event ID | `eventId` | `string` | yes |  | UUID or numeric ID of the event |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Event ID | `eventId` | `string` | yes |  | UUID or numeric ID of the event |
...
| URL | `url` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Feed ID | `feedId` | `string` | yes |  | UUID or numeric ID of the feed |
| Feed ID | `feedId` | `string` | yes |  | UUID or numeric ID of the feed |
| Feed ID | `feedId` | `string` | yes |  | UUID or numeric ID of the feed |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Feed ID | `feedId` | `string` | yes |  | ID of the feed to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Galaxy ID | `galaxyId` | `string` | yes |  | UUID or numeric ID of the galaxy |
| Galaxy ID | `galaxyId` | `string` | yes |  | UUID or numeric ID of the galaxy |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `get` |  |
| Noticelist ID | `noticelistId` | `string` | yes |  | Numeric ID of the noticelist |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
...
| Name | `name` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Organisation ID | `organisationId` | `string` | yes |  | UUID or numeric ID of the organisation |
| Organisation ID | `organisationId` | `string` | yes |  | UUID or numeric ID of the organisation |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Organisation ID | `organisationId` | `string` | yes |  | ID of the organisation to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Tag ID | `tagId` | `string` | yes |  | Numeric ID of the attribute |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
...
| Role ID | `role_id` | `string` | yes |  | Role IDs are available in the MISP dashboard at /roles/index |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| User ID | `userId` | `string` | yes |  | Numeric ID of the user |
| User ID | `userId` | `string` | yes |  | Numeric ID of the user |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Warninglist ID | `warninglistId` | `string` | yes |  | Numeric ID of the warninglist |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
