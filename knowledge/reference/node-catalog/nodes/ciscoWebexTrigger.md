...
- Node name: `ciscoWebexTrigger`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Cisco/Webex/CiscoWebexTrigger.node.js`
- Node version: `1`
- Groups: `trigger`
...
|---|---|---|---|---|---|
| Resource | `resource` | `options` | yes | `meeting` |  |
...
| Event | `event` | `options` | yes |  |  |
| Event | `event` | `options` | yes |  |  |
| Resolve Data | `resolveData` | `boolean` | no | `true` | By default the response only contain a reference to the data the user inputed. If this option gets activated, it will resolve the data automatically. |
