...
- Source file: `n8n-nodes-base/dist/nodes/CrateDb/CrateDb.node.js`
- Node version: `1`
- Groups: `input`
...
| Schema | `schema` | `string` | yes | `doc` | Name of the schema the table belongs to |
...
| Update Key | `updateKey` | `string` | yes | `id` | Comma-separated list of the properties which decides which rows in the database should be updated. Normally that would be "id". |
