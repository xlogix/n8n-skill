...
- Source file: `n8n-nodes-base/dist/nodes/Pipedrive/Pipedrive.node.js`
- Node version: `1`
- Groups: `transform`
...
- resource `deal`: `create`, `delete`, `duplicate`, `get`, `getAll`, `search`, `update`
- resource `dealActivity`: `getAll`
- resource `dealProduct`: `add`, `getAll`, `remove`, `update`
- resource `file`: `create`, `delete`, `download`, `get`, `update`
- resource `lead`: `create`, `delete`, `get`, `getAll`, `update`
- resource `note`: `create`, `delete`, `get`, `getAll`, `update`
- resource `organization`: `create`, `delete`, `get`, `getAll`, `search`, `update`
- resource `person`: `create`, `delete`, `get`, `getAll`, `search`, `update`
- resource `product`: `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Authentication | `authentication` | `options` | no | `apiToken` |  |
| Resource | `resource` | `options` | no | `deal` |  |
...
| Operation | `operation` | `options` | no | `create` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Subject | `subject` | `string` | yes |  | The subject of the activity to create |
| Done | `done` | `options` | no | `0` | Whether the activity is done or not |
| Type | `type` | `string` | yes |  | Type of the activity like "call", "meeting", etc |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Activity ID | `activityId` | `number` | yes | `0` | ID of the activity to delete |
| Activity ID | `activityId` | `number` | yes | `0` | ID of the activity to get |
| Activity ID | `activityId` | `number` | yes | `0` | ID of the activity to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Title | `title` | `string` | yes |  | The title of the deal to create |
| Associate With | `associateWith` | `options` | yes | `organization` | Type of entity to link to this deal |
| Organization ID | `org_id` | `number` | yes | `0` | ID of the organization this deal will be associated with |
| Person ID | `person_id` | `number` | no | `0` | ID of the person this deal will be associated with |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Deal ID | `dealId` | `number` | yes | `0` | ID of the deal to delete |
| Deal ID | `dealId` | `number` | yes | `0` | ID of the deal to duplicate |
| Deal ID | `dealId` | `number` | yes | `0` | ID of the deal to get |
| Deal ID | `dealId` | `number` | yes | `0` | ID of the deal to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Deal Name or ID | `dealId` | `options` | yes |  | The ID of the deal to add a product to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Product Name or ID | `productId` | `options` | yes |  | The ID of the product to add to a deal. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Item Price | `item_price` | `number` | yes | `0` | Price at which to add or update this product in a deal |
| Quantity | `quantity` | `number` | yes | `1` | How many items of this product to add/update in a deal |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Deal Name or ID | `dealId` | `options` | yes |  | The ID of the deal whose product to update. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Product Attachment Name or ID | `productAttachmentId` | `options` | yes |  | ID of the deal-product (the ID of the product attached to the deal). Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Deal Name or ID | `dealId` | `options` | yes |  | The ID of the deal whose product to remove. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Product Attachment Name or ID | `productAttachmentId` | `options` | yes |  | ID of the deal-product (the ID of the product attached to the deal). Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Deal Name or ID | `dealId` | `options` | yes |  | The ID of the deal whose products to retrieve. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Term | `term` | `string` | yes |  | The search term to look for. Minimum 2 characters (or 1 if using exact_match). |
| Exact Match | `exactMatch` | `boolean` | no | `false` | Whether only full exact matches against the given term are returned. It is not case sensitive. |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| File ID | `fileId` | `number` | yes | `0` | ID of the file to delete |
| File ID | `fileId` | `number` | yes | `0` | ID of the file to download |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| File ID | `fileId` | `number` | yes | `0` | ID of the file to get |
| File ID | `fileId` | `number` | yes | `0` | ID of the file to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Title | `title` | `string` | yes |  | Name of the lead to create |
| Associate With | `associateWith` | `options` | yes | `organization` | Type of entity to link to this lead |
| Organization ID | `organization_id` | `number` | yes | `0` | ID of the organization to link to this lead |
| Person ID | `person_id` | `number` | yes | `0` | ID of the person to link to this lead |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Lead ID | `leadId` | `string` | yes |  | ID of the lead to delete |
| Lead ID | `leadId` | `string` | yes |  | ID of the lead to retrieve |
| Lead ID | `leadId` | `string` | yes |  | ID of the lead to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Content | `content` | `string` | yes |  | The content of the note to create |
| Note ID | `noteId` | `number` | yes | `0` | ID of the note to delete |
| Note ID | `noteId` | `number` | yes | `0` | ID of the note to get |
| Note ID | `noteId` | `number` | yes | `0` | ID of the note to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Name | `name` | `string` | yes |  | The name of the organization to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Organization ID | `organizationId` | `number` | yes | `0` | ID of the organization to delete |
| Organization ID | `organizationId` | `number` | yes | `0` | ID of the organization to get |
| Term | `term` | `string` | yes |  | The search term to look for. Minimum 2 characters (or 1 if using exact_match). |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Organization ID | `organizationId` | `number` | yes |  | The ID of the organization to create |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Name | `name` | `string` | yes |  | The name of the person to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Person ID | `personId` | `number` | yes | `0` | ID of the person to delete |
| Person ID | `personId` | `number` | yes | `0` | ID of the person to get |
| Person ID | `personId` | `number` | yes | `0` | ID of the person to update |
| Update Fields | `updateFields` | `collection` | no | `{}` | The fields to update |
| Resolve Properties | `resolveProperties` | `boolean` | no | `false` | By default do custom properties get returned only as ID instead of their actual name. Also option fields contain only the ID instead of their actual value. If this option gets set they get automatically resolved. |
| Encode Properties | `encodeProperties` | `boolean` | no | `false` | By default do custom properties have to be set as ID instead of their actual name. Also option fields have to be set as ID instead of their actual value. If this option gets set they get automatically encoded. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Deal Name or ID | `dealId` | `options` | yes |  | The ID of the deal whose activity to retrieve. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
