...
- Node name: `sendInBlue`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Brevo/Brevo.node.js`
- Node version: `1`
- Groups: `transform`
...
| Type | `attributeType` | `options` | yes |  | Attribute Type |
| Value | `attributeValue` | `string` | yes |  | Value of the attribute |
| Contact Attribute List | `attributeCategoryList` | `collection` | no | `{}` |  |
| Category | `updateAttributeCategory` | `options` | no | `calculated` | Category of the attribute |
| Name | `updateAttributeName` | `string` | no |  | Name of the existing attribute |
| Value | `updateAttributeValue` | `string` | no |  | Value of the attribute to update |
| Update Fields | `updateAttributeCategoryList` | `collection` | no | `{}` | List of the values and labels that the attribute can take |
| Category | `deleteAttributeCategory` | `options` | no | `normal` | Category of the attribute |
| Name | `deleteAttributeName` | `string` | no |  | Name of the attribute |
...
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | Name of the sender |
| Email | `email` | `string` | yes |  | Email of the sender |
| Sender ID | `id` | `string` | no |  | ID of the sender to delete |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `10` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
| Email | `email` | `string` | no |  |  |
| Contact Attributes | `createContactAttributes` | `fixedCollection` | no | `{}` | Array of attributes to be added |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Filters | `filters` | `collection` | no | `{}` |  |
| Contact Identifier | `identifier` | `string` | yes |  | Email (urlencoded) OR ID of the contact OR its SMS attribute value |
| Contact Identifier | `identifier` | `string` | no |  | Email (urlencoded) OR ID of the contact OR its SMS attribute value |
| Contact Identifier | `identifier` | `string` | yes |  | Email (urlencoded) OR ID of the contact OR its SMS attribute value |
| Attributes | `updateAttributes` | `fixedCollection` | no | `{}` | Array of attributes to be updated |
| Email | `email` | `string` | yes |  | Email of the contact |
| Contact Attributes | `upsertAttributes` | `fixedCollection` | no | `{}` | Array of attributes to be updated |
| Operation | `operation` | `options` | no | `send` |  |
| Send HTML | `sendHTML` | `boolean` | no | `false` |  |
| Subject | `subject` | `string` | no |  | Subject of the email |
| Text Content | `textContent` | `string` | no |  | Text content of the message |
| HTML Content | `htmlContent` | `string` | no |  | HTML content of the message |
| Sender | `sender` | `string` | yes |  |  |
| Receipients | `receipients` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` | Additional fields to add |
| Template ID | `templateId` | `options` | no |  |  |
| Receipients | `receipients` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` | Additional fields to add |
