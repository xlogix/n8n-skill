...
- Source file: `n8n-nodes-base/dist/nodes/Twist/Twist.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `channel`: `archive`, `create`, `delete`, `get`, `getAll`, `unarchive`, `update`
- resource `comment`: `create`, `delete`, `get`, `getAll`, `update`
- resource `messageConversation`: `create`, `delete`, `get`, `getAll`, `update`
- resource `thread`: `create`, `delete`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `messageConversation` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Workspace Name or ID | `workspaceId` | `options` | yes |  | The ID of the workspace. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Name | `name` | `string` | yes |  | The name of the channel |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Channel ID | `channelId` | `string` | yes |  | The ID of the channel |
| Workspace Name or ID | `workspaceId` | `options` | yes |  | The ID of the workspace. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
...
| Operation | `operation` | `options` | no | `create` |  |
| Thread ID | `threadId` | `string` | yes |  | The ID of the thread |
| Content | `content` | `string` | yes |  | The content of the comment |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Comment ID | `commentId` | `string` | yes |  | The ID of the comment |
| Thread ID | `threadId` | `string` | yes |  | The ID of the channel |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Comment ID | `commentId` | `string` | yes |  | The ID of the comment |
...
| Operation | `operation` | `options` | no | `create` |  |
| Workspace Name or ID | `workspaceId` | `options` | yes |  | The ID of the workspace. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Conversation Name or ID | `conversationId` | `options` | yes |  | The ID of the conversation. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Content | `content` | `string` | no |  | The content of the new message. Mentions can be used as <code>[Name](twist-mention://user_id)</code> for users or <code>[Group name](twist-group-mention://group_id)</code> for groups. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` | Other options to set |
| Workspace Name or ID | `workspaceId` | `options` | yes |  | The ID of the workspace. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Conversation Name or ID | `conversationId` | `options` | yes |  | The ID of the conversation. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` | Other options to set |
| Message ID | `id` | `string` | yes |  | The ID of the conversation message |
| Conversation Message ID | `id` | `string` | yes |  | The ID of the conversation message |
| Update Fields | `updateFields` | `collection` | no | `{}` | Other options to set |
| Operation | `operation` | `options` | no | `create` |  |
| Channel ID | `channelId` | `string` | yes |  | The ID of the channel |
| Title | `title` | `string` | yes |  | The title of the new thread (1 < length < 300) |
| Content | `content` | `string` | yes |  | The content of the thread |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Thread ID | `threadId` | `string` | yes |  | The ID of the thread |
| Channel ID | `channelId` | `string` | yes |  | The ID of the channel |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
