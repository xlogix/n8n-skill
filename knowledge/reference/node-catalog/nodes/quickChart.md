...
- Source file: `n8n-nodes-base/dist/nodes/QuickChart/QuickChart.node.js`
- Node version: `1`
- Groups: `output`
...
|---|---|---|---|---|---|
| Chart Type | `chartType` | `options` | no | `bar` | The type of chart to create |
| Add Labels | `labelsMode` | `options` | no | `manually` |  |
| Labels | `labelsUi` | `fixedCollection` | yes | `{}` | Labels to use in the chart |
| Labels Array | `labelsArray` | `string` | yes |  | The array of labels to be used in the chart |
| Data | `data` | `json` | yes |  | Data to use for the dataset, documentation and examples <a href="https://quickchart.io/documentation/chart-types/" target="_blank">here</a> |
| Put Output In Field | `output` | `string` | yes | `data` | The binary data will be displayed in the Output panel on the right, under the Binary tab |
| Chart Options | `chartOptions` | `collection` | no | `{}` |  |
| Dataset Options | `datasetOptions` | `collection` | no | `{}` |  |
