...
- Source file: `n8n-nodes-base/dist/nodes/Zoho/ZohoCrm.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `account`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `contact`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `deal`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `invoice`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `lead`: `create`, `delete`, `get`, `getAll`, `getFields`, `update`, `upsert`
- resource `product`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `purchaseOrder`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `quote`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `salesOrder`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `vendor`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
...
| Account Name | `accountName` | `string` | yes |  |  |
| Account Name | `accountName` | `string` | yes |  | Name of the account. If a record with this account name exists it will be updated, otherwise a new one will be created. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Account ID | `accountId` | `string` | yes |  | ID of the account to delete. Can be found at the end of the URL. |
| Account ID | `accountId` | `string` | yes |  | ID of the account to retrieve. Can be found at the end of the URL. |
...
| Account ID | `accountId` | `string` | yes |  | ID of the account to update. Can be found at the end of the URL. |
...
| Deal Name | `dealName` | `string` | yes |  | Name of the deal. If a record with this deal name exists it will be updated, otherwise a new one will be created. |
| Stage Name or ID | `stage` | `options` | yes | `[]` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Subject | `subject` | `string` | yes |  | Subject or title of the invoice |
| Subject | `subject` | `string` | yes |  | Subject or title of the invoice. If a record with this subject exists it will be updated, otherwise a new one will be created. |
| Products | `Product_Details` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Invoice ID | `invoiceId` | `string` | yes |  | ID of the invoice to delete |
| Invoice ID | `invoiceId` | `string` | yes |  | ID of the invoice to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Invoice ID | `invoiceId` | `string` | yes |  | ID of the invoice to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Company | `Company` | `string` | yes |  | Company at which the lead works |
| Last Name | `lastName` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Company | `Company` | `string` | yes |  | Company at which the lead works |
| Last Name | `lastName` | `string` | yes |  |  |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Product Name | `productName` | `string` | yes |  |  |
| Product Name | `productName` | `string` | yes |  | Name of the product. If a record with this product name exists it will be updated, otherwise a new one will be created. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Subject | `subject` | `string` | yes |  | Subject or title of the purchase order |
| Subject | `subject` | `string` | yes |  | Subject or title of the purchase order. If a record with this subject exists it will be updated, otherwise a new one will be created. |
| Vendor Name or ID | `vendorId` | `options` | no | `[]` | ID of the vendor associated with the purchase order. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Products | `Product_Details` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Purchase Order ID | `purchaseOrderId` | `string` | yes |  | ID of the purchase order to delete |
| Purchase Order ID | `purchaseOrderId` | `string` | yes |  | ID of the purchase order to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Purchase Order ID | `purchaseOrderId` | `string` | yes |  | ID of the purchase order to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Subject | `subject` | `string` | yes |  | Subject or title of the quote |
| Subject | `subject` | `string` | yes |  | Subject or title of the quote. If a record with this subject exists it will be updated, otherwise a new one will be created. |
| Products | `Product_Details` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Quote ID | `quoteId` | `string` | yes |  | ID of the quote to delete |
| Quote ID | `quoteId` | `string` | yes |  | ID of the quote to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Quote ID | `quoteId` | `string` | yes |  | ID of the quote to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Account Name or ID | `accountId` | `options` | yes | `[]` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Subject | `subject` | `string` | yes |  | Subject or title of the sales order |
| Subject | `subject` | `string` | yes |  | Subject or title of the sales order. If a record with this subject exists it will be updated, otherwise a new one will be created. |
| Products | `Product_Details` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Sales Order ID | `salesOrderId` | `string` | yes |  | ID of the sales order to delete |
| Sales Order ID | `salesOrderId` | `string` | yes |  | ID of the sales order to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Sales Order ID | `salesOrderId` | `string` | yes |  | ID of the sales order to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Vendor Name | `vendorName` | `string` | yes |  |  |
| Vendor Name | `vendorName` | `string` | yes |  | Name of the vendor. If a record with this vendor name exists it will be updated, otherwise a new one will be created. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Vendor ID | `vendorId` | `string` | yes |  | ID of the vendor to delete |
| Vendor ID | `vendorId` | `string` | yes |  | ID of the vendor to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Vendor ID | `vendorId` | `string` | yes |  | ID of the vendor to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
