...
- Source file: `n8n-nodes-base/dist/nodes/JinaAI/JinaAi.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `reader`: `read`, `search`
- resource `research`: `deepResearch`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `reader` |  |
| Operation | `operation` | `options` | no | `read` |  |
| Operation | `operation` | `options` | no | `deepResearch` |  |
| URL | `url` | `string` | yes |  | The URL to fetch content from |
| Simplify | `simplify` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Options | `options` | `collection` | no | `{}` |  |
| Search Query | `searchQuery` | `string` | yes |  |  |
| Simplify | `simplify` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Options | `options` | `collection` | no | `{}` |  |
| Research Query | `researchQuery` | `string` | yes |  | The topic or question for the AI to research |
| Simplify | `simplify` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Options | `options` | `collection` | no | `{}` |  |
