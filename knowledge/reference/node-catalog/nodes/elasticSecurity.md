...
- Node name: `elasticSecurity`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Elastic/ElasticSecurity/ElasticSecurity.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `case`: `create`, `delete`, `get`, `getAll`, `getStatus`, `update`
- resource `caseComment`: `add`, `get`, `getAll`, `remove`, `update`
- resource `caseTag`: `add`, `remove`
- resource `connector`: `create`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `case` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Title | `title` | `string` | yes |  |  |
| Connector Name or ID | `connectorId` | `options` | yes |  | Connectors allow you to send Elastic Security cases into other systems (only ServiceNow, Jira, or IBM Resilient). Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Connector Type | `connectorType` | `options` | yes | `.jira` |  |
| Issue Type | `issueType` | `string` | yes |  | Type of the Jira issue to create for this case |
| Priority | `priority` | `string` | yes |  | Priority of the Jira issue to create for this case |
| Urgency | `urgency` | `options` | yes | `1` | Urgency of the ServiceNow ITSM issue to create for this case |
| Severity | `severity` | `options` | yes | `1` | Severity of the ServiceNow ITSM issue to create for this case |
| Impact | `impact` | `options` | yes | `1` | Impact of the ServiceNow ITSM issue to create for this case |
| Category | `category` | `string` | yes |  | Category of the ServiceNow ITSM issue to create for this case |
| Issue Types | `issueTypes` | `string` | yes |  | Comma-separated list of numerical types of the IBM Resilient issue to create for this case |
| Severity Code | `severityCode` | `number` | yes | `1` | Severity code of the IBM Resilient issue to create for this case |
...
| Sort | `sortOptions` | `fixedCollection` | no | `{}` |  |
| Case ID | `caseId` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `add` |  |
| Case ID | `caseId` | `string` | yes |  | ID of the case containing the comment to retrieve |
| Comment | `comment` | `string` | yes |  |  |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Case ID | `caseId` | `string` | yes |  | ID of the case containing the comment to retrieve |
| Comment ID | `commentId` | `string` | yes |  | ID of the case comment to retrieve |
| Case ID | `caseId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Case ID | `caseId` | `string` | yes |  | ID of the case containing the comment to remove |
| Comment ID | `commentId` | `string` | yes |  |  |
| Case ID | `caseId` | `string` | yes |  | ID of the case containing the comment to retrieve |
| Comment ID | `commentId` | `string` | yes |  |  |
| Comment | `comment` | `string` | yes |  | Text to replace current comment message |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Operation | `operation` | `options` | no | `add` |  |
| Case ID | `caseId` | `string` | yes |  |  |
| Tag Name or ID | `tag` | `options` | yes |  | Tag to attach to the case. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Case ID | `caseId` | `string` | yes |  |  |
| Tag Name or ID | `tag` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Operation | `operation` | `options` | no | `create` |  |
| Connector Name | `name` | `string` | yes |  | Connectors allow you to send Elastic Security cases into other systems (only ServiceNow, Jira, or IBM Resilient) |
| Connector Type | `connectorType` | `options` | yes | `.jira` |  |
| API URL | `apiUrl` | `string` | yes |  | URL of the third-party instance |
| Email | `email` | `string` | yes |  | Jira-registered email |
| API Token | `apiToken` | `string` | yes |  | Jira API token |
| Project Key | `projectKey` | `string` | yes |  | Jira Project Key |
| Username | `username` | `string` | yes |  | ServiceNow ITSM username |
| Password | `password` | `string` | yes |  | ServiceNow ITSM password |
| API Key ID | `apiKeyId` | `string` | yes |  | IBM Resilient API key ID |
| API Key Secret | `apiKeySecret` | `string` | yes |  | IBM Resilient API key secret |
| Organization ID | `orgId` | `string` | yes |  | IBM Resilient organization ID |
