...
- Node name: `salesforce`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Salesforce/Salesforce.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `account`: `addNote`, `create`, `delete`, `get`, `getAll`, `getSummary`, `update`, `upsert`
- resource `attachment`: `create`, `delete`, `get`, `getAll`, `getSummary`, `update`
- resource `case`: `addComment`, `create`, `delete`, `get`, `getAll`, `getSummary`, `update`
- resource `contact`: `addNote`, `addToCampaign`, `create`, `delete`, `get`, `getAll`, `getSummary`, `update`, `upsert`
- resource `customObject`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `document`: `upload`
- resource `flow`: `getAll`, `invoke`
- resource `lead`: `addNote`, `addToCampaign`, `create`, `delete`, `get`, `getAll`, `getSummary`, `update`, `upsert`
- resource `opportunity`: `addNote`, `create`, `delete`, `get`, `getAll`, `getSummary`, `update`, `upsert`
- resource `search`: `query`
- resource `task`: `create`, `delete`, `get`, `getAll`, `getSummary`, `update`
- resource `user`: `get`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Authentication | `authentication` | `options` | no | `oAuth2` | OAuth Authorization Flow |
| Resource | `resource` | `options` | no | `lead` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Match Against | `externalId` | `options` | yes |  | The field to check to see if the lead already exists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Value to Match | `externalIdValue` | `string` | yes |  | If this value exists in the 'match against' field, update the lead. Otherwise create a new one. |
| Company | `company` | `string` | yes |  | Company of the lead. If person account record types have been enabled, and if the value of Company is null, the lead converts to a person account. |
| Last Name | `lastname` | `string` | yes |  | Required. Last name of the lead. Limited to 80 characters. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Lead ID | `leadId` | `string` | yes |  | ID of Lead that needs to be fetched |
...
| Lead ID | `leadId` | `string` | yes |  | ID of contact that needs to be fetched |
| Campaign Name or ID | `campaignId` | `options` | yes |  | ID of the campaign that needs to be fetched. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Options | `options` | `collection` | no | `{}` |  |
| Lead ID | `leadId` | `string` | yes |  | ID of lead that needs to be fetched |
| Title | `title` | `string` | yes |  | Title of the note |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Match Against | `externalId` | `options` | yes |  | The field to check to see if the contact already exists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Value to Match | `externalIdValue` | `string` | yes |  | If this value exists in the 'match against' field, update the contact. Otherwise create a new one. |
| Last Name | `lastname` | `string` | yes |  | Required. Last name of the contact. Limited to 80 characters. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Contact ID | `contactId` | `string` | yes |  | ID of contact that needs to be fetched |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Contact ID | `contactId` | `string` | yes |  | ID of contact that needs to be fetched |
| Contact ID | `contactId` | `string` | yes |  | ID of contact that needs to be fetched |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| Match Against | `externalId` | `options` | yes |  | The field to check to see if the object already exists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Value to Match | `externalIdValue` | `string` | yes |  | If this value exists in the 'match against' field, update the object. Otherwise create a new one. |
| Fields | `customFieldsUi` | `fixedCollection` | no | `{}` | Filter by custom fields |
| Custom Object Name or ID | `customObject` | `options` | yes |  | Name of the custom object. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Record ID | `recordId` | `string` | yes |  | Record ID to be updated |
| Fields | `customFieldsUi` | `fixedCollection` | no | `{}` | Filter by custom fields |
| Custom Object Name or ID | `customObject` | `options` | yes |  | Name of the custom object. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Record ID | `recordId` | `string` | yes |  | Record ID to be retrieved |
| Custom Object Name or ID | `customObject` | `options` | yes |  | Name of the custom object. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Record ID | `recordId` | `string` | yes |  | Record ID to be deleted |
| Custom Object Name or ID | `customObject` | `options` | yes |  | Name of the custom object. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
...
| Title | `title` | `string` | yes |  | Name of the file |
| Input Binary Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Match Against | `externalId` | `options` | yes |  | The field to check to see if the opportunity already exists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Value to Match | `externalIdValue` | `string` | yes |  | If this value exists in the 'match against' field, update the opportunity. Otherwise create a new one. |
| Name | `name` | `string` | yes |  | Required. Last name of the opportunity. Limited to 80 characters. |
| Close Date | `closeDate` | `dateTime` | yes |  | Required. Date when the opportunity is expected to close. |
| Stage Name or ID | `stageName` | `options` | yes |  | Required. Date when the opportunity is expected to close. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Opportunity ID | `opportunityId` | `string` | yes |  | ID of opportunity that needs to be fetched |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Opportunity ID | `opportunityId` | `string` | yes |  | ID of opportunity that needs to be fetched |
| Opportunity ID | `opportunityId` | `string` | yes |  | ID of opportunity that needs to be fetched |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Match Against | `externalId` | `options` | yes |  | The field to check to see if the account already exists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Value to Match | `externalIdValue` | `string` | yes |  | If this value exists in the 'match against' field, update the account. Otherwise create a new one. |
| Name | `name` | `string` | yes |  | Name of the account. Maximum size is 255 characters. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Account ID | `accountId` | `string` | yes |  | ID of account that needs to be fetched |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Account ID | `accountId` | `string` | yes |  | ID of account that needs to be fetched |
| Account ID | `accountId` | `string` | yes |  | ID of account that needs to be fetched |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| Query | `query` | `string` | yes |  | A SOQL query. An example query parameter string might look like: “SELECT+Name+FROM+MyObject”. If the SOQL query string is invalid, a MALFORMED_QUERY response is returned. |
| Operation | `operation` | `options` | no | `create` |  |
| Type Name or ID | `type` | `options` | yes |  | The type of case. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Case ID | `caseId` | `string` | yes |  | ID of case that needs to be fetched |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Case ID | `caseId` | `string` | yes |  | ID of case that needs to be fetched |
| Case ID | `caseId` | `string` | yes |  | ID of case that needs to be fetched |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Status Name or ID | `status` | `options` | yes |  | The current status of the task, such as In Progress or Completed. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Task ID | `taskId` | `string` | yes |  | ID of task that needs to be fetched |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Task ID | `taskId` | `string` | yes |  | ID of task that needs to be fetched |
| Task ID | `taskId` | `string` | yes |  | ID of task that needs to be fetched |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Parent ID | `parentId` | `string` | yes |  |  |
| Name | `name` | `string` | yes |  | Required. Name of the attached file. Maximum size is 255 characters. Label is File Name. |
| Input Binary Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Attachment ID | `attachmentId` | `string` | yes |  | ID of attachment that needs to be fetched |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Attachment ID | `attachmentId` | `string` | yes |  | ID of attachment that needs to be fetched |
| Attachment ID | `attachmentId` | `string` | yes |  | ID of attachment that needs to be fetched |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| User ID | `userId` | `string` | yes |  | ID of user that needs to be fetched |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
...
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| API Name | `apiName` | `string` | yes |  | Required. API name of the flow. |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` | Whether the input variables should be set via the value-key pair UI or JSON/RAW |
| Variables | `variablesJson` | `json` | no |  | Input variables as JSON object |
| Variables | `variablesUi` | `fixedCollection` | no | `{}` | The input variable to send |
