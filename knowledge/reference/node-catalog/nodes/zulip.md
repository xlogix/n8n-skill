...
- Source file: `n8n-nodes-base/dist/nodes/Zulip/Zulip.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `message`: `delete`, `get`, `sendPrivate`, `sendStream`, `update`, `updateFile`
- resource `stream`: `create`, `delete`, `getAll`, `getSubscribed`, `update`
- resource `user`: `create`, `deactivate`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `message` |  |
| Operation | `operation` | `options` | no | `sendPrivate` |  |
| To | `to` | `multiOptions` | yes | `[]` | The destination stream, or a comma-separated list containing the usernames (emails) of the recipients. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Content | `content` | `string` | yes |  | The content of the message |
| Stream Name or ID | `stream` | `options` | yes |  | The destination stream, or a comma-separated list containing the usernames (emails) of the recipients. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Topic Name or ID | `topic` | `options` | yes |  | The topic of the message. Only required if type is stream, ignored otherwise. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Content | `content` | `string` | yes |  | The content of the message |
| Message ID | `messageId` | `string` | yes |  | Unique identifier for the message |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Message ID | `messageId` | `string` | yes |  | Unique identifier for the message |
| Message ID | `messageId` | `string` | yes |  | Unique identifier for the message |
| Put Output File in Field | `dataBinaryProperty` | `string` | yes | `data` |  |
| Operation | `operation` | `options` | no | `create` |  |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Additional Fields | `additionalFieldsJson` | `json` | no |  | JSON format parameters for stream creation |
| Subscriptions | `subscriptions` | `fixedCollection` | yes | `{}` | A list of dictionaries containing the the key name and value specifying the name of the stream to subscribe. If the stream does not exist a new stream is created. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Stream ID | `streamId` | `string` | yes |  | ID of stream to update |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Additional Fields | `additionalFieldsJson` | `json` | no |  | JSON format parameters for stream creation |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Stream ID | `streamId` | `string` | yes |  | ID of stream to delete |
| Operation | `operation` | `options` | no | `create` |  |
| Email | `email` | `string` | yes |  | The email address of the new user |
| Full Name | `fullName` | `string` | yes |  | The full name of the new user |
| Password | `password` | `string` | yes |  | The password of the new user |
| Short Name | `shortName` | `string` | yes |  | The short name of the new user. Not user-visible. |
| User ID | `userId` | `string` | yes |  | The ID of user to get |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| User ID | `userId` | `string` | yes |  | The ID of user to update |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| User ID | `userId` | `string` | yes |  | The ID of user to deactivate |
