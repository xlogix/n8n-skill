...
- Node name: `tapfiliate`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Tapfiliate/Tapfiliate.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `affiliate`: `create`, `delete`, `get`, `getAll`
- resource `affiliateMetadata`: `add`, `remove`, `update`
- resource `programAffiliate`: `add`, `approve`, `disapprove`, `get`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | yes | `affiliate` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Email | `email` | `string` | yes |  | The affiliate’s email |
| First Name | `firstname` | `string` | yes |  | The affiliate’s firstname |
| Last Name | `lastname` | `string` | yes |  | The affiliate’s lastname |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Affiliate ID | `affiliateId` | `string` | yes |  | The ID of the affiliate |
| Affiliate ID | `affiliateId` | `string` | yes |  | The ID of the affiliate |
...
| Affiliate ID | `affiliateId` | `string` | yes |  | The ID of the affiliate |
| Metadata | `metadataUi` | `fixedCollection` | no | `{}` | Meta data |
| Affiliate ID | `affiliateId` | `string` | yes |  | The ID of the affiliate |
| Key | `key` | `string` | no |  | Name of the metadata key to remove |
| Affiliate ID | `affiliateId` | `string` | yes |  | The ID of the affiliate |
| Key | `key` | `string` | no |  | Name of the metadata key to update |
| Value | `value` | `string` | no |  | Value to set for the metadata key |
| Operation | `operation` | `options` | no | `add` |  |
| Program Name or ID | `programId` | `options` | yes |  | The ID of the Program to add the affiliate to. This ID can be found as part of the URL when viewing the program on the platform. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Affiliate ID | `affiliateId` | `string` | yes |  | The ID of the affiliate |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Program Name or ID | `programId` | `options` | no |  | The ID of the Program to add the affiliate to. This ID can be found as part of the URL when viewing the program on the platform. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Affiliate ID | `affiliateId` | `string` | no |  | The ID of the affiliate |
| Program Name or ID | `programId` | `options` | no |  | The ID of the Program to add the affiliate to. This ID can be found as part of the URL when viewing the program on the platform. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Affiliate ID | `affiliateId` | `string` | no |  | The ID of the affiliate |
| Program Name or ID | `programId` | `options` | yes |  | The ID of the Program to add the affiliate to. This ID can be found as part of the URL when viewing the program on the platform. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Affiliate ID | `affiliateId` | `string` | yes |  | The ID of the affiliate |
