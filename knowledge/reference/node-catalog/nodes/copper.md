...
- Source file: `n8n-nodes-base/dist/nodes/Copper/Copper.node.js`
- Node version: `1`
- Groups: `transform`
...
| Name | `name` | `string` | yes |  | Name of the company to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Company ID | `companyId` | `string` | yes |  | ID of the company to delete |
| Company ID | `companyId` | `string` | yes |  | ID of the company to retrieve |
...
| Filters | `filterFields` | `collection` | no | `{}` |  |
| Company ID | `companyId` | `string` | yes |  | ID of the company to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | Name of the lead to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | Name of the opportunity to create |
| Customer Source ID | `customerSourceId` | `string` | no |  | ID of the customer source that generated this opportunity |
| Primary Contact ID | `primaryContactId` | `string` | no |  | ID of the primary company associated with this opportunity |
| Opportunity ID | `opportunityId` | `string` | yes |  | ID of the opportunity to delete |
| Opportunity ID | `opportunityId` | `string` | yes |  | ID of the opportunity to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Filters | `filterFields` | `collection` | no | `{}` |  |
| Opportunity ID | `opportunityId` | `string` | yes |  | ID of the opportunity to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | Name of the person to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Person ID | `personId` | `string` | yes |  | ID of the person to delete |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | Name of the project to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Project ID | `projectId` | `string` | yes |  | ID of the project to delete |
| Project ID | `projectId` | `string` | yes |  | ID of the project to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Filters | `filterFields` | `collection` | no | `{}` |  |
| Project ID | `projectId` | `string` | yes |  | ID of the project to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
