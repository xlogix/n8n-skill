...
- Node name: `invoiceNinja`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/InvoiceNinja/InvoiceNinja.node.js`
- Node version: `[1,2]`
- Groups: `output`
...
### Operations
- resource `bank_transaction`: `create`, `delete`, `get`, `getAll`, `matchPayment`
- resource `client`: `create`, `delete`, `get`, `getAll`
- resource `expense`: `create`, `delete`, `get`, `getAll`
- resource `invoice`: `create`, `delete`, `email`, `get`, `getAll`
- resource `payment`: `create`, `delete`, `get`, `getAll`
- resource `quote`: `create`, `delete`, `email`, `get`, `getAll`
- resource `task`: `create`, `delete`, `get`, `getAll`
...
| Resource | `resource` | `options` | no | `client` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Billing Address | `billingAddressUi` | `fixedCollection` | no | `{}` |  |
| Contacts | `contactsUi` | `fixedCollection` | no | `{}` |  |
| Shipping Address | `shippingAddressUi` | `fixedCollection` | no | `{}` |  |
| Client ID | `clientId` | `string` | yes |  |  |
| Client ID | `clientId` | `string` | yes |  |  |
...
| Operation | `operation` | `options` | no | `create` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Invoice Items | `invoiceItemsUi` | `fixedCollection` | no | `{}` |  |
| Invoice ID | `invoiceId` | `string` | yes |  |  |
| Invoice ID | `invoiceId` | `string` | yes |  |  |
| Invoice ID | `invoiceId` | `string` | yes |  |  |
| Options | `options` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| Operation | `operation` | `options` | no | `create` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Time Logs | `timeLogsUi` | `fixedCollection` | no | `{}` |  |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Invoice Name or ID | `invoice` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Amount | `amount` | `number` | no | `0` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Payment ID | `paymentId` | `string` | yes |  |  |
| Payment ID | `paymentId` | `string` | yes |  |  |
| Options | `options` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Expense ID | `expenseId` | `string` | yes |  |  |
| Expense ID | `expenseId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
...
| Operation | `operation` | `options` | no | `create` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Bank Transaction ID | `bankTransactionId` | `string` | yes |  |  |
| Bank Transaction ID | `bankTransactionId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Bank Transaction ID | `bankTransactionId` | `string` | yes |  |  |
| Payment Name or ID | `paymentId` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
