...
- Node name: `rocketchat`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Rocketchat/Rocketchat.node.js`
- Node version: `1`
- Groups: `output`
...
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `chat` |  |
| Operation | `operation` | `options` | no | `postMessage` |  |
| Channel | `channel` | `string` | yes |  | The channel name with the prefix in front of it |
| Text | `text` | `string` | no |  | The text of the message to send, is optional because of attachments |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Attachments | `attachments` | `collection` | no | `{}` |  |
| Attachments | `attachmentsJson` | `json` | no |  |  |
