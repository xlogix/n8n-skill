...
- Node name: `ciscoWebex`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Cisco/Webex/CiscoWebex.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `meeting`: `create`, `delete`, `get`, `getAll`, `update`
- resource `message`: `create`, `delete`, `get`, `getAll`, `update`
...
| Title | `title` | `string` | yes |  | Meeting title. The title can be a maximum of 128 characters long. |
| Start | `start` | `dateTime` | yes |  | Date and time for the start of the meeting. Acceptable <a href="https://datatracker.ietf.org/doc/html/rfc2445"> format</a>. |
| End | `end` | `dateTime` | yes |  | Date and time for the end of the meeting. Acceptable <a href="https://datatracker.ietf.org/doc/html/rfc2445"> format</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Meeting ID | `meetingId` | `string` | yes |  | ID of the meeting |
...
| Operation | `operation` | `options` | no | `create` |  |
| Destination | `destination` | `options` | yes | `room` |  |
...
| Specify Person By | `specifyPersonBy` | `options` | yes | `email` |  |
| Person ID | `toPersonId` | `string` | yes |  |  |
| Person Email | `toPersonEmail` | `string` | yes |  |  |
| Text | `text` | `string` | yes |  | The message, in plain text |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Message ID | `messageId` | `string` | yes |  | ID of the message to delete |
| Message ID | `messageId` | `string` | yes |  | ID of the message to retrieve |
| Room Name or ID | `roomId` | `options` | yes |  | List messages in a room, by ID. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Message ID | `messageId` | `string` | yes |  | ID of the message to update |
| Is Markdown | `markdown` | `boolean` | yes | `false` | Whether the message uses markdown |
| Text | `text` | `string` | yes |  | The message, in plain text |
| Markdown | `markdownText` | `string` | yes |  | The message, in Markdown format. The maximum message length is 7439 bytes. |
