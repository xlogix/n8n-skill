...
- Source file: `n8n-nodes-base/dist/nodes/Orbit/Orbit.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `activity`: `create`, `getAll`
- resource `member`: `delete`, `get`, `getAll`, `lookup`, `update`, `upsert`
- resource `note`: `create`, `getAll`, `update`
- resource `post`: `create`, `delete`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Orbit has been shutdown and will no longer function from July 11th, You can read more <a target="_blank" href="https://orbit.love/blog/orbit-is-joining-postman">here</a>. | `deprecated` | `notice` | no |  |  |
| Resource | `resource` | `options` | no | `member` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Member ID | `memberId` | `string` | yes |  |  |
...
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Member ID | `memberId` | `string` | yes |  |  |
| Resolve Identities | `resolveIdentities` | `boolean` | no | `false` | By default, the response just includes the reference of the identity. When set to true the identities will be resolved automatically. |
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Resolve Identities | `resolveIdentities` | `boolean` | no | `false` | By default, the response just includes the reference of the identity. When set to true the identities will be resolved automatically. |
...
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Source | `source` | `options` | yes |  | Set to github, twitter, email, discourse or the source of any identities you've manually created |
| Search By | `searchBy` | `options` | yes |  |  |
| ID | `id` | `string` | yes |  | The username at the source |
| Username | `username` | `string` | yes |  | The username at the source |
| Email | `email` | `string` | yes |  | The email address |
| Host | `host` | `string` | yes |  |  |
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Member ID | `memberId` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Identity | `identityUi` | `fixedCollection` | no | `{}` | The identity is used to find the member. If no member exists, a new member will be created and linked to the provided identity. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Member ID | `memberId` | `string` | yes |  |  |
| Note | `note` | `string` | yes |  |  |
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Member ID | `memberId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Resolve Member | `resolveMember` | `boolean` | no | `false` |  |
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Member ID | `memberId` | `string` | yes |  |  |
...
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Member ID | `memberId` | `string` | yes |  |  |
| URL | `url` | `string` | yes |  | Supply any URL and Orbit will do its best job to parse out a title, description, and image |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Workspace Name or ID | `workspaceId` | `options` | yes | `Deprecated` | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
