...
- Node name: `securityScorecard`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/SecurityScorecard/SecurityScorecard.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `company`: `getFactor`, `getFactorHistorical`, `getHistoricalScore`, `getScorecard`, `getScorePlan`
- resource `industry`: `getFactor`, `getFactorHistorical`, `getScore`
- resource `invite`: `create`
- resource `portfolio`: `create`, `delete`, `getAll`, `update`
- resource `portfolioCompany`: `add`, `getAll`, `remove`
- resource `report`: `download`, `generate`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | yes | `company` |  |
| Operation | `operation` | `options` | yes | `getFactor` |  |
| Scorecard Identifier | `scorecardIdentifier` | `string` | yes |  | Primary identifier of a company or scorecard, i.e. domain. |
| Score | `score` | `number` | yes | `0` | Score target |
...
| Operation | `operation` | `options` | yes | `getFactor` |  |
| Industry | `industry` | `options` | yes | `food` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Options | `options` | `collection` | no | `{}` |  |
...
| Message | `message` | `string` | yes |  | Message for the invitee |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Portfolio ID | `portfolioId` | `string` | yes |  |  |
| Portfolio Name | `name` | `string` | yes |  | Name of the portfolio |
| Description | `description` | `string` | no |  |  |
| Privacy | `privacy` | `options` | no | `shared` |  |
| Operation | `operation` | `options` | yes | `add` |  |
| Portfolio ID | `portfolioId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Domain | `domain` | `string` | yes |  | Company's domain name |
| Operation | `operation` | `options` | yes | `getAll` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Report | `report` | `options` | yes | `detailed` |  |
| Scorecard Identifier | `scorecardIdentifier` | `string` | yes |  | Primary identifier of a company or scorecard, i.e. domain. |
| Portfolio ID | `portfolioId` | `string` | yes |  |  |
| Branding | `branding` | `options` | no | `securityscorecard` |  |
| Date | `date` | `dateTime` | yes |  |  |
| Options | `options` | `collection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Report URL | `url` | `string` | yes |  | URL to a generated report |
