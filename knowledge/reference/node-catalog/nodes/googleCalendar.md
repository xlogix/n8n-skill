...
- Node name: `googleCalendar`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Google/Calendar/GoogleCalendar.node.js`
...
- resource `event`: `create`, `delete`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `event` |  |
| Operation | `operation` | `options` | no | `availability` |  |
| Calendar | `calendar` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Google Calendar to operate on |
| Start Time | `timeMin` | `dateTime` | yes |  | Start of the interval |
| End Time | `timeMax` | `dateTime` | yes |  | End of the interval |
| Start Time | `timeMin` | `dateTime` | yes | `={{ $now }}` | Start of the interval, use <a href="https://docs.n8n.io/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget |
| End Time | `timeMax` | `dateTime` | yes | `={{ $now.plus(1, 'hour') }}` | End of the interval, use <a href="https://docs.n8n.io/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Calendar | `calendar` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Google Calendar to operate on |
| Start | `start` | `dateTime` | yes |  | Start time of the event |
| End | `end` | `dateTime` | yes |  | End time of the event |
| Start | `start` | `dateTime` | yes | `={{ $now }}` | Start time of the event, use <a href="https://docs.n8n.io/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget |
| End | `end` | `dateTime` | yes | `={{ $now.plus(1, 'hour') }}` | End time of the event, use <a href="https://docs.n8n.io/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget |
| Use Default Reminders | `useDefaultReminders` | `boolean` | no | `true` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Reminders | `remindersUi` | `fixedCollection` | no | `{}` | If the event doesn't use the default reminders, this lists the reminders specific to the event |
...
| After | `timeMin` | `dateTime` | no | `={{ $now }}` | At least some part of the event must be after this time, use <a href="https://docs.n8n.io/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget |
| Before | `timeMax` | `dateTime` | no | `={{ $now.plus({ week: 1 }) }}` | At least some part of the event must be before this time, use <a href="https://docs.n8n.io/code/cookbook/luxon/" target="_blank">expression</a> to set a date, or switch to fixed mode to choose date from widget |
| Options | `options` | `collection` | no | `{}` |  |
| Event ID | `eventId` | `string` | yes |  |  |
| Modify | `modifyTarget` | `options` | no | `instance` |  |
| Use Default Reminders | `useDefaultReminders` | `boolean` | no | `true` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Reminders | `remindersUi` | `fixedCollection` | no | `{}` | If the event doesn't use the default reminders, this lists the reminders specific to the event |
| This node will use the time zone set in n8n’s settings, but you can override this in the workflow settings | `useN8nTimeZone` | `notice` | no |  |  |
...
[
  ...
  },
  {
    ...
    "default": "={{ $now }}",
    "description": "Start time of the event, use <a href=\"https://docs.n8n.io/code/cookbook/luxon/\" target=\"_blank\">expression</a> to set a date, or switch to fixed mode to choose date from widget"
  },
  {
    "displayName": "End",
    "name": "end",
    ...
    "default": "={{ $now.plus(1, 'hour') }}",
    "description": "End time of the event, use <a href=\"https://docs.n8n.io/code/cookbook/luxon/\" target=\"_blank\">expression</a> to set a date, or switch to fixed mode to choose date from widget"
  },
  {
