...
- Source file: `n8n-nodes-base/dist/nodes/Stripe/Stripe.node.js`
- Node version: `1`
- Groups: `transform`
...
- resource `charge`: `create`, `get`, `getAll`, `update`
- resource `coupon`: `create`, `getAll`
- resource `customer`: `create`, `delete`, `get`, `getAll`, `update`
- resource `customerCard`: `add`, `get`, `remove`
- resource `meterEvent`: `create`
- resource `source`: `create`, `delete`, `get`
- resource `token`: `create`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `balance` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Customer ID | `customerId` | `string` | yes |  | ID of the customer to be associated with this card |
| Card Token | `token` | `string` | yes |  | Token representing sensitive card information |
| Customer ID | `customerId` | `string` | yes |  | ID of the customer whose card to remove |
| Card ID | `cardId` | `string` | yes |  | ID of the card to remove |
| Customer ID | `customerId` | `string` | yes |  | ID of the customer whose card to retrieve |
| Source ID | `sourceId` | `string` | yes |  | ID of the source to retrieve |
| Operation | `operation` | `options` | no | `get` |  |
| Customer ID | `customerId` | `string` | yes |  | ID of the customer to be associated with this charge |
| Amount | `amount` | `number` | yes | `0` | Amount in cents to be collected for this charge, e.g. enter <code>100</code> for $1.00 |
| Currency Name or ID | `currency` | `options` | yes |  | Three-letter ISO currency code, e.g. <code>USD</code> or <code>EUR</code>. It must be a <a href="https://stripe.com/docs/currencies">Stripe-supported currency</a>. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Source ID | `source` | `string` | yes |  | ID of the customer's payment source to be charged |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Charge ID | `chargeId` | `string` | yes |  | ID of the charge to retrieve |
...
| Charge ID | `chargeId` | `string` | yes |  | ID of the charge to update |
...
| Amount Off | `amountOff` | `number` | yes | `0` | Amount in cents to subtract from an invoice total, e.g. enter <code>100</code> for $1.00 |
| Currency Name or ID | `currency` | `options` | yes |  | Three-letter ISO currency code, e.g. <code>USD</code> or <code>EUR</code>. It must be a <a href="https://stripe.com/docs/currencies">Stripe-supported currency</a>. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Percent Off | `percentOff` | `number` | yes | `1` | Percentage to apply with the coupon |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `get` |  |
| Name | `name` | `string` | yes |  | Full name or business name of the customer to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Event Name | `eventName` | `string` | yes |  | The name of the meter event. Corresponds with the event_name field on a meter. |
| Customer ID | `customerId` | `string` | yes |  | The Stripe customer ID associated with this meter event |
| Value | `value` | `number` | yes | `1` | The value of the meter event. Must be an integer. Can be positive or negative. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Customer ID | `customerId` | `string` | yes |  | ID of the customer to attach the source to |
| Type | `type` | `options` | yes | `wechat` | Type of source (payment instrument) to create |
| Amount | `amount` | `number` | no | `0` | Amount in cents to be collected for this charge, e.g. enter <code>100</code> for $1.00 |
| Currency Name or ID | `currency` | `options` | no |  | Three-letter ISO currency code, e.g. <code>USD</code> or <code>EUR</code>. It must be a <a href="https://stripe.com/docs/currencies">Stripe-supported currency</a>. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Customer ID | `customerId` | `string` | yes |  | ID of the customer whose source to delete |
| Source ID | `sourceId` | `string` | yes |  | ID of the source to delete |
| Source ID | `sourceId` | `string` | yes |  | ID of the source to retrieve |
| Operation | `operation` | `options` | no | `create` |  |
| Type | `type` | `options` | yes | `cardToken` | Type of token to create |
| Card Number | `number` | `string` | no |  |  |
| CVC | `cvc` | `string` | no |  | Security code printed on the back of the card |
| Expiration Month | `expirationMonth` | `string` | no |  | Number of the month when the card will expire |
| Expiration Year | `expirationYear` | `string` | no |  | Year when the card will expire |
