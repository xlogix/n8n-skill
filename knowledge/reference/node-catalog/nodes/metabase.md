...
- Source file: `n8n-nodes-base/dist/nodes/Metabase/Metabase.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `alerts`: `get`, `getAll`
- resource `databases`: `addNewDatasource`, `getAll`, `getFields`
- resource `metrics`: `get`, `getAll`
- resource `questions`: `get`, `getAll`, `resultData`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `questions` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Question ID | `questionId` | `string` | yes |  |  |
| Format | `format` | `options` | yes | `csv` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Metric ID | `metricId` | `string` | yes |  |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Database ID | `databaseId` | `string` | yes |  |  |
| Engine | `engine` | `options` | yes | `postgres` |  |
| Host | `host` | `string` | yes |  |  |
| Name | `name` | `string` | yes |  |  |
| Port | `port` | `number` | yes | `5432` |  |
| User | `user` | `string` | yes |  |  |
| Password | `password` | `string` | yes |  |  |
| Database Name | `dbName` | `string` | no |  |  |
| File Path | `filePath` | `string` | yes |  |  |
| Full Sync | `fullSync` | `boolean` | yes | `true` |  |
| Simplify | `simple` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
| Operation | `operation` | `options` | no | `getAll` |  |
| Alert ID | `alertId` | `string` | yes |  |  |
