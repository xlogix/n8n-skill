...
- Source file: `n8n-nodes-base/dist/nodes/GetResponse/GetResponse.node.js`
- Node version: `1`
- Groups: `input`
...
| Campaign Name or ID | `campaignId` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
