...
- Source file: `n8n-nodes-base/dist/nodes/Mailchimp/Mailchimp.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `campaign`: `delete`, `get`, `getAll`, `replicate`, `resend`, `send`
- resource `listGroup`: `getAll`
- resource `member`: `create`, `delete`, `get`, `getAll`, `update`
- resource `memberTag`: `create`, `delete`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Authentication | `authentication` | `options` | no | `apiKey` |  |
| Resource | `resource` | `options` | yes | `member` |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Operation | `operation` | `options` | yes | `getAll` |  |
| Operation | `operation` | `options` | yes | `getAll` |  |
| List Name or ID | `list` | `options` | yes |  | List of lists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Email | `email` | `string` | yes |  | Email address for a subscriber |
| Status | `status` | `options` | yes |  | Subscriber's current status |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Location | `locationFieldsUi` | `fixedCollection` | no | `{}` | Subscriber location information.n |
| Merge Fields | `mergeFieldsUi` | `fixedCollection` | no | `{}` | An individual merge var and value for a member |
| Merge Fields | `mergeFieldsJson` | `json` | no |  |  |
| Location | `locationJson` | `json` | no |  |  |
| Interest Groups | `groupsUi` | `fixedCollection` | no | `{}` |  |
| Interest Groups | `groupJson` | `json` | no |  |  |
| List Name or ID | `list` | `options` | yes |  | List of lists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Email | `email` | `string` | yes |  | Member's email |
| List Name or ID | `list` | `options` | yes |  | List of lists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Email | `email` | `string` | yes |  | Member's email |
| Options | `options` | `collection` | no | `{}` |  |
| List Name or ID | `list` | `options` | yes |  | List of lists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `500` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| List Name or ID | `list` | `options` | yes |  | List of lists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Email | `email` | `string` | yes |  | Email address of the subscriber |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
...
| Options | `options` | `collection` | no | `{}` |  |
| List Name or ID | `list` | `options` | yes |  | List of lists. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Group Category Name or ID | `groupCategory` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `500` | Max number of results to return |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `10` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Campaign ID | `campaignId` | `string` | yes |  | List of Campaigns |
