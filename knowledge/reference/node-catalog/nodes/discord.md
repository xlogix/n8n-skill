...
- Source file: `n8n-nodes-base/dist/nodes/Discord/Discord.node.js`
- Node version: `2`
- Groups: `output`
...
## Credentials
- `discordBotApi` (required)
- `discordOAuth2Api` (required)
- `discordWebhookApi` (required)
...
### Operations
- default/all resources: `sendLegacy`
- resource `channel`: `create`, `deleteChannel`, `get`, `getAll`, `update`
- resource `member`: `getAll`, `roleAdd`, `roleRemove`
- resource `message`: `deleteMessage`, `get`, `getAll`, `react`, `send`, `sendAndWait`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Connection Type | `authentication` | `options` | no | `botToken` |  |
| Resource | `resource` | `options` | no | `channel` |  |
| Operation | `operation` | `options` | no | `send` |  |
| Server | `guildId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the server (guild) that your bot is connected to |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the channel by name, URL, or ID |
...
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the channel by name, URL, or ID |
| Message ID | `messageId` | `string` | yes |  | The ID of the message |
| Emoji | `emoji` | `string` | yes |  | The emoji you want to react with |
| Send To | `sendTo` | `options` | no | `channel` | Send message to a channel or DM to a user |
| User | `userId` | `resourceLocator` | no | `{"mode":"list","value":""}` | Select the user you want to assign a role to |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the channel by name, URL, or ID |
| Message | `content` | `string` | no |  | The content of the message (up to 2000 characters) |
| Options | `options` | `collection` | no | `{}` |  |
| Embeds | `embeds` | `fixedCollection` | no | `[]` |  |
| Files | `files` | `fixedCollection` | no | `[]` |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the channel by name, URL, or ID |
| Message ID | `messageId` | `string` | yes |  | The ID of the message |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the channel by name, URL, or ID |
| Message ID | `messageId` | `string` | yes |  | The ID of the message |
...
| Type | `type` | `options` | yes | `0` | The type of channel to create |
| Options | `options` | `collection` | no | `{}` |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the channel by name, URL, or ID |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the channel by name, URL, or ID |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| Options | `options` | `collection` | no | `{}` |  |
| Channel | `channelId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the channel by name, URL, or ID |
| Name | `name` | `string` | no |  | The new name of the channel. Fill this field only if you want to change the channel's name. |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Server | `guildId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the server (guild) that your bot is connected to |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| After | `after` | `string` | no |  | The ID of the user after which to return the members |
| Options | `options` | `collection` | no | `{}` |  |
| User | `userId` | `resourceLocator` | no | `{"mode":"list","value":""}` | Select the user you want to assign a role to |
| Role | `role` | `multiOptions` | yes | `[]` | Select the roles you want to add to the user |
| User | `userId` | `resourceLocator` | no | `{"mode":"list","value":""}` | Select the user you want to assign a role to |
| Role | `role` | `multiOptions` | yes | `[]` | Select the roles you want to add to the user |
| Operation | `operation` | `options` | no | `sendLegacy` |  |
| Message | `content` | `string` | no |  | The content of the message (up to 2000 characters) |
| Options | `options` | `collection` | no | `{}` |  |
| Embeds | `embeds` | `fixedCollection` | no | `[]` |  |
| Files | `files` | `fixedCollection` | no | `[]` |  |
