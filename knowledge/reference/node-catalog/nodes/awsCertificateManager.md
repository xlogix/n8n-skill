...
- Node name: `awsCertificateManager`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Aws/CertificateManager/AwsCertificateManager.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `certificate`: `delete`, `get`, `getMany`, `getMetadata`, `renew`
...
| Operation | `operation` | `options` | no | `renew` |  |
| Certificate ARN | `certificateArn` | `string` | yes |  | String that contains the ARN of the ACM certificate to be renewed. This must be of the form: arn:aws:acm:region:123456789012:certificate/12345678-1234-1234-1234-123456789012. |
| Bucket Name | `bucketName` | `string` | yes |  |  |
| Certificate Key | `certificateKey` | `string` | yes |  |  |
