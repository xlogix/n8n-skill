...
- Node name: `homeAssistant`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/HomeAssistant/HomeAssistant.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `cameraProxy`: `getScreenshot`
- resource `config`: `check`, `get`
- resource `event`: `create`, `getAll`
- resource `history`: `getAll`
- resource `log`: `getErroLogs`, `getLogbookEntries`
- resource `service`: `call`, `getAll`
- resource `state`: `get`, `getAll`, `upsert`
- resource `template`: `create`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `config` |  |
| Operation | `operation` | `options` | no | `getScreenshot` |  |
| Camera Entity Name or ID | `cameraEntityId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
...
| Event Type | `eventType` | `string` | yes |  | The Entity ID for which an event will be created |
| Event Attributes | `eventAttributes` | `fixedCollection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getErroLogs` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
...
| Service Name or ID | `service` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Service Attributes | `serviceAttributes` | `fixedCollection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Entity Name or ID | `entityId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Entity Name or ID | `entityId` | `options` | yes |  | The entity ID for which a state will be created. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| State | `state` | `string` | yes |  |  |
| State Attributes | `stateAttributes` | `fixedCollection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Template | `template` | `string` | yes |  | Render a Home Assistant template. <a href="https://www.home-assistant.io/docs/configuration/templating/">See template docs for more information.</a>. |
