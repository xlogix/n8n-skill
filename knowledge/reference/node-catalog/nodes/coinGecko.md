...
- Source file: `n8n-nodes-base/dist/nodes/CoinGecko/CoinGecko.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `coin`: `candlestick`, `get`, `getAll`, `history`, `market`, `marketChart`, `price`, `ticker`
- resource `event`: `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `coin` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Search By | `searchBy` | `options` | yes | `coinId` | Search by coin ID or contract address |
| Coin Name or ID | `coinId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Base Currency Name or ID | `baseCurrency` | `options` | yes |  | The first currency in the pair. For BTC:ETH this is BTC. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Base Currency Name or ID | `baseCurrency` | `options` | yes |  | The first currency in the pair. For BTC:ETH this is BTC. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Coin Name or ID | `coinId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Base Currency Names or IDs | `baseCurrencies` | `multiOptions` | yes | `[]` | The first currency in the pair. For BTC:ETH this is BTC. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Platform ID | `platformId` | `options` | yes | `ethereum` | The ID of the platform issuing tokens |
| Contract Address | `contractAddress` | `string` | yes |  | Token's contract address |
| Contract Addresses | `contractAddresses` | `string` | yes |  | The contract address of tokens, comma-separated |
| Base Currency Name or ID | `baseCurrency` | `options` | yes |  | The first currency in the pair. For BTC:ETH this is BTC. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Quote Currency Name or ID | `quoteCurrency` | `options` | yes |  | The second currency in the pair. For BTC:ETH this is ETH. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Quote Currency Names or IDs | `quoteCurrencies` | `multiOptions` | yes | `[]` | The second currency in the pair. For BTC:ETH this is ETH. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Range (Days) | `days` | `options` | yes |  | Return data for this many days in the past from now |
| Date | `date` | `dateTime` | yes |  | The date of data snapshot |
