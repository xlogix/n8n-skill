...
- Source file: `n8n-nodes-base/dist/nodes/Intercom/Intercom.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `company`: `create`, `get`, `getAll`, `update`, `users`
...
| Operation | `operation` | `options` | no | `create` |  |
| Operation | `operation` | `options` | no | `create` |  |
| ID | `id` | `string` | yes |  | The Intercom defined ID representing the Lead |
...
| Select By | `selectBy` | `options` | no |  | The property to select the user by |
| Value | `value` | `string` | yes |  | View by value |
| Update By | `updateBy` | `options` | no | `id` | The property via which to query the user |
| Value | `value` | `string` | yes |  | Value of the property to identify the user to update |
| Identifier Type | `identifierType` | `options` | no |  | Unique string identifier |
| Value | `idValue` | `string` | yes |  | Unique string identifier value |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Custom Attributes | `customAttributesJson` | `json` | no |  | A hash of key/value pairs to represent custom data you want to attribute to a user |
| Custom Attributes | `customAttributesUi` | `fixedCollection` | no | `{}` | A hash of key/value pairs to represent custom data you want to attribute to a user |
| Delete By | `deleteBy` | `options` | no |  |  |
| Value | `value` | `string` | yes |  | Delete by value |
| Select By | `selectBy` | `options` | no |  | The property to select the lead by |
| Value | `value` | `string` | yes |  | View by value |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Update By | `updateBy` | `options` | no | `id` | The property via which to query the lead |
| Value | `value` | `string` | yes |  | Value of the property to identify the lead to update |
| Email | `email` | `string` | yes |  | The email of the user |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Custom Attributes | `customAttributesJson` | `json` | no |  | A hash of key/value pairs to represent custom data you want to attribute to a user |
| Custom Attributes | `customAttributesUi` | `fixedCollection` | no | `{}` | A hash of key/value pairs to represent custom data you want to attribute to a user |
| List By | `listBy` | `options` | no |  |  |
| Value | `value` | `string` | yes |  | View by value |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Select By | `selectBy` | `options` | no |  | What property to use to query the company |
| Value | `value` | `string` | yes |  | View by value |
| Company ID | `companyId` | `string` | no |  | The company ID you have defined for the company |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Custom Attributes | `customAttributesJson` | `json` | no |  | A hash of key/value pairs to represent custom data you want to attribute to a user |
| Custom Attributes | `customAttributesUi` | `fixedCollection` | no | `{}` | A hash of key/value pairs to represent custom data you want to attribute to a user |
