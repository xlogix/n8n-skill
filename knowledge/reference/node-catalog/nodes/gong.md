...
- Source file: `n8n-nodes-base/dist/nodes/Gong/Gong.node.js`
- Node version: `1`
- Groups: `transform`
...
| Resource | `resource` | `options` | no | `call` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Call to Get | `call` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
