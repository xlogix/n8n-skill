...
- Source file: `n8n-nodes-base/dist/nodes/Crypto/Crypto.node.js`
- Node version: `2`
- Groups: `transform`
...
|---|---|---|---|---|---|
| Action | `action` | `options` | no | `hash` |  |
| Binary File | `binaryData` | `boolean` | yes | `false` | Whether the data to hashed should be taken from binary field |
| Binary Property Name | `binaryPropertyName` | `string` | yes | `data` | Name of the binary property which contains the input data |
| Type | `type` | `options` | yes | `SHA256` | The hash type to use |
| Value | `value` | `string` | yes |  | The value that should be hashed |
| Property Name | `dataPropertyName` | `string` | yes | `data` | Name of the property to which to write the hash |
| Encoding | `encoding` | `options` | yes | `hex` |  |
| Type | `type` | `options` | yes | `SHA256` | The hash type to use |
| Value | `value` | `string` | yes |  | The value of which the hmac should be created |
| Property Name | `dataPropertyName` | `string` | yes | `data` | Name of the property to which to write the hmac |
| Encoding | `encoding` | `options` | yes | `hex` |  |
| Value | `value` | `string` | yes |  | The value that should be signed |
| Property Name | `dataPropertyName` | `string` | yes | `data` | Name of the property to which to write the signed value |
| Algorithm Name or ID | `algorithm` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Encoding | `encoding` | `options` | yes | `hex` |  |
| Property Name | `dataPropertyName` | `string` | yes | `data` | Name of the property to which to write the random string |
| Type | `encodingType` | `options` | yes | `uuid` | Encoding that will be used to generate string |
| Length | `stringLength` | `number` | no | `32` | Length of the generated string |
