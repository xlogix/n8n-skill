...
- Source file: `n8n-nodes-base/dist/nodes/Markdown/Markdown.node.js`
- Node version: `1`
- Groups: `output`
...
|---|---|---|---|---|---|
| Mode | `mode` | `options` | no | `htmlToMarkdown` |  |
| HTML | `html` | `string` | yes |  | The HTML to be converted to markdown |
| Markdown | `markdown` | `string` | yes |  | The Markdown to be converted to html |
| Destination Key | `destinationKey` | `string` | yes | `data` | The field to put the output in. Specify nested fields using dots, e.g."level1.level2.newKey". |
