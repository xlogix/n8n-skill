...
- Node name: `quickbooks`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/QuickBooks/QuickBooks.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `bill`: `create`, `delete`, `get`, `getAll`, `update`
- resource `customer`: `create`, `get`, `getAll`, `update`
- resource `employee`: `create`, `get`, `getAll`, `update`
- resource `estimate`: `create`, `delete`, `get`, `getAll`, `send`, `update`
- resource `invoice`: `create`, `delete`, `get`, `getAll`, `send`, `update`, `void`
- resource `item`: `get`, `getAll`
- resource `payment`: `create`, `delete`, `get`, `getAll`, `send`, `update`, `void`
- resource `purchase`: `get`, `getAll`
- resource `transaction`: `getReport`
- resource `vendor`: `create`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `customer` |  |
| Operation | `operation` | `options` | no | `get` |  |
| For Vendor Name or ID | `VendorRef` | `options` | yes | `[]` | The ID of the vendor who the bill is for. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Line | `Line` | `collection` | no | `{}` | Individual line item of a transaction |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Bill ID | `billId` | `string` | yes |  | The ID of the bill to delete |
| Bill ID | `billId` | `string` | yes |  | The ID of the bill to retrieve |
...
| Bill ID | `billId` | `string` | yes |  | The ID of the bill to update |
| Update Fields | `updateFields` | `collection` | yes | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Display Name | `displayName` | `string` | yes |  | The display name of the customer to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Update Fields | `updateFields` | `collection` | yes | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Family Name | `FamilyName` | `string` | no |  |  |
| Given Name | `GivenName` | `string` | no |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Employee ID | `employeeId` | `string` | yes |  | The ID of the employee to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Employee ID | `employeeId` | `string` | yes |  | The ID of the employee to update |
| Update Fields | `updateFields` | `collection` | yes | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| For Customer Name or ID | `CustomerRef` | `options` | yes | `[]` | The ID of the customer who the estimate is for. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Line | `Line` | `collection` | no | `{}` | Individual line item of a transaction |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Estimate ID | `estimateId` | `string` | yes |  | The ID of the estimate to delete |
| Estimate ID | `estimateId` | `string` | yes |  | The ID of the estimate to retrieve |
| Download | `download` | `boolean` | yes | `false` | Whether to download the estimate as a PDF file |
| Put Output File in Field | `binaryProperty` | `string` | yes | `data` |  |
| File Name | `fileName` | `string` | yes |  | Name of the file that will be downloaded |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Estimate ID | `estimateId` | `string` | yes |  | The ID of the estimate to send |
| Email | `email` | `string` | yes |  | The email of the recipient of the estimate |
| Estimate ID | `estimateId` | `string` | yes |  | The ID of the estimate to update |
| Update Fields | `updateFields` | `collection` | yes | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| For Customer Name or ID | `CustomerRef` | `options` | yes | `[]` | The ID of the customer who the invoice is for. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Line | `Line` | `collection` | no | `{}` | Individual line item of a transaction |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Invoice ID | `invoiceId` | `string` | yes |  | The ID of the invoice to delete |
| Invoice ID | `invoiceId` | `string` | yes |  | The ID of the invoice to retrieve |
| Download | `download` | `boolean` | yes | `false` | Whether to download the invoice as a PDF file |
| Put Output File in Field | `binaryProperty` | `string` | yes | `data` |  |
| File Name | `fileName` | `string` | yes |  | Name of the file that will be downloaded |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Invoice ID | `invoiceId` | `string` | yes |  | The ID of the invoice to send |
| Email | `email` | `string` | yes |  | The email of the recipient of the invoice |
| Invoice ID | `invoiceId` | `string` | yes |  | The ID of the invoice to void |
| Invoice ID | `invoiceId` | `string` | yes |  | The ID of the invoice to update |
| Update Fields | `updateFields` | `collection` | yes | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Item ID | `itemId` | `string` | yes |  | The ID of the item to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| For Customer Name or ID | `CustomerRef` | `options` | yes | `[]` | The ID of the customer who the payment is for. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Total Amount | `TotalAmt` | `number` | no | `0` | Total amount of the transaction |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Payment ID | `paymentId` | `string` | yes |  | The ID of the payment to delete |
| Payment ID | `paymentId` | `string` | yes |  | The ID of the payment to retrieve |
| Download | `download` | `boolean` | yes | `false` | Whether to download estimate as PDF file |
| Put Output File in Field | `binaryProperty` | `string` | yes | `data` |  |
| File Name | `fileName` | `string` | yes |  | Name of the file that will be downloaded |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Payment ID | `paymentId` | `string` | yes |  | The ID of the payment to send |
| Email | `email` | `string` | yes |  | The email of the recipient of the payment |
| Payment ID | `paymentId` | `string` | yes |  | The ID of the payment to void |
| Payment ID | `paymentId` | `string` | yes |  | The ID of the payment to update |
| Update Fields | `updateFields` | `collection` | yes | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Purchase ID | `purchaseId` | `string` | yes |  | The ID of the purchase to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
...
| Filters | `filters` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Display Name | `displayName` | `string` | yes |  | The display name of the vendor to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
[
  ...
  },
  {
    ...
    "type": "options",
    "required": true,
    "description": "The ID of the customer who the invoice is for. Choose from the list, or specify an ID using an <a href=\"https://docs.n8n.io/code/expressions/\">expression</a>.",
    "default": [],
    "typeOptions": {
      "loadOptionsMethod": "getCustomers"
    },
    ...
    "options": [
      ...
      },
      {
        ...
        "options": [
          ...
          {
            "name": "This Fiscal Quarter-to-Date",
            "value": "This Fiscal Quarter-to-Date"
          },
          {
            "name": "Last Fiscal Quarter-to-Date",
          ...
          {
            "name": "This Fiscal Year-to-Date",
            "value": "This Fiscal Year-to-Date"
          },
          {
            "name": "Last Fiscal Year-to-Date",
            "value": "Last Fiscal Year-to-Date"
          },
          {
      ...
      },
      {
        ...
        "options": [
          ...
          {
            "name": "Bill Payment Check",
            "value": "BillPaymentCheck"
          },
          {
            "name": "Bill Payment Credit Card",
            "value": "BillPaymentCreditCard"
          },
          {
          ...
          {
            "name": "Credit Card Credit",
            "value": "CreditCardCredit"
          },
          {
            "name": "Credit Memo",
            "value": "CreditMemo"
          ...
          {
            "name": "Global Tax Adjustment",
            "value": "GlobalTaxAdjustment"
          },
          {
            "name": "Global Tax Payment",
            "value": "GlobalTaxPayment"
          },
          {
            "name": "Inventory Quantity Adjustment",
            "value": "InventoryQuantityAdjustment"
          },
          {
            "name": "Invoice",
            "value": "Invoice"
          ...
          {
            "name": "Service  Tax  Defer",
            "value": "Service Tax Defer"
          },
          {
            "name": "Service  Tax  Gross  Adjustment",
            "value": "Service Tax Gross Adjustment"
          },
          {
            "name": "Service  Tax  Partial  Utilisation",
          ...
          {
            "name": "Service  Tax  Reversal",
            "value": "Service Tax Reversal"
          },
          {
            "name": "Statement",
            "value": "Statement"
