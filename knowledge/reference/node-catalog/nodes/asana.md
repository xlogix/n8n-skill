...
- Source file: `n8n-nodes-base/dist/nodes/Asana/Asana.node.js`
- Node version: `1`
- Groups: `input`
...
- resource `subtask`: `create`, `getAll`
- resource `task`: `create`, `delete`, `get`, `getAll`, `move`, `search`, `update`
- resource `taskComment`: `add`, `remove`
- resource `taskProject`: `add`, `remove`
- resource `taskTag`: `add`, `remove`
...
| Parent Task ID | `taskId` | `string` | yes |  | The task to operate on |
| Name | `name` | `string` | yes |  | The name of the subtask to create |
| Additional Fields | `otherProperties` | `collection` | no | `{}` |  |
| Parent Task ID | `taskId` | `string` | yes |  | The task to operate on |
...
| Operation | `operation` | `options` | no | `create` |  |
| Workspace Name or ID | `workspace` | `options` | yes |  | The workspace to create the task in. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Name | `name` | `string` | yes |  | The name of the task to create |
| Task ID | `id` | `string` | yes |  | The ID of the task to delete |
| Task ID | `id` | `string` | yes |  | The ID of the task to get the data of |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` | Properties to search for |
| Task ID | `id` | `string` | yes |  | The ID of the task to be moved |
| Project Name or ID | `projectId` | `options` | yes |  | Project to show the sections of. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Section Name or ID | `section` | `options` | yes |  | The Section to move the task to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Task ID | `id` | `string` | yes |  | The ID of the task to update the data of |
| Workspace Name or ID | `workspace` | `options` | yes |  | The workspace in which the task is searched. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Filters | `searchTaskProperties` | `collection` | no | `{}` | Properties to search for |
| Additional Fields | `otherProperties` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `add` |  |
| Task ID | `id` | `string` | yes |  | The ID of the task to add the comment to |
| Is Text HTML | `isTextHtml` | `boolean` | no | `false` | Whether body is HTML or simple text |
| Text | `text` | `string` | yes |  | The plain text of the comment to add |
| HTML Text | `text` | `string` | yes |  | Comment as HTML string. Do not use together with plain text. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` | Properties of the task comment |
| Comment ID | `id` | `string` | yes |  | The ID of the comment to be removed |
| Operation | `operation` | `options` | no | `add` |  |
| Task ID | `id` | `string` | yes |  | The ID of the task to add the project to |
| Project Name or ID | `project` | `options` | yes |  | The project where the task will be added. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` | Other properties to set |
| Task ID | `id` | `string` | yes |  | The ID of the task to add the project to |
| Project Name or ID | `project` | `options` | yes |  | The project where the task will be removed from. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Operation | `operation` | `options` | no | `add` |  |
| Task ID | `id` | `string` | yes |  | The ID of the task to add the tag to |
| Tags Name or ID | `tag` | `options` | yes |  | The tag that should be added. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Task ID | `id` | `string` | yes |  | The ID of the task to add the tag to |
| Tags Name or ID | `tag` | `options` | yes |  | The tag that should be added. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Operation | `operation` | `options` | no | `get` |  |
| User ID | `userId` | `string` | yes |  | An identifier for the user to get data of. Can be one of an email address,the globally unique identifier for the user, or the keyword me to indicate the current user making the request. |
| Workspace Name or ID | `workspace` | `options` | yes |  | The workspace in which to get users. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Operation | `operation` | `options` | no | `get` |  |
| Name | `name` | `string` | yes |  | The name of the project to create |
| Workspace Name or ID | `workspace` | `options` | yes |  | The workspace to create the project in. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Team Name or ID | `team` | `options` | no |  | The team this project will be assigned to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` | Other properties to set |
| Project ID | `id` | `string` | yes |  |  |
| Project ID | `id` | `string` | yes |  |  |
| Workspace Name or ID | `workspace` | `options` | yes |  | The workspace in which to get users. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` | Other properties to set |
| Workspace Name or ID | `workspace` | `options` | yes |  | The workspace in which to get users. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Project ID | `id` | `string` | yes |  | The ID of the project to update the data of |
| Update Fields | `updateFields` | `collection` | no | `{}` | Other properties to set |
