...
- Node name: `hubspotTrigger`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Hubspot/HubspotTrigger.node.js`
- Node version: `1`
- Groups: `trigger`
...
|---|---|---|---|---|---|
| Events | `eventsUi` | `fixedCollection` | no | `{}` |  |
