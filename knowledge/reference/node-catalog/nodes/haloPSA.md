...
- Source file: `n8n-nodes-base/dist/nodes/HaloPSA/HaloPSA.node.js`
- Node version: `1`
- Groups: `input`
...
- resource `site`: `create`, `delete`, `get`, `getAll`, `update`
...
|---|---|---|---|---|---|
| Resource | `resource` | `options` | yes | `client` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `clientName` | `string` | yes |  | Enter client name |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Client ID | `clientId` | `string` | yes |  |  |
| Simplify | `simplify` | `boolean` | no | `true` | Whether to return a simplified version of the response instead of the raw data |
...
| Ticket Type Name or ID | `ticketType` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
...
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Ticket ID | `ticketId` | `string` | no |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `siteName` | `string` | yes |  | Enter site name |
| Select Client by ID | `selectOption` | `boolean` | no | `false` | Whether client can be selected by ID |
| Client ID | `clientId` | `string` | yes |  |  |
| Client Name or ID | `clientId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Site ID | `siteId` | `string` | no |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `userName` | `string` | yes |  | Enter user name |
| Site Name or ID | `siteId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
