...
- Node name: `microsoftEntra`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Microsoft/Entra/MicrosoftEntra.node.js`
- Node version: `1`
- Groups: `transform`
...
## Credentials
- `microsoftEntraOAuth2Api` (required)
...
- resource `user`: `addGroup`, `create`, `delete`, `get`, `getAll`, `removeGroup`, `update`
...
| Group Type | `groupType` | `options` | no |  |  |
| Group Name | `displayName` | `string` | yes |  | The name to display in the address book for the group |
| Group Email Address | `mailNickname` | `string` | yes |  | The mail alias for the group. Only enter the local-part without the domain. |
| Mail Enabled | `mailEnabled` | `boolean` | yes | `false` | Whether the group is mail-enabled |
| Membership Type | `membershipType` | `options` | no |  |  |
| Security Enabled | `securityEnabled` | `boolean` | no | `true` | Whether the group is a security group |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Group to Delete | `group` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Group to Get | `group` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
...
| Filter | `filter` | `string` | no |  | <a href="https://docs.microsoft.com/en-us/graph/query-parameters#filter-parameter">Query parameter</a> to filter results by |
| Output | `output` | `options` | no | `simple` |  |
| Fields | `fields` | `multiOptions` | no | `[]` | The fields to add to the output |
| Group to Update | `group` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Group | `group` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| User to Add | `user` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Account Enabled | `accountEnabled` | `boolean` | yes | `true` | Whether the account is enabled |
| Display Name | `displayName` | `string` | yes |  | The name to display in the address book for the user |
| User Principal Name | `userPrincipalName` | `string` | yes |  | The user principal name (UPN) |
| Mail Nickname | `mailNickname` | `string` | yes |  | The mail alias for the user |
| Password | `password` | `string` | yes |  | The password for the user |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| User to Delete | `user` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| User to Get | `user` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Output | `output` | `options` | no | `simple` |  |
| Fields | `fields` | `multiOptions` | no | `[]` | The fields to add to the output |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
...
| Fields | `fields` | `multiOptions` | no | `[]` | The fields to add to the output |
| Group | `group` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| User to Remove | `user` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| User to Update | `user` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
  ...
  },
  {
    ...
    "routing": {
      "send": {
        ...
        "type": "body",
        "value": "={{ ($credentials.graphApiBaseUrl || \"https://graph.microsoft.com\").replace(/\\/+$/, \"\") }}/v1.0/directoryObjects/{{ $value }}"
      }
    },
    "type": "resourceLocator"
  },
