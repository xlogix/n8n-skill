...
- Source file: `n8n-nodes-base/dist/nodes/Google/Ads/GoogleAds.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `campaign`: `get`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `campaign` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Divide field names expressed with <i>micros</i> by 1,000,000 to get the actual value | `campaigsNotice` | `notice` | no |  |  |
| Manager Customer ID | `managerCustomerId` | `string` | yes |  |  |
| Client Customer ID | `clientCustomerId` | `string` | yes |  |  |
| Campaign ID | `campaignId` | `string` | yes |  | ID of the campaign |
| Additional Options | `additionalOptions` | `collection` | no | `{}` | Additional options for fetching campaigns |
