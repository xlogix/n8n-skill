...
- Source file: `n8n-nodes-base/dist/nodes/CustomerIo/CustomerIo.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `campaign`: `get`, `getAll`, `getMetrics`
- resource `customer`: `delete`, `upsert`
- resource `event`: `track`, `trackAnonymous`
- resource `segment`: `add`, `remove`
...
| Campaign ID | `campaignId` | `number` | yes | `0` | The unique identifier for the campaign |
| Campaign ID | `campaignId` | `number` | yes | `0` | The unique identifier for the campaign |
| Period | `period` | `options` | no | `days` | Specify metric period |
...
| ID | `id` | `string` | yes |  | The unique identifier for the customer |
| ID | `id` | `string` | yes |  | The unique identifier for the customer |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
...
| Customer ID | `customerId` | `string` | yes |  | The unique identifier for the customer |
| Event Name | `eventName` | `string` | no |  | Name of the event to track |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Additional Fields | `additionalFieldsJson` | `json` | no |  | Object of values to set as described <a href="https://customer.io/docs/api-triggered-data-format#basic-data-formatting">here</a> |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Event Name | `eventName` | `string` | yes |  | The unique identifier for the customer |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Additional Fields | `additionalFieldsJson` | `json` | no |  | Object of values to set as described <a href="https://customer.io/docs/api-triggered-data-format#basic-data-formatting">here</a> |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `add` |  |
| Segment ID | `segmentId` | `number` | yes | `0` | The unique identifier of the segment |
| Customer IDs | `customerIds` | `string` | yes |  | A list of customer IDs to add to the segment |
