...
- Node name: `extractFromFile`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Files/ExtractFromFile/ExtractFromFile.node.js`
- Node version: `[1,1.1]`
- Groups: `input`
...
### Operations
- default/all resources: `binaryToPropery`, `csv`, `fromIcs`, `fromJson`, `html`, `ods`, `pdf`, `rtf`, `text`, `xls`, `xlsx`, `xml`
...
| Input Binary Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Destination Output Field | `destinationKey` | `string` | yes | `data` | The name of the output field that will contain the extracted data |
| Options | `options` | `collection` | no | `{}` |  |
| Input Binary Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Options | `options` | `collection` | no | `{}` |  |
        ...
        "options": [
          {
            ...
            "values": [
              ...
              },
              {
                ...
                "type": "number",
                "default": -1,
                "description": "The maximum number of records that can be skipped, will throw an error if exceeded. Set to -1 to remove limit."
              }
            ]
          }
        ],
