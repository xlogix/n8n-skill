...
- Source file: `n8n-nodes-base/dist/nodes/PayPal/PayPal.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `payout`: `create`, `get`
- resource `payoutItem`: `cancel`, `get`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `payout` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Sender Batch ID | `senderBatchId` | `string` | yes |  | A sender-specified ID number. Tracks the payout in an accounting system. |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Items | `itemsUi` | `fixedCollection` | no | `{}` |  |
| Items | `itemsJson` | `json` | no |  | An array of individual payout items |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Payout Batch ID | `payoutBatchId` | `string` | yes |  | The ID of the payout for which to show details |
...
| Payout Item ID | `payoutItemId` | `string` | yes |  | The ID of the payout item for which to show details |
| Payout Item ID | `payoutItemId` | `string` | yes |  | The ID of the payout item to cancel |
