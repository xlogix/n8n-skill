...
- Source file: `n8n-nodes-base/dist/nodes/Xero/Xero.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `contact`: `create`, `get`, `getAll`, `update`
- resource `invoice`: `create`, `get`, `getAll`, `update`
...
| Organization Name or ID | `organizationId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Name | `name` | `string` | yes |  | Full name of contact/organisation |
...
| Operation | `operation` | `options` | no | `create` |  |
| Organization Name or ID | `organizationId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Type | `type` | `options` | yes |  | Invoice Type |
| Contact ID | `contactId` | `string` | yes |  |  |
