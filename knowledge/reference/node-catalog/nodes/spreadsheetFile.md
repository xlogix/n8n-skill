...
- Node name: `spreadsheetFile`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/SpreadsheetFile/SpreadsheetFile.node.js`
- Node version: `2`
- Groups: `transform`
...
### Operations
- default/all resources: `fromFile`, `toFile`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Operation | `operation` | `options` | no | `fromFile` |  |
...
| File Format | `fileFormat` | `options` | no | `xls` | The format of the file to save the data as |
