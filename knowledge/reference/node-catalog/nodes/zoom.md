...
- Source file: `n8n-nodes-base/dist/nodes/Zoom/Zoom.node.js`
- Node version: `1`
- Groups: `input`
...
| Resource | `resource` | `options` | no | `meeting` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Topic | `topic` | `string` | no |  | Topic of the meeting |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| ID | `meetingId` | `string` | yes |  | Meeting ID |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
