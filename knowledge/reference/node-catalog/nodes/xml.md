...
- Source file: `n8n-nodes-base/dist/nodes/Xml/Xml.node.js`
- Node version: `1`
- Groups: `transform`
...
|---|---|---|---|---|---|
| Mode | `mode` | `options` | no | `xmlToJson` | From and to what format the data should be converted |
| If your XML is inside a binary file, use the 'Extract from File' node to convert it to text first | `xmlNotice` | `notice` | no |  |  |
| Property Name | `dataPropertyName` | `string` | yes | `data` | Name of the property to which to contains the converted XML data |
| Options | `options` | `collection` | no | `{}` |  |
| Property Name | `dataPropertyName` | `string` | yes | `data` | Name of the property which contains the XML data to convert |
| Options | `options` | `collection` | no | `{}` |  |
