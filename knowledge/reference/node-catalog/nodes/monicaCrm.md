...
- Source file: `n8n-nodes-base/dist/nodes/MonicaCrm/MonicaCrm.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `activity`: `create`, `delete`, `get`, `getAll`, `update`
- resource `call`: `create`, `delete`, `get`, `getAll`, `update`
- resource `contact`: `create`, `delete`, `get`, `getAll`, `update`
- resource `contactField`: `create`, `delete`, `get`, `update`
- resource `contactTag`: `add`, `remove`
- resource `conversation`: `create`, `delete`, `get`, `update`
- resource `conversationMessage`: `add`, `update`
- resource `journalEntry`: `create`, `delete`, `get`, `getAll`, `update`
- resource `note`: `create`, `delete`, `get`, `getAll`, `update`
- resource `reminder`: `create`, `delete`, `get`, `getAll`, `update`
- resource `tag`: `create`, `delete`, `get`, `getAll`, `update`
...
| Activity Type Name or ID | `activityTypeId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Contacts | `contacts` | `string` | yes |  | Comma-separated list of IDs of the contacts to associate the activity with |
| Happened At | `happenedAt` | `dateTime` | yes |  | Date when the activity happened |
| Summary | `summary` | `string` | yes |  | Brief description of the activity - max 255 characters |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Activity ID | `activityId` | `string` | yes |  | ID of the activity to delete |
| Activity ID | `activityId` | `string` | yes |  | ID of the activity to retrieve |
...
| Activity ID | `activityId` | `string` | yes |  | ID of the activity to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Contact ID | `contactId` | `string` | yes |  | ID of the contact to associate the call with |
| Called At | `calledAt` | `dateTime` | yes |  | Date when the call happened |
| Description | `content` | `string` | yes |  | Description of the call - max 100,000 characters |
| Call ID | `callId` | `string` | yes |  | ID of the call to delete |
| Call ID | `callId` | `string` | yes |  | ID of the call to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Call ID | `callId` | `string` | yes |  | ID of the call to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| First Name | `firstName` | `string` | yes |  |  |
| Gender Name or ID | `genderId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Contact ID | `contactId` | `string` | yes |  | ID of the contact to associate the contact field with |
| Contact Field Type Name or ID | `contactFieldTypeId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Content | `data` | `string` | yes |  | Content of the contact field - max 255 characters |
| Contact Field ID | `contactFieldId` | `string` | yes |  | ID of the contactField to delete |
| Contact Field ID | `contactFieldId` | `string` | yes |  | ID of the contact field to retrieve |
| Contact ID | `contactId` | `string` | yes |  | ID of the contact whose fields to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Contact ID | `contactId` | `string` | yes |  | ID of the contact to associate the contact field with |
| Contact Field ID | `contactFieldId` | `string` | yes |  | ID of the contact field to update |
| Contact Field Type Name or ID | `contactFieldTypeId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Content | `data` | `string` | yes |  | Content of the contact field - max 255 characters |
| Operation | `operation` | `options` | no | `add` |  |
| Contact ID | `contactId` | `string` | yes |  | ID of the contact to add a tag to |
| Tag Names or IDs | `tagsToAdd` | `multiOptions` | yes | `[]` | Tags to add to the contact. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Contact ID | `contactId` | `string` | yes |  | ID of the contact to remove the tag from |
| Tag Names or IDs | `tagsToRemove` | `multiOptions` | yes | `[]` | Tags to remove from the contact. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Operation | `operation` | `options` | no | `create` |  |
| Contact ID | `contactId` | `string` | yes |  | ID of the contact to associate the conversation with |
| Contact Field Type Name or ID | `contactFieldTypeId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Happened At | `happenedAt` | `dateTime` | yes |  | Date when the conversation happened |
| Conversation ID | `conversationId` | `string` | yes |  | ID of the conversation to delete |
| Conversation ID | `conversationId` | `string` | yes |  | ID of the conversation to retrieve |
| Conversation ID | `conversationId` | `string` | yes |  | ID of the conversation to update |
| Contact Field Type Name or ID | `contactFieldTypeId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Happened At | `happenedAt` | `dateTime` | yes |  | Date when the conversation happened |
| Operation | `operation` | `options` | no | `add` |  |
| Conversation ID | `conversationId` | `string` | yes |  | ID of the contact whose conversation |
| Content | `content` | `string` | yes |  | Content of the message |
| Written At | `writtenAt` | `dateTime` | yes |  | Date when the message was written |
| Written By | `writtenByMe` | `options` | yes | `true` | Author of the message |
| Message ID | `messageId` | `string` | yes |  | ID of the message to update |
| Conversation ID | `conversationId` | `string` | yes |  | ID of the conversation whose message to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Title | `title` | `string` | yes |  | Title of the journal entry - max 250 characters |
| Content | `post` | `string` | yes |  | Content of the journal entry - max 100,000 characters |
| Journal Entry ID | `journalId` | `string` | yes |  | ID of the journal entry to delete |
| Journal Entry ID | `journalId` | `string` | yes |  | ID of the journal entry to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Journal Entry ID | `journalId` | `string` | yes |  | ID of the journal entry to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Contact ID | `contactId` | `string` | yes |  | ID of the contact to associate the note with |
| Body | `body` | `string` | yes |  | Body of the note - max 100,000 characters |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Note ID | `noteId` | `string` | yes |  | ID of the note to delete |
| Note ID | `noteId` | `string` | yes |  | ID of the note to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Note ID | `noteId` | `string` | yes |  | ID of the note to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Contact ID | `contactId` | `string` | no |  | ID of the contact to associate the reminder with |
| Frequency Type | `frequencyType` | `options` | yes | `one_time` | Type of frequency of the reminder |
| Recurring Interval | `frequencyNumber` | `number` | no | `0` | Interval for the reminder |
| Initial Date | `initialDate` | `dateTime` | yes |  | Date of the reminder |
| Title | `title` | `string` | yes |  | Title of the reminder - max 100,000 characters |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Reminder ID | `reminderId` | `string` | yes |  | ID of the reminder to delete |
| Reminder ID | `reminderId` | `string` | yes |  | ID of the reminder to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Reminder ID | `reminderId` | `string` | yes |  | ID of the reminder to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | Name of the tag - max 250 characters |
| Tag ID | `tagId` | `string` | yes |  | ID of the tag to delete |
| Tag ID | `tagId` | `string` | yes |  | ID of the tag to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Tag ID | `tagId` | `string` | yes |  | ID of the tag to update |
| Name | `name` | `string` | yes |  | Name of the tag - max 250 characters |
| Operation | `operation` | `options` | no | `create` |  |
| Contact ID | `contactId` | `string` | yes |  | ID of the contact to associate the task with |
| Title | `title` | `string` | yes |  | Title of the task entry - max 250 characters |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
