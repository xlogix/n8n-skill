...
- Source file: `n8n-nodes-base/dist/nodes/Freshdesk/Freshdesk.node.js`
- Node version: `1`
- Groups: `output`
...
|---|---|---|---|---|---|
| Resource | `resource` | `options` | yes | `ticket` |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Requester Identification | `requester` | `options` | yes | `requesterId` |  |
| Value | `requesterIdentificationValue` | `string` | yes |  | Value of the identification selected |
| Status | `status` | `options` | yes | `pending` |  |
| Priority | `priority` | `options` | yes | `low` |  |
| Source | `source` | `options` | yes | `portal` | The channel through which the ticket was created |
...
| Ticket ID | `ticketId` | `string` | yes |  |  |
| Operation | `operation` | `options` | yes | `create` |  |
| Name | `name` | `string` | yes |  | Name of the contact |
| Email | `email` | `string` | no |  | Primary email address of the contact. If you want to associate additional email(s) with this contact, use the other_emails attribute. |
