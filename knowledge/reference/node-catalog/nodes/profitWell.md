...
- Node name: `profitWell`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/ProfitWell/ProfitWell.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `company`: `getSetting`
- resource `metric`: `get`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `metric` |  |
| Operation | `operation` | `options` | no | `getSetting` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Type | `type` | `options` | yes |  |  |
| Month | `month` | `string` | yes |  | Can only be the current or previous month. Format should be YYYY-MM. |
