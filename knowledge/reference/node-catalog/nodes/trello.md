...
- Source file: `n8n-nodes-base/dist/nodes/Trello/Trello.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `attachment`: `create`, `delete`, `get`, `getAll`
- resource `board`: `create`, `delete`, `get`, `update`
- resource `boardMember`: `add`, `getAll`, `invite`, `remove`
- resource `card`: `create`, `delete`, `get`, `update`
- resource `cardComment`: `create`, `delete`, `update`
- resource `checklist`: `completedCheckItems`, `create`, `createCheckItem`, `delete`, `deleteCheckItem`, `get`, `getAll`, `getCheckItem`, `updateCheckItem`
- resource `label`: `addLabel`, `create`, `delete`, `get`, `getAll`, `removeLabel`, `update`
- resource `list`: `archive`, `create`, `get`, `getAll`, `getCards`, `update`
...
| Operation | `operation` | `options` | no | `getAll` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Card ID | `cardId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The ID of the card |
| Source URL | `url` | `string` | yes |  | The URL of the attachment to add |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Attachment ID | `id` | `string` | yes |  | The ID of the attachment to delete |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Attachment ID | `id` | `string` | yes |  | The ID of the attachment to get |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Name | `name` | `string` | yes |  | The name of the board |
| Description | `description` | `string` | no |  | The description of the board |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Board | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The ID of the board |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Type | `type` | `options` | yes | `normal` | Determines the type of membership the user being added should have |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Board ID | `id` | `string` | yes |  | The ID of the board to invite member to |
| Email | `email` | `string` | yes |  | The ID of the board to update |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| List ID | `listId` | `string` | yes |  | The ID of the list to create card in |
| Name | `name` | `string` | yes |  | The name of the card |
| Description | `description` | `string` | no |  | The description of the card |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Card | `id` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The ID of the card |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Card | `cardId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The ID of the card |
| Text | `text` | `string` | yes |  | Text of the comment |
| Comment ID | `commentId` | `string` | yes |  | The ID of the comment to delete |
| Comment ID | `commentId` | `string` | yes |  | The ID of the comment to delete |
| Text | `text` | `string` | yes |  | Text of the comment |
| Card | `cardId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The ID of the card |
| Name | `name` | `string` | yes |  | The URL of the checklist to add |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Checklist ID | `id` | `string` | yes |  | The ID of the checklist to delete |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Checklist ID | `id` | `string` | yes |  | The ID of the checklist to get |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Checklist ID | `checklistId` | `string` | yes |  | The ID of the checklist to update |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Board | `boardId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The ID of the board |
| Name | `name` | `string` | yes |  | Name for the label |
| Color | `color` | `options` | yes | `null` | The color for the label |
| Label ID | `id` | `string` | yes |  | The ID of the label to delete |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Label ID | `id` | `string` | yes |  | Get information about a label by ID |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Card ID | `cardId` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The ID of the card |
| Label ID | `id` | `string` | yes |  | The ID of the label to add |
| Label ID | `id` | `string` | yes |  | The ID of the label to remove |
| Label ID | `id` | `string` | yes |  | The ID of the label to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| List ID | `id` | `string` | yes |  | The ID of the list to archive or unarchive |
| Archive | `archive` | `boolean` | no | `false` | Whether the list should be archived or unarchived |
| Board ID | `idBoard` | `string` | yes |  | The ID of the board the list should be created in |
| Name | `name` | `string` | yes |  | The name of the list |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| List ID | `id` | `string` | yes |  | The ID of the list to get cards |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `20` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
