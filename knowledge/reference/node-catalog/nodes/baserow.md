...
- Source file: `n8n-nodes-base/dist/nodes/Baserow/Baserow.node.js`
- Node version: `1`
- Groups: `output`
...
| Database Name or ID | `databaseId` | `options` | yes |  | Database to operate on. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Table Name or ID | `tableId` | `options` | yes |  | Table to operate on. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Row ID | `rowId` | `string` | yes |  | ID of the row to return |
| Row ID | `rowId` | `string` | yes |  | ID of the row to update |
...
| Row ID | `rowId` | `string` | yes |  | ID of the row to delete |
