...
- Source file: `n8n-nodes-base/dist/nodes/S3/S3.node.js`
- Node version: `1`
- Groups: `output`
...
|---|---|---|---|---|---|
| This node is for services that use the S3 standard, e.g. Minio or Digital Ocean Spaces. For AWS S3 use the 'AWS S3' node. | `s3StandardNotice` | `notice` | no |  |  |
