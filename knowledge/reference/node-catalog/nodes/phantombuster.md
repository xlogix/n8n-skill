...
- Node name: `phantombuster`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Phantombuster/Phantombuster.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `agent`: `delete`, `get`, `getAll`, `getOutput`, `launch`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `agent` |  |
| Operation | `operation` | `options` | no | `launch` |  |
| Agent Name or ID | `agentId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Agent ID | `agentId` | `string` | yes |  |  |
...
| Agent Name or ID | `agentId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Resolve Data | `resolveData` | `boolean` | no | `true` | By default the outpout is presented as string. If this option gets activated, it will resolve the data automatically. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Agent Name or ID | `agentId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Resolve Data | `resolveData` | `boolean` | no | `true` | By default the launch just include the container ID. If this option gets activated, it will resolve the data automatically. |
