...
- Source file: `n8n-nodes-base/dist/nodes/Onfleet/Onfleet.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `admin`: `create`, `delete`, `getAll`, `update`
- resource `container`: `addTask`, `get`, `updateTask`
- resource `destination`: `create`, `get`
- resource `hub`: `create`, `getAll`, `update`
- resource `organization`: `get`, `getDelegatee`
- resource `recipient`: `create`, `get`, `update`
- resource `task`: `clone`, `complete`, `create`, `delete`, `get`, `getAll`, `update`
- resource `team`: `autoDispatch`, `create`, `delete`, `get`, `getAll`, `getTimeEstimates`, `update`
- resource `worker`: `create`, `delete`, `get`, `getAll`, `getSchedule`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `task` | The resource to perform operations on |
...
| Limit | `limit` | `number` | no | `64` | Max number of results to return |
| Name | `name` | `string` | yes |  | The administrator's name |
| Email | `email` | `string` | yes |  | The administrator's email address |
...
| Container Type | `containerType` | `options` | yes |  |  |
| Container ID | `containerId` | `string` | yes |  | The object ID according to the container chosen |
| Insert Type | `type` | `options` | yes |  |  |
| Index | `index` | `number` | yes | `0` | The index given indicates the position where the tasks are going to be inserted |
| Task IDs | `tasks` | `string` | yes | `[]` | Task's ID that are going to be used |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Destination ID | `id` | `string` | yes |  | The ID of the destination object for lookup |
| Unparsed Address | `unparsed` | `boolean` | yes | `false` | Whether or not the address is specified in a single unparsed string |
| Destination Address | `address` | `string` | yes |  | The destination's street address details |
| Number | `addressNumber` | `string` | yes |  | The number component of this address, it may also contain letters |
| Street | `addressStreet` | `string` | yes |  | The name of the street |
| City | `addressCity` | `string` | yes |  | The name of the municipality |
| Country | `addressCountry` | `string` | yes |  | The name of the country |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
...
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `64` | Max number of results to return |
| Name | `name` | `string` | yes |  | A name to identify the hub |
| Destination | `destination` | `fixedCollection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Organization ID | `id` | `string` | yes |  | The ID of the delegatees for lookup |
| Operation | `operation` | `options` | no | `get` |  |
| Get By | `getBy` | `options` | yes | `id` | The variable that is used for looking up a recipient |
| Recipient ID | `id` | `string` | yes |  | The ID of the recipient object for lookup |
| Recipient ID | `id` | `string` | yes |  | The ID of the recipient object for lookup |
| Name | `name` | `string` | yes |  | The name of the recipient for lookup |
| Phone | `phone` | `string` | yes |  | The phone of the recipient for lookup |
| Recipient Name | `recipientName` | `string` | yes |  | The recipient's complete name |
| Recipient Phone | `recipientPhone` | `string` | yes |  | A unique, valid phone number as per the organization's country if there's no leading + sign. If a phone number has a leading + sign, it will disregard the organization's country setting. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Task ID | `id` | `string` | yes |  | The ID of the task object for lookup |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `64` | Max number of results to return |
| Destination | `destination` | `fixedCollection` | yes | `{}` |  |
| Complete as a Success | `success` | `boolean` | yes | `true` | Whether the task's completion was successful |
| Filters | `filters` | `collection` | no | `{}` |  |
| Override Fields | `overrideFields` | `collection` | no | `{}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Team ID | `id` | `string` | yes |  | The ID of the team object for lookup |
| Name | `name` | `string` | yes |  | A unique name for the team |
| Worker Names or IDs | `workers` | `multiOptions` | yes | `[]` | A list of workers. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Administrator Names or IDs | `managers` | `multiOptions` | yes | `[]` | A list of managing administrators. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `64` | Max number of results to return |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
...
| Filters | `filters` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Search by Location | `byLocation` | `boolean` | yes | `false` | Whether to search for only those workers who are currently within a certain target area |
| Worker ID | `id` | `string` | yes |  | The ID of the worker object for lookup |
| Name | `name` | `string` | yes |  | The worker's name |
| Phone | `phone` | `string` | yes |  | A list of worker’s phone numbers |
| Team Names or IDs | `teams` | `multiOptions` | yes | `[]` | One or more teams of which the worker is a member. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Longitude | `longitude` | `number` | yes | `0` | The longitude component of the coordinate pair |
| Latitude | `latitude` | `number` | yes | `0` | The latitude component of the coordinate pair |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `64` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
...
| Options | `options` | `collection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Schedule | `schedule` | `fixedCollection` | no | `{}` |  |
