...
- Node name: `boxTrigger`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Box/BoxTrigger.node.js`
- Node version: `1`
- Groups: `trigger`
...
| Target Type | `targetType` | `options` | no |  | The type of item to trigger a webhook |
| Target ID | `targetId` | `string` | no |  | The ID of the item to trigger a webhook |
