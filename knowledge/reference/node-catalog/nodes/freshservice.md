...
- Node name: `freshservice`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Freshservice/Freshservice.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `agent`: `create`, `delete`, `get`, `getAll`, `update`
- resource `agentGroup`: `create`, `delete`, `get`, `getAll`, `update`
- resource `agentRole`: `get`, `getAll`
- resource `announcement`: `create`, `delete`, `get`, `getAll`, `update`
- resource `assetType`: `create`, `delete`, `get`, `getAll`, `update`
- resource `change`: `create`, `delete`, `get`, `getAll`, `update`
- resource `department`: `create`, `delete`, `get`, `getAll`, `update`
- resource `location`: `create`, `delete`, `get`, `getAll`, `update`
- resource `problem`: `create`, `delete`, `get`, `getAll`, `update`
- resource `product`: `create`, `delete`, `get`, `getAll`, `update`
- resource `release`: `create`, `delete`, `get`, `getAll`, `update`
- resource `requester`: `create`, `delete`, `get`, `getAll`, `update`
- resource `requesterGroup`: `create`, `delete`, `get`, `getAll`, `update`
- resource `software`: `create`, `delete`, `get`, `getAll`, `update`
- resource `ticket`: `create`, `delete`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `agent` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Email | `email` | `string` | yes |  |  |
| First Name | `firstName` | `string` | yes |  |  |
| Roles | `roles` | `fixedCollection` | yes | `{}` | Role to assign to the agent |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Agent ID | `agentId` | `string` | yes |  | ID of the agent to delete |
| Agent ID | `agentId` | `string` | yes |  | ID of the agent to retrieve |
...
| Agent ID | `agentId` | `string` | yes |  | ID of the agent to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Agent Group ID | `agentGroupId` | `string` | yes |  | ID of the agent group to delete |
| Agent Group ID | `agentGroupId` | `string` | yes |  | ID of the agent group to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Agent Group ID | `agentGroupId` | `string` | yes |  | ID of the agent group to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Agent Role ID | `agentRoleId` | `string` | yes |  | ID of the agent role to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
| Title | `title` | `string` | yes |  |  |
| Body | `bodyHtml` | `string` | yes |  | HTML supported |
| Visibility | `visibility` | `options` | yes | `everyone` |  |
| Visible From | `visibleFrom` | `dateTime` | yes |  | Timestamp at which announcement becomes active |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Announcement ID | `announcementId` | `string` | yes |  | ID of the announcement to delete |
| Announcement ID | `announcementId` | `string` | yes |  | ID of the announcement to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Announcement ID | `announcementId` | `string` | yes |  | ID of the announcement to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Asset Type ID | `assetTypeId` | `string` | yes |  | ID of the asset type to delete |
| Asset Type ID | `assetTypeId` | `string` | yes |  | ID of the asset type to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Asset Type ID | `assetTypeId` | `string` | yes |  | ID of the asset type to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Requester Name or ID | `requesterId` | `options` | yes |  | ID of the requester of the change. Choose from the list or specify an ID. You can also specify the ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Subject | `subject` | `string` | yes |  |  |
| Planned Start Date | `plannedStartDate` | `dateTime` | yes |  |  |
| Planned End Date | `plannedEndDate` | `dateTime` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Change ID | `changeId` | `string` | yes |  | ID of the change to delete |
| Change ID | `changeId` | `string` | yes |  | ID of the change to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Change ID | `changeId` | `string` | yes |  | ID of the change to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Department ID | `departmentId` | `string` | yes |  | ID of the department to delete |
| Department ID | `departmentId` | `string` | yes |  | ID of the department to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Department ID | `departmentId` | `string` | yes |  | ID of the department to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | Name of the location |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Location ID | `locationId` | `string` | yes |  | ID of the location to delete |
| Location ID | `locationId` | `string` | yes |  | ID of the location to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Location ID | `locationId` | `string` | yes |  | ID of the location to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Subject | `subject` | `string` | yes |  |  |
| Requester Name or ID | `requesterId` | `options` | yes |  | ID of the initiator of the problem. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Due By | `dueBy` | `dateTime` | no |  | Date when the problem is due to be solved |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Problem ID | `problemId` | `string` | yes |  | ID of the problem to delete |
| Problem ID | `problemId` | `string` | yes |  | ID of the problem to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Problem ID | `problemId` | `string` | yes |  | ID of the problem to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Asset Type Name or ID | `assetTypeId` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Name | `name` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Operation | `operation` | `options` | no | `create` |  |
| Subject | `subject` | `string` | yes |  |  |
| Release Type | `releaseType` | `options` | no | `1` |  |
| Priority | `priority` | `options` | no | `1` |  |
| Status | `status` | `options` | no | `1` |  |
| Planned Start Date | `plannedStartDate` | `dateTime` | yes |  |  |
| Planned End Date | `plannedEndDate` | `dateTime` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Release ID | `releaseId` | `string` | yes |  | ID of the release to delete |
| Release ID | `releaseId` | `string` | yes |  | ID of the release to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Release ID | `releaseId` | `string` | yes |  | ID of the release to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| First Name | `firstName` | `string` | yes |  |  |
| Primary Email | `primaryEmail` | `string` | no |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Requester ID | `requesterId` | `string` | yes |  | ID of the requester to delete |
| Requester ID | `requesterId` | `string` | yes |  | ID of the requester to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Requester ID | `requesterId` | `string` | yes |  | ID of the requester to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Requester Group ID | `requesterGroupId` | `string` | yes |  | ID of the requester group to delete |
| Requester Group ID | `requesterGroupId` | `string` | yes |  | ID of the requester group to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Requester Group ID | `requesterGroupId` | `string` | yes |  | ID of the requester group to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Application Type | `applicationType` | `options` | yes | `desktop` |  |
| Name | `name` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Software ID | `softwareId` | `string` | yes |  | ID of the software application to delete |
| Software ID | `softwareId` | `string` | yes |  | ID of the software application to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Software ID | `softwareId` | `string` | yes |  | ID of the software application to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Email | `email` | `string` | yes |  | Email address of the ticket author |
| Subject | `subject` | `string` | no |  |  |
| Description | `description` | `string` | no |  | HTML supported |
| Priority | `priority` | `options` | no | `1` |  |
| Status | `status` | `options` | no | `2` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Ticket ID | `ticketId` | `string` | yes |  | ID of the ticket to delete |
| Ticket ID | `ticketId` | `string` | yes |  | ID of the ticket to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Ticket ID | `ticketId` | `string` | yes |  | ID of the ticket to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
