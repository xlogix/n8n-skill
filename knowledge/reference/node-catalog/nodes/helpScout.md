...
- Source file: `n8n-nodes-base/dist/nodes/HelpScout/HelpScout.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `conversation`: `create`, `delete`, `get`, `getAll`
- resource `customer`: `create`, `get`, `getAll`, `properties`, `update`
- resource `mailbox`: `get`, `getAll`
- resource `thread`: `create`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `conversation` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Mailbox Name or ID | `mailboxId` | `options` | yes |  | ID of a mailbox where the conversation is being created. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Status | `status` | `options` | yes |  | Conversation status |
| Subject | `subject` | `string` | yes |  | Conversation’s subject |
| Type | `type` | `options` | yes |  | Conversation type |
| Resolve Data | `resolveData` | `boolean` | no | `true` | By default the response only contain the ID to resource. If this option gets activated, it will resolve the data automatically. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Threads | `threadsUi` | `fixedCollection` | no | `{}` |  |
| Conversation ID | `conversationId` | `string` | yes |  |  |
| Conversation ID | `conversationId` | `string` | yes |  |  |
...
| Resolve Data | `resolveData` | `boolean` | no | `true` | By default the response only contain the ID to resource. If this option gets activated, it will resolve the data automatically. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Address | `addressUi` | `fixedCollection` | no | `{}` |  |
| Chat Handles | `chatsUi` | `fixedCollection` | no | `{}` |  |
| Emails | `emailsUi` | `fixedCollection` | no | `{}` |  |
| Phones | `phonesUi` | `fixedCollection` | no | `{}` |  |
| Social Profiles | `socialProfilesUi` | `fixedCollection` | no | `{}` |  |
| Websites | `websitesUi` | `fixedCollection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
...
| Mailbox ID | `mailboxId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
| Conversation ID | `conversationId` | `string` | yes |  |  |
| Type | `type` | `options` | yes |  |  |
| Text | `text` | `string` | yes |  | The chat text |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
