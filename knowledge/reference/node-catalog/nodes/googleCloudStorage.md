...
- Node name: `googleCloudStorage`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Google/CloudStorage/GoogleCloudStorage.node.js`
- Node version: `1`
- Groups: `transform`
...
## Credentials
- `googleCloudStorageOAuth2Api` (required)
...
### Operations
- resource `bucket`: `create`, `delete`, `get`, `getAll`, `update`
- resource `object`: `create`, `delete`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `bucket` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Project ID | `projectId` | `string` | yes |  |  |
| Bucket Name | `bucketName` | `string` | yes |  |  |
| Prefix | `prefix` | `string` | no |  |  |
| Projection | `projection` | `options` | no | `noAcl` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Filters | `getFilters` | `collection` | no | `{}` |  |
| Predefined Access Control | `createAcl` | `collection` | no | `{}` |  |
| Additional Parameters | `createBody` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Bucket Name | `bucketName` | `string` | yes |  |  |
| Object Name | `objectName` | `string` | yes |  |  |
| Projection | `projection` | `options` | no | `noAcl` |  |
| Projection | `updateProjection` | `options` | no | `full` |  |
| Return Data | `alt` | `options` | no | `json` |  |
| Use Input Binary Field | `createFromBinary` | `boolean` | no | `true` | Whether the data for creating a file should come from a binary field |
| Input Binary Field | `createBinaryPropertyName` | `string` | no | `data` |  |
| File Content | `createContent` | `string` | no |  | Content of the file to be uploaded |
| Put Output File in Field | `binaryPropertyName` | `string` | no | `data` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `maxResults` | `number` | no | `100` | Max number of results to return |
| Create Fields | `createData` | `collection` | no | `{}` |  |
| Update Fields | `updateData` | `collection` | no | `{"acl":"[]"}` |  |
| Additional Parameters | `createQuery` | `collection` | no | `{}` |  |
| Additional Parameters | `getParameters` | `collection` | no | `{}` |  |
| Additional Parameters | `metagenAndAclQuery` | `collection` | no | `{}` |  |
| Encryption Headers | `encryptionHeaders` | `collection` | no | `{}` |  |
| Additional Parameters | `listFilters` | `collection` | no | `{}` |  |
