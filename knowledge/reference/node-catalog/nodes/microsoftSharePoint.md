...
- Node name: `microsoftSharePoint`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Microsoft/SharePoint/MicrosoftSharePoint.node.js`
- Node version: `1`
- Groups: `transform`
...
## Credentials
- `microsoftSharePointOAuth2Api` (required)
...
### Operations
- resource `file`: `download`, `update`, `upload`
- resource `item`: `create`, `delete`, `get`, `getAll`, `update`, `upsert`
- resource `list`: `get`, `getAll`
...
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve folders from |
| Parent Folder | `folder` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the folder to download the file from |
| File | `file` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the file to download |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve folders from |
| Parent Folder | `folder` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the folder to update the file in |
| File | `file` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the file to update |
| Updated File Name | `fileName` | `string` | no |  | If not specified, the original file name will be used |
| Change File Content | `changeFileContent` | `boolean` | yes | `false` | Whether to update the file contents |
| Updated File Contents | `fileContents` | `string` | yes |  | Find the name of input field containing the binary data to update the file with in the Input panel on the left, in the Binary tab |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve folders from |
| Parent Folder | `folder` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the folder to upload the file to |
| File Name | `fileName` | `string` | yes |  | The name of the file being uploaded |
| File Contents | `fileContents` | `string` | yes |  | Find the name of input field containing the binary data to upload in the Input panel on the left, in the Binary tab |
| Operation | `operation` | `options` | no | `getAll` |  |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve lists from |
| List | `list` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the list you want to create an item in |
| Due to API restrictions, the following column types cannot be updated: Hyperlink, Location, Metadata | `noticeUnsupportedFields` | `notice` | no |  |  |
| Columns | `columns` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve lists from |
| List | `list` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the list you want to delete an item in |
| Item | `item` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the item you want to delete |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve lists from |
| List | `list` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the list you want to retrieve an item from |
| Item | `item` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the item you want to get |
| Simplify | `simplify` | `boolean` | no | `true` |  |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve lists from |
| List | `list` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the list you want to search for items in |
| Filter by Formula | `filter` | `string` | no |  | The formula will be evaluated for each record. <a href="https://learn.microsoft.com/en-us/graph/filter-query-parameter">More info</a>. |
...
| Simplify | `simplify` | `boolean` | no | `true` |  |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve lists from |
| List | `list` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the list you want to update an item in |
| Due to API restrictions, the following column types cannot be updated: Hyperlink, Location, Metadata | `noticeUnsupportedFields` | `notice` | no |  |  |
| Columns | `columns` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve lists from |
| List | `list` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the list you want to create or update an item in |
| Due to API restrictions, the following column types cannot be updated: Hyperlink, Location, Metadata | `noticeUnsupportedFields` | `notice` | no |  |  |
| Columns | `columns` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve lists from |
| List | `list` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the list you want to retrieve |
| Simplify | `simplify` | `boolean` | no | `true` |  |
| Site | `site` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the site to retrieve lists from |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
