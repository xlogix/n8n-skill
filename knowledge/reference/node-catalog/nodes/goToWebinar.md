...
- Node name: `goToWebinar`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/GoToWebinar/GoToWebinar.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `attendee`: `get`, `getAll`, `getDetails`
- resource `coorganizer`: `create`, `delete`, `getAll`, `reinvite`
- resource `panelist`: `create`, `delete`, `getAll`, `reinvite`
- resource `registrant`: `create`, `delete`, `get`, `getAll`
- resource `session`: `get`, `getAll`, `getDetails`
- resource `webinar`: `create`, `get`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `attendee` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Webinar Key Name or ID | `webinarKey` | `options` | yes |  | Key of the webinar that the attendee attended. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Session Key Name or ID | `sessionKey` | `options` | yes |  | Key of the session that the attendee attended. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Registrant Key | `registrantKey` | `string` | yes |  | Registrant key of the attendee at the webinar session |
| Registrant Key | `registrantKey` | `string` | yes |  | Registrant key of the attendee at the webinar session |
| Details | `details` | `options` | yes |  | The details to retrieve for the attendee |
...
| Operation | `operation` | `options` | no | `get` |  |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar that the co-organizer is hosting. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Is External | `isExternal` | `boolean` | yes | `false` | Whether the co-organizer has no GoToWebinar account |
| Organizer Key | `organizerKey` | `string` | no |  | The co-organizer's organizer key for the webinar |
| Given Name | `givenName` | `string` | no |  | The co-organizer's given name |
| Email | `email` | `string` | no |  | The co-organizer's email address |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar to delete. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Co-Organizer Key | `coorganizerKey` | `string` | no |  | Key of the co-organizer to delete |
| Is External | `isExternal` | `boolean` | yes | `false` | By default only internal co-organizers (with a GoToWebinar account) can be deleted. If you want to use this call for external co-organizers you have to set this parameter to 'true'. |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar to retrieve all co-organizers from. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `10` | Max number of results to return |
| Webinar Key | `webinarKey` | `string` | yes |  | By default only internal co-organizers (with a GoToWebinar account) can be deleted. If you want to use this call for external co-organizers you have to set this parameter to 'true'. |
| Co-Organizer Key | `coorganizerKey` | `string` | no |  | Key of the co-organizer to reinvite |
| Is External | `isExternal` | `boolean` | yes | `false` | Whether the co-organizer has no GoToWebinar account |
| Operation | `operation` | `options` | no | `get` |  |
| Name | `name` | `string` | yes |  | Name of the panelist to create |
| Email | `email` | `string` | yes |  | Email address of the panelist to create |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar that the panelist will present at. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar to retrieve all panelists from. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `10` | Max number of results to return |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar to delete the panelist from. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Panelist Key | `panelistKey` | `string` | yes |  | Key of the panelist to delete |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar to reinvite the panelist to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Panelist Key | `panelistKey` | `string` | yes |  | Key of the panelist to reinvite |
| Operation | `operation` | `options` | no | `get` |  |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar of the registrant to create. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| First Name | `firstName` | `string` | no |  | First name of the registrant to create |
| Last Name | `lastName` | `string` | no |  | Last name of the registrant to create |
| Email | `email` | `string` | no |  | Email address of the registrant to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | The key of the webinar to retrieve registrants from. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `10` | Max number of results to return |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar of the registrant to delete. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Registrant Key | `registrantKey` | `string` | yes |  | Key of the registrant to delete |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar of the registrant to retrieve. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Registrant Key | `registrantKey` | `string` | yes |  | Key of the registrant to retrieve |
| Operation | `operation` | `options` | no | `get` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `10` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Webinar Key Name or ID | `webinarKey` | `options` | yes | `[]` | Key of the webinar to which the session belongs. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Session Key | `sessionKey` | `string` | yes |  |  |
| Details | `details` | `options` | no | `performance` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Subject | `subject` | `string` | yes |  |  |
| Time Range | `times` | `fixedCollection` | yes | `{}` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Webinar Key | `webinarKey` | `string` | yes |  | Key of the webinar to delete |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Webinar Key | `webinarKey` | `string` | yes |  | Key of the webinar to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `10` | Max number of results to return |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Webinar Key | `webinarKey` | `string` | yes |  | Key of the webinar to update |
| Notify Participants | `notifyParticipants` | `boolean` | yes | `false` |  |
