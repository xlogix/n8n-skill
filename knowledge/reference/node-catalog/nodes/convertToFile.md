...
- Node name: `convertToFile`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Files/ConvertToFile/ConvertToFile.node.js`
- Node version: `[1,1.1]`
- Groups: `input`
...
### Operations
- default/all resources: `csv`, `html`, `iCal`, `ods`, `rtf`, `toBinary`, `toJson`, `toText`, `xls`, `xlsx`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Operation | `operation` | `options` | no | `csv` |  |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Base64 Input Field | `sourceProperty` | `string` | yes |  | The name of the input field that contains the base64 string to convert to a file. Use dot-notation for deep fields (e.g. 'level1.level2.currentKey'). |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Text Input Field | `sourceProperty` | `string` | yes |  | The name of the input field that contains a string to convert to a file. Use dot-notation for deep fields (e.g. 'level1.level2.currentKey'). |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Mode | `mode` | `options` | no | `once` |  |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Event Title | `title` | `string` | no |  |  |
| Start | `start` | `dateTime` | yes |  | Date and time at which the event begins. (For all-day events, the time will be ignored.). |
| End | `end` | `dateTime` | yes |  | Date and time at which the event ends. (For all-day events, the time will be ignored.). |
| All Day | `allDay` | `boolean` | no | `false` | Whether the event lasts all day or not |
| Put Output File in Field | `binaryPropertyName` | `string` | yes | `data` | The field that your iCalendar file will be available under in the output |
