...
- Source file: `n8n-nodes-base/dist/nodes/Keap/Keap.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `company`: `create`, `getAll`
- resource `contact`: `delete`, `get`, `getAll`, `upsert`
- resource `contactNote`: `create`, `delete`, `get`, `getAll`, `update`
- resource `contactTag`: `create`, `delete`, `getAll`
- resource `ecommerceOrder`: `create`, `delete`, `get`, `getAll`
- resource `ecommerceProduct`: `create`, `delete`, `get`, `getAll`
- resource `email`: `createRecord`, `getAll`, `send`
- resource `file`: `delete`, `getAll`, `upload`
...
| Addresses | `addressesUi` | `fixedCollection` | no | `{}` |  |
| Faxes | `faxesUi` | `fixedCollection` | no | `{}` |  |
| Phones | `phonesUi` | `fixedCollection` | no | `{}` |  |
...
| Duplicate Option | `duplicateOption` | `options` | yes | `email` | Performs duplicate checking by one of the following options: Email, EmailAndName. If a match is found using the option provided, the existing contact will be updated. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Addresses | `addressesUi` | `fixedCollection` | no | `{}` |  |
| Emails | `emailsUi` | `fixedCollection` | no | `{}` |  |
| Faxes | `faxesUi` | `fixedCollection` | no | `{}` |  |
| Phones | `phonesUi` | `fixedCollection` | no | `{}` |  |
| Social Accounts | `socialAccountsUi` | `fixedCollection` | no | `{}` |  |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| User Name or ID | `userId` | `options` | no |  | The infusionsoft user to create the note on behalf of. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Contact ID | `contactId` | `string` | no |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Note ID | `noteId` | `string` | yes |  |  |
| Note ID | `noteId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
...
| Operation | `operation` | `options` | no | `create` |  |
| Contact ID | `contactId` | `string` | yes |  |  |
| Tag Names or IDs | `tagIds` | `multiOptions` | yes | `[]` | Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Contact ID | `contactId` | `string` | yes |  |  |
| Tag IDs | `tagIds` | `string` | yes | `Tag IDs, multiple IDs can be set separated by comma.` |  |
| Contact ID | `contactId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
| Contact ID | `contactId` | `string` | yes |  |  |
| Order Date | `orderDate` | `dateTime` | yes |  |  |
| Order Title | `orderTitle` | `string` | yes |  |  |
| Order Type | `orderType` | `options` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Shipping Address | `addressUi` | `fixedCollection` | no | `{}` |  |
| Order Items | `orderItemsUi` | `fixedCollection` | no | `{}` |  |
| Order ID | `orderId` | `string` | yes |  |  |
| Order ID | `orderId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
...
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `createRecord` |  |
| Sent To Address | `sentToAddress` | `string` | yes |  |  |
| Sent From Address | `sentFromAddress` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| User Name or ID | `userId` | `options` | yes |  | The infusionsoft user to send the email on behalf of. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Contact IDs | `contactIds` | `string` | no |  | Contact IDs to receive the email. Multiple can be added seperated by comma. |
| Subject | `subject` | `string` | no |  | The subject line of the email |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Attachments | `attachmentsUi` | `fixedCollection` | no | `{}` | Attachments to be sent with each copy of the email, maximum of 10 with size of 1MB each |
...
| File Association | `fileAssociation` | `options` | yes |  |  |
| Contact ID | `contactId` | `string` | yes |  |  |
| File Name | `fileName` | `string` | yes |  | The filename of the attached file, including extension |
| File Data | `fileData` | `string` | yes |  | The content of the attachment, encoded in Base64 |
| Is Public | `isPublic` | `boolean` | no | `false` |  |
| File ID | `fileId` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
