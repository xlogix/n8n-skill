...
- Source file: `n8n-nodes-base/dist/nodes/QuestDb/QuestDb.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- default/all resources: `executeQuery`, `insert`
...
| Schema | `schema` | `hidden` | no |  | Name of the schema the table belongs to |
...
| Additional Fields | `additionalFields` | `hidden` | no | `{}` |  |
