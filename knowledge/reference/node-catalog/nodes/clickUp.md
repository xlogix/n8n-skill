...
- Source file: `n8n-nodes-base/dist/nodes/ClickUp/ClickUp.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `checklist`: `create`, `delete`, `update`
- resource `checklistItem`: `create`, `delete`, `update`
- resource `comment`: `create`, `delete`, `getAll`, `update`
- resource `folder`: `create`, `delete`, `get`, `getAll`, `update`
- resource `goal`: `create`, `delete`, `get`, `getAll`, `update`
- resource `goalKeyResult`: `create`, `delete`, `update`
- resource `list`: `create`, `customFields`, `delete`, `get`, `getAll`, `member`, `update`
- resource `spaceTag`: `create`, `delete`, `getAll`, `update`
- resource `task`: `create`, `delete`, `get`, `getAll`, `member`, `setCustomField`, `update`
- resource `taskDependency`: `create`, `delete`
- resource `taskList`: `add`, `remove`
- resource `taskTag`: `add`, `remove`
- resource `timeEntry`: `create`, `delete`, `get`, `getAll`, `start`, `stop`, `update`
- resource `timeEntryTag`: `add`, `getAll`, `remove`
...
| Task ID | `task` | `string` | yes |  |  |
| Name | `name` | `string` | yes |  |  |
| Checklist ID | `checklist` | `string` | yes |  |  |
| Checklist ID | `checklist` | `string` | yes |  |  |
...
| Checklist ID | `checklist` | `string` | yes |  |  |
| Checklist Item ID | `checklistItem` | `string` | yes |  |  |
| Checklist ID | `checklist` | `string` | yes |  |  |
| Checklist Item ID | `checklistItem` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Comment On | `commentOn` | `options` | no |  |  |
| ID | `id` | `string` | yes |  |  |
| Comment Text | `commentText` | `string` | no |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Comment ID | `comment` | `string` | yes |  |  |
| Comments On | `commentsOn` | `options` | no |  |  |
| ID | `id` | `string` | yes |  |  |
...
| Space Name or ID | `space` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Name | `name` | `string` | yes |  |  |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Space Name or ID | `space` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Folder Name or ID | `folder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Space Name or ID | `space` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Folder Name or ID | `folder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Key Result ID | `keyResult` | `string` | yes |  |  |
| Key Result ID | `keyResult` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `add` |  |
| Task ID | `taskId` | `string` | yes |  |  |
| Tag Name | `tagName` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `add` |  |
| Task ID | `taskId` | `string` | yes |  |  |
| List ID | `listId` | `string` | yes |  |  |
| Operation | `operation` | `options` | no | `create` |  |
| Space ID | `space` | `string` | yes |  |  |
| Name | `name` | `string` | yes |  |  |
| Name or ID | `name` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| New Name | `newName` | `string` | yes |  | New name to set for the tag |
| Foreground Color | `foregroundColor` | `color` | yes | `#000000` |  |
| Background Color | `backgroundColor` | `color` | yes | `#000000` |  |
| Return All | `returnAll` | `boolean` | no | `true` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `create` |  |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Space Name or ID | `space` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Folderless List | `folderless` | `boolean` | yes | `false` |  |
| Folder Name or ID | `folder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
...
| List Name or ID | `list` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Name | `name` | `string` | yes |  | The first name on the task |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Task ID | `id` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Task ID | `id` | `string` | yes |  |  |
| Include Subtasks | `includeSubtasks` | `boolean` | no | `false` | Whether to also fetch and include subtasks for this task |
| Include Markdown Description | `includeMarkdownDescription` | `boolean` | no | `false` | Whether to include the markdown_description field in the response. This is important for preserving links in the description. |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Space Name or ID | `space` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Folderless List | `folderless` | `boolean` | yes | `false` |  |
| Folder Name or ID | `folder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
...
| Return All | `returnAll` | `boolean` | no | `true` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Task ID | `task` | `string` | yes |  | The ID of the task to add custom field to |
| Field ID | `field` | `string` | yes |  | The ID of the field to add custom field to |
| Value Is JSON | `jsonParse` | `boolean` | no | `false` | The value is JSON and will be parsed as such. Is needed if for example needed for labels which expects the value to be an array. |
| Value | `value` | `string` | yes |  | The value to set on custom field |
| Operation | `operation` | `options` | no | `create` |  |
| Task ID | `task` | `string` | yes |  |  |
| Depends On Task ID | `dependsOnTask` | `string` | yes |  |  |
| Task ID | `task` | `string` | yes |  |  |
| Depends On Task ID | `dependsOnTask` | `string` | yes |  |  |
| Operation | `operation` | `options` | no | `create` |  |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
...
| Filters | `filters` | `collection` | no | `{}` |  |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Running | `running` | `boolean` | no | `false` | Whether to return just the current running time entry |
| Time Entry ID | `timeEntry` | `string` | yes |  |  |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Space Name or ID | `space` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Folderless List | `folderless` | `boolean` | yes | `false` |  |
| Folder Name or ID | `folder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| List Name or ID | `list` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| List Name or ID | `list` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Start | `start` | `dateTime` | yes |  |  |
| Duration (Minutes) | `duration` | `number` | yes | `0` | Duration in minutes |
| Task Name or ID | `task` | `options` | no |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Task ID | `task` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| List Name or ID | `list` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| List Name or ID | `list` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Archived | `archived` | `boolean` | yes | `false` |  |
| Time Entry ID | `timeEntry` | `string` | yes |  |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Task ID | `task` | `string` | yes |  |  |
| Depends On Task ID | `dependsOnTask` | `string` | yes |  |  |
...
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Time Entry IDs | `timeEntryIds` | `string` | yes |  |  |
| Tags | `tagsUi` | `fixedCollection` | no | `{}` |  |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Time Entry IDs | `timeEntryIds` | `string` | yes |  |  |
| Tag Names or IDs | `tagNames` | `multiOptions` | yes | `[]` | Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Operation | `operation` | `options` | no | `customFields` |  |
| Team Name or ID | `team` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Space Name or ID | `space` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
| Folderless List | `folderless` | `boolean` | yes | `false` |  |
| Folder Name or ID | `folder` | `options` | yes |  | Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a> |
