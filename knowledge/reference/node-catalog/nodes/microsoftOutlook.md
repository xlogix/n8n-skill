...
- Node name: `microsoftOutlook`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Microsoft/Outlook/MicrosoftOutlook.node.js`
- Node version: `2`
- Groups: `transform`
...
### Operations
- resource `calendar`: `create`, `delete`, `get`, `getAll`, `update`
- resource `contact`: `create`, `delete`, `get`, `getAll`, `update`
- resource `draft`: `create`, `delete`, `get`, `send`, `update`
- resource `event`: `create`, `delete`, `get`, `getAll`, `update`
- resource `folder`: `create`, `delete`, `get`, `getAll`, `update`
- resource `folderMessage`: `getAll`
- resource `message`: `delete`, `get`, `getAll`, `move`, `reply`, `send`, `sendAndWait`, `update`
- resource `messageAttachment`: `add`, `download`, `get`, `getAll`
...
| Name | `name` | `string` | yes |  | The name of the calendar to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Calendar | `calendarId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Calendar | `calendarId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
...
| Operation | `operation` | `options` | no | `getAll` |  |
| First Name | `givenName` | `string` | yes |  |  |
| Last Name | `surname` | `string` | no |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Contact | `contactId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Contact | `contactId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
...
| Subject | `subject` | `string` | no |  | The subject of the message |
| Message | `bodyContent` | `string` | no |  | Message body content |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Draft | `draftId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Draft | `draftId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Output | `output` | `options` | no | `simple` |  |
| Fields | `fields` | `multiOptions` | no | `[]` | The fields to add to the output |
| Options | `options` | `collection` | no | `{}` |  |
| Draft | `draftId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| To | `to` | `string` | no |  | Comma-separated list of email addresses of recipients |
| Draft | `draftId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Calendar | `calendarId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Title | `subject` | `string` | yes |  |  |
| Start | `startDateTime` | `dateTime` | yes | `2026-02-16T14:43:26.613+05:30` |  |
| End | `endDateTime` | `dateTime` | yes | `2026-02-16T15:13:26.613+05:30` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Calendar | `calendarId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Event | `eventId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Calendar | `calendarId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Event | `eventId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Output | `output` | `options` | no | `simple` |  |
| Fields | `fields` | `multiOptions` | no | `[]` | The fields to add to the output |
| From All Calendars | `fromAllCalendars` | `boolean` | no | `true` |  |
| Calendar | `calendarId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Output | `output` | `options` | no | `simple` |  |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `displayName` | `string` | yes |  | Name of the folder |
| Options | `options` | `collection` | no | `{}` |  |
| Folder | `folderId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Folder | `folderId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
...
| Message | `messageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Message | `messageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Output | `output` | `options` | no | `simple` |  |
| Fields | `fields` | `multiOptions` | no | `[]` | The fields to add to the output |
| Options | `options` | `collection` | no | `{}` |  |
...
| Options | `options` | `collection` | no | `{}` |  |
| Message | `messageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Parent Folder | `folderId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Message | `messageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Reply to Sender Only | `replyToSenderOnly` | `boolean` | no | `false` | Whether to reply to the sender only or to the entire list of recipients |
| Message | `message` | `string` | no |  | Message body content |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| To | `toRecipients` | `string` | yes |  | Comma-separated list of email addresses of recipients |
| Subject | `subject` | `string` | no |  | The subject of the message |
| Message | `bodyContent` | `string` | no |  | Message body content |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| To | `toRecipients` | `string` | yes |  | Comma-separated list of email addresses of recipients |
...
| Message | `messageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Input Data Field Name | `binaryPropertyName` | `string` | yes | `data` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Message | `messageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Attachment | `attachmentId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Put Output in Field | `binaryPropertyName` | `string` | yes | `data` |  |
| Message | `messageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Attachment | `attachmentId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Message | `messageId` | `resourceLocator` | yes | `{"mode":"list","value":""}` |  |
...
[
  ...
  },
  {
    ...
    "name": "startDateTime",
    "type": "dateTime",
    "default": "2026-02-16T14:43:26.613+05:30",
    "required": true,
    "displayOptions": {
      "show": {
        "resource": [
  ...
  },
  {
    ...
    "type": "dateTime",
    "required": true,
    "default": "2026-02-16T15:13:26.613+05:30",
    "displayOptions": {
      "show": {
        "resource": [
          "event"
