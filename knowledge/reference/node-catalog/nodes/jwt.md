...
- Source file: `n8n-nodes-base/dist/nodes/Jwt/Jwt.node.js`
- Node version: `1`
- Groups: `transform`
- Description: JWT
...
### Operations
- default/all resources: `decode`, `sign`, `verify`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Operation | `operation` | `options` | no | `sign` |  |
| Use JSON to Build Payload | `useJson` | `boolean` | no | `false` | Whether to use JSON to build the claims |
| Payload Claims | `claims` | `collection` | no | `{}` |  |
| Payload Claims (JSON) | `claimsJson` | `json` | no | `{
  "my_field_1": "value 1",
  "my_field_2": "value 2"
}
` | Claims to add to the token in JSON format |
| Token | `token` | `string` | yes |  | The token to verify or decode |
