...
- Source file: `n8n-nodes-base/dist/nodes/Vero/Vero.node.js`
- Node version: `1`
- Groups: `output`
...
- resource `user`: `addTags`, `alias`, `create`, `delete`, `removeTags`, `resubscribe`, `unsubscribe`
...
| ID | `id` | `string` | yes |  | The unique identifier of the customer |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Data | `dataAttributesUi` | `fixedCollection` | no | `{}` | Key value pairs that represent the custom user properties you want to update |
| Data | `dataAttributesJson` | `json` | no |  | Key value pairs that represent the custom user properties you want to update |
| ID | `id` | `string` | yes |  | The old unique identifier of the user |
| New ID | `newId` | `string` | yes |  | The new unique identifier of the user |
| ID | `id` | `string` | yes |  | The unique identifier of the user |
| ID | `id` | `string` | yes |  | The unique identifier of the user |
| ID | `id` | `string` | yes |  | The unique identifier of the user |
| ID | `id` | `string` | yes |  | The unique identifier of the user |
| Tags | `tags` | `string` | yes |  | Tags to add separated by "," |
| ID | `id` | `string` | yes |  | The unique identifier of the user |
| Tags | `tags` | `string` | yes |  | Tags to remove separated by "," |
| ID | `id` | `string` | yes |  | The unique identifier of the customer |
| Email | `email` | `string` | yes |  |  |
| Event Name | `eventName` | `string` | yes |  | The name of the event tracked |
| JSON Parameters | `jsonParameters` | `boolean` | no | `false` |  |
| Data | `dataAttributesUi` | `fixedCollection` | no | `{}` | Key value pairs that represent any properties you want to track with this event |
| Extra | `extraAttributesUi` | `fixedCollection` | no | `{}` | Key value pairs that represent reserved, Vero-specific operators. Refer to the note on “deduplication” below. |
| Data | `dataAttributesJson` | `json` | no |  | Key value pairs that represent the custom user properties you want to update |
| Extra | `extraAttributesJson` | `json` | no |  | Key value pairs that represent reserved, Vero-specific operators. Refer to the note on “deduplication” below. |
