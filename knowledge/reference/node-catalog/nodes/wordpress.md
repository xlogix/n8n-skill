...
- Source file: `n8n-nodes-base/dist/nodes/Wordpress/Wordpress.node.js`
- Node version: `1`
- Groups: `output`
...
### Operations
- resource `page`: `create`, `get`, `getAll`, `update`
- resource `post`: `create`, `get`, `getAll`, `update`
- resource `user`: `create`, `get`, `getAll`, `update`
...
| Title | `title` | `string` | yes |  | The title for the post |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Post ID | `postId` | `string` | yes |  | Unique identifier for the object |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Title | `title` | `string` | yes |  | The title for the page |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Page ID | `pageId` | `string` | yes |  | Unique identifier for the object |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Page ID | `pageId` | `string` | yes |  | Unique identifier for the object |
| Options | `options` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Username | `username` | `string` | yes |  | Login name for the user |
| Name | `name` | `string` | yes |  | Display name for the user |
| First Name | `firstName` | `string` | yes |  | First name for the user |
| Last Name | `lastName` | `string` | yes |  | Last name for the user |
| Email | `email` | `string` | yes |  | The email address for the user |
| Password | `password` | `string` | yes |  | Password for the user (never included) |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
...
| Limit | `limit` | `number` | no | `5` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Reassign | `reassign` | `string` | yes |  | Reassign the deleted user's posts and links to this user ID |
