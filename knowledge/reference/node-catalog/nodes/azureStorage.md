...
- Node name: `azureStorage`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Microsoft/Storage/AzureStorage.node.js`
- Node version: `1`
- Groups: `transform`
...
## Credentials
- `azureStorageOAuth2Api` (required)
- `azureStorageSharedKeyApi` (required)
...
### Operations
- resource `blob`: `create`, `delete`, `get`, `getAll`
- resource `container`: `create`, `delete`, `get`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Authentication | `authentication` | `options` | no | `sharedKey` |  |
| Resource | `resource` | `options` | no | `container` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Container to create or replace a blob in |
| Blob Name | `blobCreate` | `string` | yes |  | The name of the new or existing blob |
| From | `from` | `options` | yes | `binary` |  |
| Binary Contents | `binaryPropertyName` | `string` | yes | `data` | The name of the input binary field containing the file to be written |
| URL | `url` | `string` | yes |  | URL where to read of the blob contents from |
| Options | `options` | `collection` | no | `{}` |  |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Container to delete a blob from |
| Blob | `blob` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Blob to be deleted |
| Options | `options` | `collection` | no | `{}` |  |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Container to get a blob from |
| Blob | `blob` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Blob to get |
| Options | `options` | `collection` | no | `{}` |  |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Container to get blobs from |
...
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
| Container Name | `containerCreate` | `string` | yes |  | The name of the new container |
| Options | `options` | `collection` | no | `{}` |  |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container to delete |
| Container | `container` | `resourceLocator` | yes | `{"mode":"list","value":""}` | Select the container to get |
| Options | `options` | `collection` | no | `{}` |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
