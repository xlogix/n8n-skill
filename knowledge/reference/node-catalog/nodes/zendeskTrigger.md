...
- Node name: `zendeskTrigger`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/Zendesk/ZendeskTrigger.node.js`
- Node version: `1`
- Groups: `trigger`
...
| Service | `service` | `options` | yes | `support` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Conditions | `conditions` | `fixedCollection` | no | `{}` | The condition to set |
