...
- Source file: `n8n-nodes-base/dist/nodes/UProc/UProc.node.js`
- Node version: `1`
- Groups: `output`
...
|---|---|---|---|---|---|
| Resource | `group` | `options` | no | `communication` |  |
| Operation | `tool` | `options` | no | `getAudioAdvancedSpeechByText` | The Operation to consume |
| Operation | `tool` | `options` | no | `checkSocialDomainExist` | The Operation to consume |
| Operation | `tool` | `options` | no | `checkCifValid` | The Operation to consume |
| Operation | `tool` | `options` | no | `checkBankBicValid` | The Operation to consume |
| Operation | `tool` | `options` | no | `checkCountryValidIso` | The Operation to consume |
| Operation | `tool` | `options` | no | `getQrDecoded` | The Operation to consume |
| Operation | `tool` | `options` | no | `checkDomainExist` | The Operation to consume |
| Operation | `tool` | `options` | no | `checkAgeBetw` | The Operation to consume |
| Operation | `tool` | `options` | no | `checkAsinExist` | The Operation to consume |
| Operation | `tool` | `options` | no | `checkNumberLuhn` | The Operation to consume |
| Operation | `tool` | `options` | no | `checkStringAlpha` | The Operation to consume |
| Credit card | `credit_card` | `string` | yes |  | The "Credit card" value to use as a parameter for this Operation |
| Address | `address` | `string` | yes |  | The "Address" value to use as a parameter for this Operation |
| Country | `country` | `string` | no |  | The "Country" value to use as a parameter for this Operation |
| Coordinates | `coordinates` | `string` | yes |  | The "Coordinates" value to use as a parameter for this Operation |
| Date | `date` | `string` | yes |  | The "Date" value to use as a parameter for this Operation |
| Years1 | `years1` | `number` | yes |  | The "Years1" value to use as a parameter for this Operation |
| Years2 | `years2` | `number` | yes |  | The "Years2" value to use as a parameter for this Operation |
| Years | `years` | `number` | yes |  | The "Years" value to use as a parameter for this Operation |
| Ean | `ean` | `string` | yes |  | The "Ean" value to use as a parameter for this Operation |
| Asin | `asin` | `string` | yes |  | The "Asin" value to use as a parameter for this Operation |
| Text | `text` | `string` | yes |  | The "Text" value to use as a parameter for this Operation |
| Gender | `gender` | `options` | yes |  | The "Gender" value to use as a parameter for this Operation |
| Language | `language` | `options` | yes |  | The "Language" value to use as a parameter for this Operation |
| Account | `account` | `string` | yes |  | The "Account" value to use as a parameter for this Operation |
| Bic | `bic` | `string` | yes |  | The "Bic" value to use as a parameter for this Operation |
| Isocode | `isocode` | `string` | yes |  | The "Isocode" value to use as a parameter for this Operation |
| Iban | `iban` | `string` | yes |  | The "Iban" value to use as a parameter for this Operation |
| Swift | `swift` | `string` | yes |  | The "Swift" value to use as a parameter for this Operation |
| Bcid | `bcid` | `options` | yes |  | The "Bcid" value to use as a parameter for this Operation |
| Author | `author` | `string` | yes |  | The "Author" value to use as a parameter for this Operation |
| Category | `category` | `string` | yes |  | The "Category" value to use as a parameter for this Operation |
| Isbn | `isbn` | `string` | yes |  | The "Isbn" value to use as a parameter for this Operation |
| Publisher | `publisher` | `string` | yes |  | The "Publisher" value to use as a parameter for this Operation |
| Title | `title` | `string` | yes |  | The "Title" value to use as a parameter for this Operation |
| Dni | `dni` | `string` | yes |  | The "Dni" value to use as a parameter for this Operation |
| Cif | `cif` | `string` | yes |  | The "Cif" value to use as a parameter for this Operation |
| Nie | `nie` | `string` | yes |  | The "Nie" value to use as a parameter for this Operation |
| Nif | `nif` | `string` | yes |  | The "Nif" value to use as a parameter for this Operation |
| Ip | `ip` | `string` | yes |  | The "Ip" value to use as a parameter for this Operation |
| City | `city` | `string` | yes |  | The "City" value to use as a parameter for this Operation |
| Phone | `phone` | `string` | yes |  | The "Phone" value to use as a parameter for this Operation |
| Zipcode | `zipcode` | `string` | yes |  | The "Zipcode" value to use as a parameter for this Operation |
| Upc | `upc` | `string` | yes |  | The "Upc" value to use as a parameter for this Operation |
| Isin | `isin` | `string` | yes |  | The "Isin" value to use as a parameter for this Operation |
| Number | `number` | `string` | yes |  | The "Number" value to use as a parameter for this Operation |
| Uuid | `uuid` | `string` | yes |  | The "Uuid" value to use as a parameter for this Operation |
| Domain | `domain` | `string` | yes |  | The "Domain" value to use as a parameter for this Operation |
| Duns | `duns` | `string` | yes |  | The "Duns" value to use as a parameter for this Operation |
| Email | `email` | `string` | yes |  | The "Email" value to use as a parameter for this Operation |
| Name | `name` | `string` | yes |  | The "Name" value to use as a parameter for this Operation |
| Url | `url` | `string` | yes |  | The "Url" value to use as a parameter for this Operation |
| Profile | `profile` | `string` | yes |  | The "Profile" value to use as a parameter for this Operation |
| Role | `role` | `string` | yes |  | The "Role" value to use as a parameter for this Operation |
| Taxid | `taxid` | `string` | yes |  | The "Taxid" value to use as a parameter for this Operation |
| Company | `company` | `string` | yes |  | The "Company" value to use as a parameter for this Operation |
| Area | `area` | `options` | no |  | The "Area" value to use as a parameter for this Operation |
| Clevel | `clevel` | `options` | no |  | The "Clevel" value to use as a parameter for this Operation |
| Location | `location` | `string` | no |  | The "Location" value to use as a parameter for this Operation |
| Keyword | `keyword` | `string` | no |  | The "Keyword" value to use as a parameter for this Operation |
| Message | `message` | `string` | yes |  | The "Message" value to use as a parameter for this Operation |
| Message1 | `message1` | `string` | yes |  | The "Message1" value to use as a parameter for this Operation |
| Message2 | `message2` | `string` | yes |  | The "Message2" value to use as a parameter for this Operation |
| Seniority | `seniority` | `options` | no |  | The "Seniority" value to use as a parameter for this Operation |
| Address1 | `address1` | `string` | yes |  | The "Address1" value to use as a parameter for this Operation |
| Address2 | `address2` | `string` | yes |  | The "Address2" value to use as a parameter for this Operation |
| Fuel consumption | `fuel_consumption` | `string` | yes |  | The "Fuel consumption" value to use as a parameter for this Operation |
| Price liter | `price_liter` | `string` | yes |  | The "Price liter" value to use as a parameter for this Operation |
| Coordinates1 | `coordinates1` | `string` | yes |  | The "Coordinates1" value to use as a parameter for this Operation |
| Coordinates2 | `coordinates2` | `string` | yes |  | The "Coordinates2" value to use as a parameter for this Operation |
| Ip1 | `ip1` | `string` | yes |  | The "Ip1" value to use as a parameter for this Operation |
| Ip2 | `ip2` | `string` | yes |  | The "Ip2" value to use as a parameter for this Operation |
| Phone1 | `phone1` | `string` | yes |  | The "Phone1" value to use as a parameter for this Operation |
| Phone2 | `phone2` | `string` | yes |  | The "Phone2" value to use as a parameter for this Operation |
| Zipcode1 | `zipcode1` | `string` | yes |  | The "Zipcode1" value to use as a parameter for this Operation |
| Zipcode2 | `zipcode2` | `string` | yes |  | The "Zipcode2" value to use as a parameter for this Operation |
| Distance | `distance` | `string` | yes |  | The "Distance" value to use as a parameter for this Operation |
| Coin | `coin` | `options` | yes |  | The "Coin" value to use as a parameter for this Operation |
| Country code | `country_code` | `string` | yes |  | The "Country code" value to use as a parameter for this Operation |
| Amount | `amount` | `string` | yes |  | The "Amount" value to use as a parameter for this Operation |
| Isocode1 | `isocode1` | `options` | yes |  | The "Isocode1" value to use as a parameter for this Operation |
| Isocode2 | `isocode2` | `options` | yes |  | The "Isocode2" value to use as a parameter for this Operation |
| Date1 | `date1` | `string` | yes |  | The "Date1" value to use as a parameter for this Operation |
| Date2 | `date2` | `string` | yes |  | The "Date2" value to use as a parameter for this Operation |
| Date3 | `date3` | `string` | yes |  | The "Date3" value to use as a parameter for this Operation |
| Period | `period` | `options` | yes |  | The "Period" value to use as a parameter for this Operation |
| Useragent | `useragent` | `string` | yes |  | The "Useragent" value to use as a parameter for this Operation |
| Type | `type` | `options` | no |  | The "Type" value to use as a parameter for this Operation |
| Width | `width` | `options` | no |  | The "Width" value to use as a parameter for this Operation |
| Fullpage | `fullpage` | `options` | no |  | The "Fullpage" value to use as a parameter for this Operation |
| Selector | `selector` | `string` | no |  | The "Selector" value to use as a parameter for this Operation |
| Delay | `delay` | `string` | no |  | The "Delay" value to use as a parameter for this Operation |
| Viewport | `viewport` | `string` | no |  | The "Viewport" value to use as a parameter for this Operation |
| Email from | `email_from` | `string` | yes |  | The "Email from" value to use as a parameter for this Operation |
| Email to | `email_to` | `string` | yes |  | The "Email to" value to use as a parameter for this Operation |
| Subject | `subject` | `string` | yes |  | The "Subject" value to use as a parameter for this Operation |
| Body | `body` | `string` | yes |  | The "Body" value to use as a parameter for this Operation |
| Page | `page` | `number` | no |  | The "Page" value to use as a parameter for this Operation |
| Firstname | `firstname` | `string` | yes |  | The "Firstname" value to use as a parameter for this Operation |
| Lastname | `lastname` | `string` | no |  | The "Lastname" value to use as a parameter for this Operation |
| Mode | `mode` | `options` | yes |  | The "Mode" value to use as a parameter for this Operation |
| Fullname | `fullname` | `string` | yes |  | The "Fullname" value to use as a parameter for this Operation |
| Mobile | `mobile` | `string` | yes |  | The "Mobile" value to use as a parameter for this Operation |
| Url dlr | `url_dlr` | `string` | no |  | The "Url dlr" value to use as a parameter for this Operation |
| Source | `source` | `string` | yes |  | The "Source" value to use as a parameter for this Operation |
| Destination | `destination` | `string` | yes |  | The "Destination" value to use as a parameter for this Operation |
| Size | `size` | `string` | no |  | The "Size" value to use as a parameter for this Operation |
| List | `list` | `string` | no |  | The "List" value to use as a parameter for this Operation |
| Keywords | `keywords` | `string` | no |  | The "Keywords" value to use as a parameter for this Operation |
| Current company | `current_company` | `string` | no |  | The "Current company" value to use as a parameter for this Operation |
| Current title | `current_title` | `string` | no |  | The "Current title" value to use as a parameter for this Operation |
| Included companies | `included_companies` | `string` | no |  | The "Included companies" value to use as a parameter for this Operation |
| Excluded companies | `excluded_companies` | `string` | no |  | The "Excluded companies" value to use as a parameter for this Operation |
| Included titles | `included_titles` | `string` | no |  | The "Included titles" value to use as a parameter for this Operation |
| Excluded titles | `excluded_titles` | `string` | no |  | The "Excluded titles" value to use as a parameter for this Operation |
| Included keywords | `included_keywords` | `string` | no |  | The "Included keywords" value to use as a parameter for this Operation |
| Excluded keywords | `excluded_keywords` | `string` | no |  | The "Excluded keywords" value to use as a parameter for this Operation |
| Length1 | `length1` | `number` | yes |  | The "Length1" value to use as a parameter for this Operation |
| Length2 | `length2` | `number` | yes |  | The "Length2" value to use as a parameter for this Operation |
| Length | `length` | `number` | yes |  | The "Length" value to use as a parameter for this Operation |
| Separator | `separator` | `string` | yes |  | The "Separator" value to use as a parameter for this Operation |
| Latitude | `latitude` | `string` | yes |  | The "Latitude" value to use as a parameter for this Operation |
| Longitude | `longitude` | `string` | yes |  | The "Longitude" value to use as a parameter for this Operation |
| Radius | `radius` | `string` | no |  | The "Radius" value to use as a parameter for this Operation |
| Imei | `imei` | `string` | yes |  | The "Imei" value to use as a parameter for this Operation |
| Regex | `regex` | `string` | yes |  | The "Regex" value to use as a parameter for this Operation |
| Host | `host` | `string` | yes |  | The "Host" value to use as a parameter for this Operation |
| Port | `port` | `string` | yes |  | The "Port" value to use as a parameter for this Operation |
| Table | `table` | `string` | no |  | The "Table" value to use as a parameter for this Operation |
| Number1 | `number1` | `string` | yes |  | The "Number1" value to use as a parameter for this Operation |
| Number2 | `number2` | `string` | yes |  | The "Number2" value to use as a parameter for this Operation |
| Number3 | `number3` | `string` | yes |  | The "Number3" value to use as a parameter for this Operation |
| Luhn | `luhn` | `string` | yes |  | The "Luhn" value to use as a parameter for this Operation |
| Mod | `mod` | `string` | yes |  | The "Mod" value to use as a parameter for this Operation |
| Rest | `rest` | `string` | yes |  | The "Rest" value to use as a parameter for this Operation |
| Password | `password` | `string` | yes |  | The "Password" value to use as a parameter for this Operation |
| Locality | `locality` | `options` | yes |  | The "Locality" value to use as a parameter for this Operation |
| Surname | `surname` | `string` | yes |  | The "Surname" value to use as a parameter for this Operation |
| Province | `province` | `string` | yes |  | The "Province" value to use as a parameter for this Operation |
| Format | `format` | `string` | yes |  | The "Format" value to use as a parameter for this Operation |
| Text1 | `text1` | `string` | yes |  | The "Text1" value to use as a parameter for this Operation |
| Text2 | `text2` | `string` | yes |  | The "Text2" value to use as a parameter for this Operation |
| Glue | `glue` | `string` | yes |  | The "Glue" value to use as a parameter for this Operation |
| Field | `field` | `options` | yes |  | The "Field" value to use as a parameter for this Operation |
| Find | `find` | `string` | yes |  | The "Find" value to use as a parameter for this Operation |
| Replace | `replace` | `string` | yes |  | The "Replace" value to use as a parameter for this Operation |
| Texts | `texts` | `string` | yes |  | The "Texts" value to use as a parameter for this Operation |
| Html | `html` | `string` | yes |  | The "Html" value to use as a parameter for this Operation |
| Tin | `tin` | `string` | yes |  | The "Tin" value to use as a parameter for this Operation |
| Vin | `vin` | `string` | yes |  | The "Vin" value to use as a parameter for this Operation |
| Count1 | `count1` | `string` | yes |  | The "Count1" value to use as a parameter for this Operation |
| Count2 | `count2` | `string` | yes |  | The "Count2" value to use as a parameter for this Operation |
| Count | `count` | `string` | yes |  | The "Count" value to use as a parameter for this Operation |
