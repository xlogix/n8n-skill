...
- Node name: `uptimeRobot`
- n8n-nodes-base version: `2.7.2`
- Source file: `n8n-nodes-base/dist/nodes/UptimeRobot/UptimeRobot.node.js`
- Node version: `1`
- Groups: `output`
...
- resource `alertContact`: `create`, `delete`, `get`, `getAll`, `update`
- resource `maintenanceWindow`: `create`, `delete`, `get`, `getAll`, `update`
- resource `monitor`: `create`, `delete`, `get`, `getAll`, `reset`, `update`
- resource `publicStatusPage`: `create`, `delete`, `get`, `getAll`
...
| Type | `type` | `options` | yes |  | The type of the monitor |
| URL | `url` | `string` | yes |  | The URL/IP of the monitor |
| ID | `id` | `string` | yes |  | The ID of the monitor |
...
| Type | `type` | `options` | yes |  | The type of the alert contact |
| Value | `value` | `string` | yes |  | The correspondent value for the alert contact type |
| ID | `id` | `string` | yes |  | The ID of the alert contact |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| ID | `id` | `string` | yes |  | The ID of the alert contact |
...
| Type | `type` | `options` | yes |  | The type of the maintenance window |
| Week Day | `weekDay` | `options` | no |  |  |
| Month Day | `monthDay` | `number` | no | `1` |  |
| Start Time | `start_time` | `dateTime` | yes |  | The maintenance window start datetime |
| ID | `id` | `string` | yes |  | The ID of the maintenance window |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| ID | `id` | `string` | yes |  | The ID of the maintenance window |
| Duration (Minutes) | `duration` | `number` | yes |  | The maintenance window activation period (minutes) |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `getAll` |  |
...
| ID | `id` | `string` | yes |  | The ID of the public status page |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| ID | `id` | `string` | yes |  | The ID of the public status page |
