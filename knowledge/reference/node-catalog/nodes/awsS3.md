...
- Source file: `n8n-nodes-base/dist/nodes/Aws/S3/AwsS3.node.js`
- Node version: `2`
- Groups: `output`
...
### Operations
- resource `bucket`: `create`, `delete`, `getAll`, `search`
- resource `file`: `copy`, `delete`, `download`, `getAll`, `upload`
- resource `folder`: `create`, `delete`, `getAll`
...
| Name | `name` | `string` | yes |  | A succinct description of the nature, symptoms, cause, or effect of the bucket |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Name | `name` | `string` | yes |  | Name of the AWS S3 bucket to delete |
...
| Operation | `operation` | `options` | no | `create` |  |
| Bucket Name | `bucketName` | `string` | yes |  |  |
| Folder Name | `folderName` | `string` | yes |  |  |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Bucket Name | `bucketName` | `string` | yes |  |  |
| Folder Key | `folderKey` | `string` | yes |  |  |
| Bucket Name | `bucketName` | `string` | yes |  |  |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `100` | Max number of results to return |
| Options | `options` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `download` |  |
| Source Path | `sourcePath` | `string` | yes |  | The name of the source bucket should start with (/) and key name of the source object, separated by a slash (/) |
| Destination Path | `destinationPath` | `string` | yes |  | The name of the destination bucket and key name of the destination object, separated by a slash (/) |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Bucket Name | `bucketName` | `string` | yes |  |  |
| File Name | `fileName` | `string` | yes |  |  |
| File Name | `fileName` | `string` | no |  | If not set the binary data filename will be used |
| Binary File | `binaryData` | `boolean` | no | `true` | Whether the data to upload should be taken from binary field |
...
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Tags | `tagsUi` | `fixedCollection` | no | `{}` | Optional extra headers to add to the message (most headers are allowed) |
| Bucket Name | `bucketName` | `string` | yes |  |  |
| File Key | `fileKey` | `string` | yes |  |  |
