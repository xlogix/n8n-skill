...
- Source file: `n8n-nodes-base/dist/nodes/Bubble/Bubble.node.js`
- Node version: `1`
- Groups: `transform`
...
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `object` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Type Name | `typeName` | `string` | yes |  | Name of data type of the object to create |
| Properties | `properties` | `fixedCollection` | no | `{}` |  |
| Type Name | `typeName` | `string` | yes |  | Name of data type of the object to retrieve |
| Object ID | `objectId` | `string` | yes |  | ID of the object to retrieve |
| Type Name | `typeName` | `string` | yes |  | Name of data type of the object to update |
| Object ID | `objectId` | `string` | yes |  | ID of the object to update |
| Properties | `properties` | `fixedCollection` | no | `{}` |  |
| Type Name | `typeName` | `string` | yes |  | Name of data type of the object to create |
