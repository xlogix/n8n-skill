...
- Source file: `n8n-nodes-base/dist/nodes/Spotify/Spotify.node.js`
- Node version: `1`
- Groups: `input`
...
### Operations
- resource `album`: `get`, `getNewReleases`, `getTracks`, `search`
- resource `artist`: `get`, `getAlbums`, `getRelatedArtists`, `getTopTracks`, `search`
- resource `library`: `getLikedTracks`
- resource `myData`: `getFollowingArtists`
- resource `player`: `addSongToQueue`, `currentlyPlaying`, `nextSong`, `pause`, `previousSong`, `recentlyPlayed`, `resume`, `startMusic`, `volume`
- resource `playlist`: `add`, `create`, `delete`, `get`, `getTracks`, `getUserPlaylists`, `search`
- resource `track`: `get`, `getAudioFeatures`, `search`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `player` |  |
| Operation | `operation` | `options` | no | `addSongToQueue` |  |
...
| Operation | `operation` | `options` | no | `get` |  |
| Artist ID | `id` | `string` | yes |  | The artist's Spotify URI or ID |
| Country | `country` | `string` | yes | `US` | Top tracks in which country? Enter the postal abbreviation |
| Search Keyword | `query` | `string` | yes |  | The keyword term to search for |
| Operation | `operation` | `options` | no | `add` |  |
| Playlist ID | `id` | `string` | yes |  | The playlist's Spotify URI or its ID |
| Name | `name` | `string` | yes |  | Name of the playlist to create |
...
| Track ID | `id` | `string` | yes |  | The track's Spotify URI or ID |
| Search Keyword | `query` | `string` | yes |  | The keyword term to search for |
| Operation | `operation` | `options` | no | `getLikedTracks` |  |
| Operation | `operation` | `options` | no | `getFollowingArtists` |  |
...
| Limit | `limit` | `number` | yes | `50` | Max number of results to return |
| Volume | `volumePercent` | `number` | yes | `50` | The volume percentage to set |
