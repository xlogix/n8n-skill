...
- Source file: `n8n-nodes-base/dist/nodes/Postgres/Postgres.node.js`
- Node version: `[2,2.1,2.2,2.3,2.4,2.5,2.6]`
- Groups: `input`
...
### Operations
- resource `database`: `deleteTable`, `executeQuery`, `insert`, `select`, `update`, `upsert`
...
| Schema | `schema` | `resourceLocator` | yes | `{"mode":"list","value":"public"}` | The schema that contains the table you want to work on |
| Table | `table` | `resourceLocator` | yes | `{"mode":"list","value":""}` | The table you want to work on |
| Command | `deleteCommand` | `options` | no | `truncate` |  |
| Restart Sequences | `restartSequences` | `boolean` | no | `false` | Whether to reset identity (auto-increment) columns to their initial values |
| Select Rows | `where` | `fixedCollection` | no | `{}` | If not set, all rows will be selected |
| Combine Conditions | `combineConditions` | `options` | no | `AND` | How to combine the conditions defined in "Select Rows": AND requires all conditions to be true, OR requires at least one condition to be true |
| Options | `options` | `collection` | no | `{}` |  |
| Query | `query` | `string` | yes |  | The SQL query to execute. You can use n8n expressions and $1, $2, $3, etc to refer to the 'Query Parameters' set in options below. |
| Options | `options` | `collection` | no | `{}` |  |
| Data Mode | `dataMode` | `options` | no | `autoMapInputData` | Whether to map node input properties and the table data automatically or manually |
| 
		In this mode, make sure incoming data fields are named the same as the columns in your table. If needed, use an 'Edit Fields' node before this node to change the field names.
		 | `notice` | `notice` | no |  |  |
| Values to Send | `valuesToSend` | `fixedCollection` | no | `{}` |  |
...
| 
		In this mode, make sure incoming data fields are named the same as the columns in your table. If needed, use an 'Edit Fields' node before this node to change the field names.
		 | `notice` | `notice` | no |  |  |
| Column to Match On | `columnToMatchOn` | `options` | yes |  | The column to compare when finding the rows to update. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/" target="_blank">expression</a>. |
| Value of Column to Match On | `valueToMatchOn` | `string` | no |  | Rows with a value in the specified "Column to Match On" that corresponds to the value in this field will be updated |
| Values to Send | `valuesToSend` | `fixedCollection` | no | `{}` |  |
| Columns | `columns` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Options | `options` | `collection` | no | `{}` |  |
| Data Mode | `dataMode` | `options` | no | `autoMapInputData` | Whether to map node input properties and the table data automatically or manually |
| 
		In this mode, make sure incoming data fields are named the same as the columns in your table. If needed, use an 'Edit Fields' node before this node to change the field names.
		 | `notice` | `notice` | no |  |  |
| Unique Column | `columnToMatchOn` | `options` | yes |  | The column to compare when finding the rows to update. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/" target="_blank">expression</a>. |
| Value of Unique Column | `valueToMatchOn` | `string` | no |  | Rows with a value in the specified "Column to Match On" that corresponds to the value in this field will be updated. New rows will be created for non-matching items. |
| Values to Send | `valuesToSend` | `fixedCollection` | no | `{}` |  |
| Columns | `columns` | `resourceMapper` | yes | `{"mappingMode":"defineBelow","value":null}` |  |
| Options | `options` | `collection` | no | `{}` |  |
