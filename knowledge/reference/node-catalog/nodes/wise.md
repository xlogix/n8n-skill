...
- Source file: `n8n-nodes-base/dist/nodes/Wise/Wise.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `account`: `getBalances`, `getCurrencies`, `getStatement`
- resource `exchangeRate`: `get`
- resource `profile`: `get`, `getAll`
- resource `quote`: `create`, `get`
- resource `recipient`: `getAll`
- resource `transfer`: `create`, `delete`, `execute`, `get`, `getAll`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `account` |  |
| Operation | `operation` | `options` | no | `getBalances` |  |
| Profile Name or ID | `profileId` | `options` | yes | `[]` | ID of the user profile to retrieve the balance of. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Profile Name or ID | `profileId` | `options` | no | `[]` | ID of the user profile whose account to retrieve the statement of. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Borderless Account Name or ID | `borderlessAccountId` | `options` | yes | `[]` | ID of the borderless account to retrieve the statement of. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Currency | `currency` | `string` | no |  | Code of the currency of the borderless account to retrieve the statement of |
| Format | `format` | `options` | no | `json` | File format to retrieve the statement in |
...
| Source Currency | `source` | `string` | no |  | Code of the source currency to retrieve the exchange rate for |
| Target Currency | `target` | `string` | no |  | Code of the target currency to retrieve the exchange rate for |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `get` |  |
| Profile Name or ID | `profileId` | `options` | yes | `[]` | ID of the user profile to retrieve. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Operation | `operation` | `options` | no | `get` |  |
| Profile Name or ID | `profileId` | `options` | yes | `[]` | ID of the user profile to create the quote under. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Target Account Name or ID | `targetAccountId` | `options` | yes | `[]` | ID of the account that will receive the funds. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Amount Type | `amountType` | `options` | no | `source` | Whether the amount is to be sent or received |
| Amount | `amount` | `number` | no | `1` | Amount of funds for the quote to create |
| Source Currency | `sourceCurrency` | `string` | no |  | Code of the currency to send for the quote to create |
| Target Currency | `targetCurrency` | `string` | no |  | Code of the currency to receive for the quote to create |
...
| Operation | `operation` | `options` | no | `get` |  |
| Profile Name or ID | `profileId` | `options` | yes | `[]` | ID of the user profile to retrieve the balance of. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Quote ID | `quoteId` | `string` | yes |  | ID of the quote based on which to create the transfer |
| Target Account Name or ID | `targetAccountId` | `options` | yes | `[]` | ID of the account that will receive the funds. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Transfer ID | `transferId` | `string` | yes |  | ID of the transfer to delete |
| Profile Name or ID | `profileId` | `options` | yes | `[]` | ID of the user profile to execute the transfer under. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Transfer ID | `transferId` | `string` | yes |  | ID of the transfer to execute |
| Transfer ID | `transferId` | `string` | yes |  | ID of the transfer to retrieve |
| Download Receipt | `downloadReceipt` | `boolean` | yes | `false` | Whether to download the transfer receipt as a PDF file. Only for executed transfers, having status 'Outgoing Payment Sent'. |
| Put Output File in Field | `binaryProperty` | `string` | yes | `data` |  |
| File Name | `fileName` | `string` | yes |  | Name of the file that will be downloaded |
| Profile Name or ID | `profileId` | `options` | yes | `[]` | ID of the user profile to retrieve. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
