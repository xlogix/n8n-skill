...
- Source file: `n8n-nodes-base/dist/nodes/Vonage/Vonage.node.js`
- Node version: `1`
- Groups: `input`
...
| From | `from` | `string` | no |  | The name or number the message should be sent from |
| To | `to` | `string` | no |  | The number that the message should be sent to. Numbers are specified in E.164 format. |
| Message | `message` | `string` | no |  | The body of the message being sent |
