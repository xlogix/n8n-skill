...
- Source file: `n8n-nodes-base/dist/nodes/Grafana/Grafana.node.js`
- Node version: `1`
- Groups: `transform`
...
### Operations
- resource `dashboard`: `create`, `delete`, `get`, `getAll`, `update`
- resource `team`: `create`, `delete`, `get`, `getAll`, `update`
- resource `teamMember`: `add`, `getAll`, `remove`
- resource `user`: `delete`, `getAll`, `update`

## Parameters
| Display Name | Name | Type | Required | Default | Description |
|---|---|---|---|---|---|
| Resource | `resource` | `options` | no | `dashboard` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Title | `title` | `string` | yes |  | Title of the dashboard to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Dashboard UID or URL | `dashboardUidOrUrl` | `string` | yes |  | Unique alphabetic identifier or URL of the dashboard to delete |
| Dashboard UID or URL | `dashboardUidOrUrl` | `string` | yes |  | Unique alphabetic identifier or URL of the dashboard to retrieve |
...
| Dashboard UID or URL | `dashboardUidOrUrl` | `string` | yes |  | Unique alphabetic identifier or URL of the dashboard to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `create` |  |
| Name | `name` | `string` | yes |  | Name of the team to create |
| Additional Fields | `additionalFields` | `collection` | no | `{}` |  |
| Team ID | `teamId` | `string` | yes |  | ID of the team to delete |
| Team ID | `teamId` | `string` | yes |  | ID of the team to retrieve |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Filters | `filters` | `collection` | no | `{}` |  |
| Team ID | `teamId` | `string` | yes |  | ID of the team to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| Operation | `operation` | `options` | no | `add` |  |
| User Name or ID | `userId` | `options` | yes |  | User to add to a team. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Team Name or ID | `teamId` | `options` | yes |  | Team to add the user to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| User Name or ID | `memberId` | `options` | yes |  | User to remove from the team. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Team Name or ID | `teamId` | `options` | yes |  | Team to remove the user from. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Team Name or ID | `teamId` | `options` | yes |  | Team to retrieve all members from. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
| Operation | `operation` | `options` | no | `getAll` |  |
| User ID | `userId` | `string` | yes |  | ID of the user to update |
| Update Fields | `updateFields` | `collection` | no | `{}` |  |
| User ID | `userId` | `string` | yes |  | ID of the user to delete |
| Return All | `returnAll` | `boolean` | no | `false` | Whether to return all results or only up to a given limit |
| Limit | `limit` | `number` | no | `50` | Max number of results to return |
